...
-- +=======================================================================+
-- | Name             :XX_JTF_WWW_PROSPECT_MSTR_PKG.pkb                    |
...
create or replace package body XX_JTF_WWW_PROSPECT_MSTR_PKG
AS 
...
IS
    ...
    lv_process_name         varchar2(32) := 'JTF WWW PROSPECT';
    lc_program_name         VARCHAR2(32);
    lc_stage_name           varchar2(32);
    lc_package_name         varchar2(32) := 'XX_JTF_WWW_PROSPECT_MSTR_PKG';
...
BEGIN    
    ...
    fnd_file.put_line (fnd_file.log,' ');
    lc_request_set := 'XX_JTF_WWW_PROSPECT_SET';
...
--
    fnd_file.put_line (fnd_file.log,' ');
    Lc_program_name := 'XX_JTF_WWW_PROSPECT';
