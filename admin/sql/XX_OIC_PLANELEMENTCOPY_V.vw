...
WHENEVER OSERROR EXIT FAILURE ROLLBACK;
   ...
   -- +===================================================================+
   -- | Name        : XX_OIC_PLANELEMENTCOPY_V                            |
   -- | Description : View to copy plan element details data              |
   ...
   -- |                      for exporting Plan Element data              |
   -- |                                                                   |
   -- |                                                                   |
   -- +===================================================================+
 CREATE OR REPLACE VIEW APPS.XX_OIC_PLANELEMENTCOPY_V  OF XX_OIC_QUOTAS_OBJ
   WITH OBJECT IDENTIFIER (QUOTA_ID, ORG_ID)
AS
SELECT CQA.quota_id,
          CQA.name,
