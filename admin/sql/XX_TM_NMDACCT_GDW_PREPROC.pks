...
PROMPT
PROMPT Creating XX_TM_NMDACCT_GDW_PREPROC package specification
PROMPT

CREATE OR REPLACE PACKAGE XX_TM_NMDACCT_GDW_PREPROC
-- +===================================================================================+
...
G_CHLD_PROG_EXECUTABLE          CONSTANT  VARCHAR2(30)  := 'XXTMNMDACCTGDWPREPROCCHILD'; 
