...
--This is the fix found from metalink for the issue related 
...
begin
  ...
  select guid into event_guid from wf_events where name = 'od.oracle.apps.ar.hz.AccountCreationRequestBatch.create' ;
