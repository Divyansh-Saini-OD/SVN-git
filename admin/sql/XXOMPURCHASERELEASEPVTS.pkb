...
/* $Header: /home/cvs/repository/Office_Depot/SRC/OTC/E1064_AssignSupplier/3.\040Source\040Code\040&\040Install\040Files/XXOMPURCHASERELEASEPVTS.pks,v 1.1 2007/04/25 14:26:07 hchikkanna Exp $ */
...
l_ou_org_id                  NUMBER;
x_vendor_id                  NUMBER; -- Added for custom requirement E1064
x_vendor_site_id             NUMBER; -- Added for custom requirement E1064
 ...
 */
 ...
 x_loc_var            := NULL;  /* Added by Faiz Mohammad.B to update the context type*/
 x_dropship_type      := NULL;  /* Added by Faiz Mohammad.B to update the context type*/
 ...
 INSERT INTO po_requisitions_interface_all
             ...
             item_description,
             org_id,
             suggested_vendor_id,        -- Added for E1064
             suggested_vendor_site_id,   -- Added for E1064
             autosource_flag,
             line_attribute_category,    -- For E1064_AssignSupplier, for updating the context type DropShip/NoneCodeDropship
             line_attribute6             -- For E1064_AssignSupplier, as per the update in MDO50 updating Costcenter/Department
            )
             VALUES
             (
             l_source_code,
             ...
             l_ou_org_id,
             x_vendor_id,                       --Added by vikas E1064
             x_vendor_site_id,                  --Added by Viaks E1064
             decode(x_vendor_id,null, null,'P'),
             x_dropship_type,                   --Added by Faiz Mohammad B. for  E1064 to store the context type--DropShip or NoncodeDropship
             SUBSTR(x_loc_var,1,150)            --Added by Faiz Mohammad B. for  E1064 to store the DesktopDelivery/Costcenter
             );
