...
PROMPT
PROMPT Creating XX_JTF_SLS_REP_NW_DIV_PTY_SITE package specification
PROMPT

CREATE OR REPLACE PACKAGE XX_JTF_SLS_REP_NW_DIV_PTY_SITE 
-- +===================================================================================+
...
G_LIMIT                         CONSTANT  PLS_INTEGER  := NVL(fnd_profile.value ('XX_CDH_BULK_FETCH_LIMIT'),10000);
G_CHLD_PROG_APPLICATION         CONSTANT VARCHAR2(30)  := 'XXCRM';
G_CHLD_PROG_EXECUTABLE          CONSTANT VARCHAR2(30)  := 'XXJTFSLREPNEWDIVPTYSITECHILD'; -- Name of the child program
