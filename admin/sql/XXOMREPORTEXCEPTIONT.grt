...
-- |                                                                                            |
-- +============================================================================================+
-- | Name         : XXOMREPORTEXCEPTION.grt                                                     |
-- | Rice Id      :                                                                             | 
-- | Description  : OD Exceptions Handling Grants Creation                                      |  
-- | Purpose      : Create Grant for Object XX_OM_REPORT_EXCEPTION_T.                           |
-- |                                                                                            |
-- |                                                                                            |
-- |Change Record:                                                                              |
-- |===============                                                                             |
...
PROMPT
PROMPT Providing Grant on object xx_om_report_exception_t to Apps .....
PROMPT

GRANT ALL ON  xx_om_report_exception_t TO APPS
/
