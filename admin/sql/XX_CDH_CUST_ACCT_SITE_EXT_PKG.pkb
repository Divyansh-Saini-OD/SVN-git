...
CREATE OR REPLACE package body XX_CDH_CUST_ACCT_SITE_EXT_PKG
-- +======================================================================================+
-- |                  Office Depot - Project Simplify                                     |
-- |      Oracle NAIO/WIPRO/Office Depot/Consulting Organization                          |
-- +======================================================================================|
-- | Name       : XX_CDH_CUST_ACCT_SITE_EXT_PKG                                           |
-- | Description: This package body provides table handlers for XX_CDH_ACCT_SITE_EXT_B and|
...
BEGIN
  ...
  INSERT INTO XX_CDH_ACCT_SITE_EXT_B (
    EXTENSION_ID,
    CUST_ACCT_SITE_ID,
    ATTR_GROUP_ID,
    C_EXT_ATTR1,
  ...
  insert into XX_CDH_ACCT_SITE_EXT_TL (
    TL_EXT_ATTR8,
    TL_EXT_ATTR9,
    TL_EXT_ATTR10,
    TL_EXT_ATTR11,
  ...
  and not exists
    (select NULL
    from XX_CDH_ACCT_SITE_EXT_TL T
...
begin
  ...
  close c;
  if (    (recinfo.CUST_ACCT_SITE_ID = X_CUST_ACCT_SITE_ID)
...
procedure UPDATE_ROW (
 ...
 BEGIN
  ...
  UPDATE XX_CDH_ACCT_SITE_EXT_TL SET
...
BEGIN
  ...
  DELETE FROM XX_CDH_ACCT_SITE_EXT_TL T
  WHERE NOT EXISTS
    (SELECT NULL
     FROM   XX_CDH_ACCT_SITE_EXT_B B
     WHERE  B.EXTENSION_ID = T.EXTENSION_ID
    );

  UPDATE XX_CDH_ACCT_SITE_EXT_TL T SET (
      TL_EXT_ATTR1,
      TL_EXT_ATTR2,
      TL_EXT_ATTR3,
      TL_EXT_ATTR4,
      ...
      B.TL_EXT_ATTR19,
      B.TL_EXT_ATTR20
    FROM XX_CDH_ACCT_SITE_EXT_TL B
    WHERE B.EXTENSION_ID = T.EXTENSION_ID
  ...
  WHERE (
      ...
      SUBT.EXTENSION_ID,
      SUBT.LANGUAGE
    FROM XX_CDH_ACCT_SITE_EXT_TL SUBB, XX_CDH_ACCT_SITE_EXT_TL SUBT
  ...
  INSERT INTO XX_CDH_ACCT_SITE_EXT_TL (
    ...
    L.LANGUAGE_CODE,
    B.SOURCE_LANG
  from XX_CDH_ACCT_SITE_EXT_TL B, FND_LANGUAGES L
  where L.INSTALLED_FLAG in ('I', 'B')
