CREATE OR REPLACE PACKAGE APPS.XX_XDO_REQUEST_DOCS_PKG AS 
-- +============================================================================================+ 
...
-- |                                                                                            | 
-- |  Returns:     rowid, xdo_document_id (NEXTVAL)                                             | 
-- +============================================================================================+ 
...
-- |                                                                                            | 
-- |  Returns:     rowid, xdo_document_id (NEXTVAL into rowtype)                                | 
-- +============================================================================================+ 
PROCEDURE insert_row
( x_rowid                  IN OUT VARCHAR2,
...
-- |                                                                                            | 
-- |  Parameters:  xdo_document_id (primary key)                                                | 
-- |                                                                                            | 
-- |  Returns:     Y or N                                                                       | 
-- +============================================================================================+ 
FUNCTION row_exists
