...
CREATE INDEX APPS.XX_AR_CUSTOMER_AGING_GC_MV_N1 ON APPS.XX_AR_CUSTOMER_AGING_GC_MV
  ...
  COMPUTE STATISTICS NOPARALLEL LOGGING;
CREATE INDEX APPS.XX_CRM_EBILL_CONTACT_OBJS_MV_N1 ON APPS.XX_CRM_EBILL_CONTACT_OBJS_MV
  (
    ORIG_SYSTEM_REFERENCE
  )
  COMPUTE STATISTICS NOPARALLEL LOGGING;
...
CREATE OR REPLACE SYNONYM XX_AR_CUSTOMER_AGING_MV FOR APPS.XX_AR_CUSTOMER_AGING_MV;
CREATE OR REPLACE SYNONYM XX_AR_CUSTOMER_AGING_CH_MV FOR APPS.XX_AR_CUSTOMER_AGING_CH_MV;
CREATE OR REPLACE SYNONYM XX_AR_CUSTOMER_AGING_GC_MV FOR APPS.XX_AR_CUSTOMER_AGING_GC_MV;
CREATE OR REPLACE SYNONYM XX_AR_CUSTOMER_PARENT_MV FOR APPS.XX_AR_CUSTOMER_PARENT_MV;
CREATE OR REPLACE SYNONYM XX_CRM_CREDIT_LIMTS_OBJS_MV FOR APPS.XX_CRM_CREDIT_LIMTS_OBJS_MV;
CREATE OR REPLACE SYNONYM XX_CRM_EBILL_CONTACT_OBJS_MV FOR APPS.XX_CRM_EBILL_CONTACT_OBJS_MV;
CREATE OR REPLACE SYNONYM XX_CRM_GRAND_PARENT_OBJS_MV FOR APPS.XX_CRM_GRAND_PARENT_OBJS_MV;
CREATE OR REPLACE SYNONYM XX_CRM_PAYMENT_TERMS_OBJS_MV FOR APPS.XX_CRM_PAYMENT_TERMS_OBJS_MV;
