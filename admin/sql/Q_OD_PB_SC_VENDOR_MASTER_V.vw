...
AS
SELECT
  /*+ LEADING(qp) USE_NL(qp qr) push_pred(PH) USE_NL(PH PR)*/
  qr.rowid row_id,
  qr.plan_id,
  qp.name plan_name,
  qr.organization_id,
  ...
  to_date(qr.CHARACTER88, 'YYYY/MM/DD') "OD_PB_PAYRTN_APRVL_DATE",
  to_date(qr.CHARACTER66, 'YYYY/MM/DD') "OD_SC_VENDPAY_RCVD_D",
  to_date(qr.CHARACTER67, 'YYYY/MM/DD') "OD_SC_STRAUDT_SCHD_D",
  to_date(qr.CHARACTER68, 'YYYY/MM/DD') "OD_SC_REQ_AUDIT_DATE",
  qr.CHARACTER69 "OD_SC_STR_AUDIT_RESULT",
  qr.CHARACTER70 "OD_SC_CAP_ASSIGNMENT",
  to_date(qr.CHARACTER71, 'YYYY/MM/DD') "OD_SC_CAP_SENT_D",
  to_date(qr.CHARACTER72, 'YYYY/MM/DD') "OD_SC_CAP_RECD_D",
  qr.CHARACTER73 "OD_SC_STRAUDT_CAP_STATUS",
  to_date(qr.CHARACTER74, 'YYYY/MM/DD') "OD_SC_CAP_RESP_D",
  qr.COMMENT3 " OD_SC_CAP_REV_COMMENTS",
  qr.CHARACTER75 "OD_SC_CAP_PREAPPROVER",
  to_date(qr.CHARACTER76, 'YYYY/MM/DD') "OD_SC_STRAUDT_GSO_APR_D",
  qr.CHARACTER77 "OD_SC_CAP_FINAL_APPROVER",
  to_date(qr.CHARACTER78, 'YYYY/MM/DD') "OD_SC_SRTAUDT_US_APR_D",
  qr.CHARACTER79 "OD_SC_VEND_INITIATE",
  qr.CHARACTER80 "OD_SC_INITSTR_NOTIFY",
  qr.CHARACTER81 "OD_SC_VENDPAY_NOTIFY",
  qr.CHARACTER82 "OD_SC_REGRUSH_NOTIFY",
  qr.CHARACTER83 "OD_SC_AUDRESZT_NOTIFY",
  qr.CHARACTER84 "OD_SC_RECAUDIT_NOTIFY",
  qr.CHARACTER85 "OD_SC_CAP_NOTIFY",
  qr.CHARACTER86 "OD_SC_VENDSK_NOTIFY",
  qr.CHARACTER87 "OD_SC_NB_NOTIFY",
