...
-- +===========================================================================+
-- | Name        :    XX_C2T_CC_DEPOSITS_CONVERT_PHASE_5_1.sql                 |
-- | Description :    Populate XX_C2T_CONV_THREADS_DEPOSITS Table for          |
-- |                  Convert Phase                                            |
-- | Rice ID     :    C0705                                                    |
-- |Change Record:                                                             |
-- |===============                                                            |
...
-- +===========================================================================+
 ...
 BEGIN
    ...
    lc_location := 'TRUNCATE  TABLE XX_C2T_CONV_THREADS_DEPOSITS ';
    DBMS_OUTPUT.PUT_LINE( lc_location );
    EXECUTE IMMEDIATE 'TRUNCATE TABLE XXOM.XX_C2T_CONV_THREADS_DEPOSITS';
			
    lc_location := 'INSERTING Values in table XX_C2T_CONV_THREADS_DEPOSITS';
    DBMS_OUTPUT.PUT_LINE( lc_location );			
    INSERT INTO XX_C2T_CONV_THREADS_DEPOSITS (
                                             min_deposit_id
                                          ,  max_deposit_id
                                          ,  thread_num
                                          ,  total_count
                ...
                SELECT MIN(X.deposit_id)         min_deposit_id
                 ...
                 FROM (SELECT /*+ parallel(DEP) full(DEP) */ 
                              DEP.deposit_id
                            , NTILE(128) OVER(ORDER BY DEP.deposit_id) thread_num
