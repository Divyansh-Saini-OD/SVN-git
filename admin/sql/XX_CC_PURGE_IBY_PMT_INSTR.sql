...
DELETE /*+ parallel(16) full(piua_o) */
  FROM iby_pmt_instr_uses_all piua_o
 WHERE EXISTS (SELECT /*+ parallel(16) full(cc) */ cc.instrid 
   ...
   AND piua_o.instrument_type = 'CREDITCARD';
