...
WHENEVER OSERROR EXIT FAILURE ROLLBACK;
   ...
   -- +===================================================================+
   -- | Name        : XX_OIC_FORMULACOPY_V                                |
   -- | Description : View to copy formula details data                   |
   ...
   -- |                      for exporting formula data                   |
   -- |                                                                   |
   -- |                                                                   |
   -- +===================================================================+
CREATE OR REPLACE VIEW APPS.XX_OIC_FORMULACOPY_V OF APPS.XX_OIC_CALC_FORMULAS_OBJ
  WITH OBJECT IDENTIFIER (CALC_FORMULA_ID,ORG_ID) AS 
  SELECT   CCFA.org_id,
