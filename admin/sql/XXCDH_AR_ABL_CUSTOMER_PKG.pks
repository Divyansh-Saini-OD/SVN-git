...
CREATE OR REPLACE PACKAGE XXCDH_AR_ABL_CUSTOMER_PKG AUTHID CURRENT_USER 
-- +=====================================================================================+
...
AS
 ...
 TYPE xxcdh_abl_cust_rec IS RECORD 
  ...
  TYPE xxcdh_abl_cust_tab        IS TABLE OF XXCDH_AR_ABL_CUSTOMER_PKG.xxcdh_abl_cust_rec;
 ...
 TYPE xxcdh_subq_rec IS RECORD 
  ...
  TYPE lt_subq_func      IS TABLE OF XXCDH_AR_ABL_CUSTOMER_PKG.xxcdh_subq_rec; 
  TYPE lt_subq_func_in   IS TABLE OF XXCDH_AR_ABL_CUSTOMER_PKG.xxcdh_subq_rec;     
 
  l_tab_subq_func_inc       lt_subq_func_in; 
  lrec_subq_func_out        XXCDH_AR_ABL_CUSTOMER_PKG.xxcdh_subq_rec;
