...
REM dbdrv: checkfile(120.27.12000000.2=120.29)(115.17=120.0):~PROD:~PATH:~FILE 

/*+=======================================================================+
--|               Copyright (c) 1998, 2014 Oracle Corporation                   |
...
--|                                                                       |
--| DESCRIPTION                                                           |
--|     Handles the supplier user in r12                                  |
--|                                                                       |
--+======================================================================*/
...
CREATE or REPLACE PACKAGE BODY pos_user_admin_pkg as
...
procedure revoke_user_resp
  ...
  IS
     l_start_date DATE;
     CURSOR l_cur IS
        SELECT start_date FROM fnd_user_resp_groups_direct 
...
--Function Usage:
--  This function is used to replace the workflow message subject by FND Message and its tokens
--Logic Implemented:
...
--Procedure Usage:
--  It is being used to replace the workflow message Body by FND Message and its tokens
--Logic Implemented:
-- For HTML Body:
