...
-- +===========================================================================+
-- | Name        : XX_CDH_EBL_TXT_DET_FIELDS_V.vw                              |
-- | Description : View on FINTRANS table for eBilling Detail TXT Fields.      |
-- |                                                                           |
-- |                                                                           |
-- |Change Record:                                                             |
-- |===============                                                            |
...
-- +===========================================================================+
  ...
  CREATE OR REPLACE VIEW XX_CDH_EBL_TXT_DET_FIELDS_V (
       FIELD_ID,
       FIELD_NAME,
       SOURCE_TABLE,
       SOURCE_COLUMN,
  ...
  SELECT 
	   ...
	   val.target_value24 SPL_FUNCTION
