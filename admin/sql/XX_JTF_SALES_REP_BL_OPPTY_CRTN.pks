...
PROMPT
PROMPT Creating XX_JTF_SALES_REP_BL_OPPTY_CRTN package specification
PROMPT

CREATE OR REPLACE PACKAGE XX_JTF_SALES_REP_BL_OPPTY_CRTN 
-- +===============================================================================================+
...
G_CHLD_PROG_EXECUTABLE          CONSTANT  VARCHAR2(30) := 'XXJTFBLSLREPOPPTYCRTNCHILD';
...
-----------------------------------
TYPE req_id_oppty_id_rec_type IS RECORD
           (
              REQUEST_ID         NUMBER
              , FROM_OPPTY_ID    NUMBER
              , TO_OPPTY_ID      NUMBER
           );
...
---------------------------------------
TYPE req_id_oppty_id_tbl_type IS TABLE OF req_id_oppty_id_rec_type INDEX BY BINARY_INTEGER;
gt_req_id_oppty_id req_id_oppty_id_tbl_type;
