...
CREATE OR REPLACE PACKAGE XX_AP_INV_REASON_CODE_UI_PKG
AS
  -- +============================================================================================+
  ...
  -- | 1.1         03/31/2020   Mayur Palsokar    Modified AP_INV_REASONCODE_DB, AP_INV_REASONCODE_SUM_DB, 
  -- |                                            GET_AP_INV_REASONCODE_DETAIL, GET_AP_INV_REASONCODE_SUMMARY for NAIT-27208 |
  -- +============================================================================================+
...
IS
  ...
  (
	...
	GL_DATE  DATE,         -- Added by Mayur for NAIT-27208
	INVOICE_DATE DATE      -- Added by Mayur for NAIT-27208;
	);
