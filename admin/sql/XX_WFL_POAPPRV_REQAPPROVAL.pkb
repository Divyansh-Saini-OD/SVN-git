...
SET TERM ON
PROMPT Creating Package Body XX_WFL_POAPPRV_REQAPPROVAL
PROMPT Program exits if the creation is not successful
SET TERM OFF
WHENEVER SQLERROR CONTINUE

CREATE OR REPLACE
PACKAGE BODY XX_WFL_POAPPRV_REQAPPROVAL
AS
-- +====================================================================+
...
BEGIN
   ...
   lc_error_loc := 'Fetch the Buyer Type';
   SELECT attribute1
   INTO lc_buyer_flag
   FROM po_agents_v
   WHERE agent_id=ln_empid;
