...
PROMPT Creating Package Body XX_CDH_EBL_CONV_PAPER_EPDF
...
-- +========================================================================+
  ...
  BEGIN
    ...
    BEGIN       
      ...
      INSERT INTO XXCRM.xx_cdh_ebl_conv_login_dtl ( aops_number
                                                  , customer_name
                                                  , zip_code
                                                  , contact_first_name
                                                  , contact_last_name
...
-- |===========================================================================|
  ...
  PROCEDURE create_ebill_contact( p_cust_account_id       IN  HZ_CUST_ACCOUNTS.cust_account_id%TYPE
    ...
    -- PERSON
    lr_person_rec        APPS.HZ_PARTY_V2PUB.PERSON_REC_TYPE;
    ...
    -- contact points
    lr_contact_point_rec APPS.hz_contact_point_v2pub.contact_point_rec_type;
    lr_edi_rec           APPS.hz_contact_point_v2pub.edi_rec_type;
    lr_email_rec         APPS.hz_contact_point_v2pub.email_rec_type;
    lr_phone_rec         APPS.hz_contact_point_v2pub.phone_rec_type;
    lr_telex_rec         APPS.hz_contact_point_v2pub.telex_rec_type;
    lr_web_rec           APPS.hz_contact_point_v2pub.web_rec_type;
    ln_contact_point_id  NUMBER;

    -- Account roles
    lr_cust_account_role_rec APPS.hz_cust_account_role_v2pub.cust_account_role_rec_type;
    ln_cust_account_role_id  NUMBER;

    -- Role responsibility
    lr_role_responsibility_rec APPS.hz_cust_account_role_v2pub.role_responsibility_rec_type;
    ln_responsibility_id NUMBER;
...
-- |===========================================================================|    
  ...
  SELECT XCDD.ebl_conv_doc_id            ebl_conv_doc_id
    ...
    FROM apps.xx_cdh_ebl_conv_doc_dtl XCDD
 ...
 SELECT (XCCD.first_name || ' ' || XCCD.last_name) contact_name
   ...
   FROM apps.xx_cdh_ebl_conv_contact_dtl XCCD
