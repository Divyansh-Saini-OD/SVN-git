...
CREATE UNIQUE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_U1
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (TASK_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N1
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (PARTY_SITE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N2
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (PARTY_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N3
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (ASSIGNED_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N4
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (ASSIGNED_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N5
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (M1_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N6
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (M1_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N7
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (M2_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N8
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (M2_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N9
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (M3_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N10
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (M3_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N11
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (M4_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N12
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (M4_USER_ID);


CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N13
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (OWNER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N14
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (OWNER_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N15
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (OWNER_M1_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N16
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (OWNER_M1_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N17
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (OWNER_M2_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N18
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (OWNER_M2_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N19
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (OWNER_M3_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N20
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (OWNER_M3_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N21
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (OWNER_M4_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N22
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (OWNER_M4_USER_ID);

--CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N23
--  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATED_BY);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N24
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATED_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N25
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATED_M1_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N26
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATED_M1_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N27
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATED_M2_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N28
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATED_M2_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N29
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATED_M3_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N30
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATED_M3_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N31
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATED_M4_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N32
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATED_M4_USER_ID);

--CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N33
--  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATED_BY);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N34
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATED_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N35
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATED_M1_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N36
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATED_M1_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N37
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATED_M2_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N38
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATED_M2_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N39
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATED_M3_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N40
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATED_M3_USER_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N41
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATED_M4_RESOURCE_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N42
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATED_M4_USER_ID);


CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N43
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATION_YEAR_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N44
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (CREATION_WEEK_NUMBER);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N45
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATE_YEAR_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N46
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (LAST_UPDATE_WEEK_NUMBER);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N47
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (TASK_YEAR_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N48
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (TASK_WEEK_NUMBER);

CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N49
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (ORG_NUMBER);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N50
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (ORG_TYPE);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N51
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (SITE_USE);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N52
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (SITE_ORIG_SYS_REF);

CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N53
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (TASK_STATUS_ID);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N54
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (TASK_TYPE_ID);

CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N55
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (ORG_NUMBER_DUPLICATE);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N56
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (ORG_TYPE_DUPLICATE);
CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N57
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (SITE_USE_DUPLICATE);

CREATE INDEX XXCRM.XXBI_ACTIVITIES_FCT_MV_N58
  ON XXCRM.XXBI_ACTIVITIES_FCT_MV (ASSIGNED_RESOURCE_ID_DUP);
