...
CREATE OR REPLACE PACKAGE BODY XXCDH_AR_ABL_CUSTOMER_PRF_PKG
-- +=====================================================================================+
...
IS
  ...
  IS
            ...
            FROM  (SELECT /*+ NO_MERGE */
                   ...
                   --AND     UPPER(cust_prof.attribute3) = 'YES' 
                   AND NOT EXISTS
                                ( SELECT /*+ NL_AJ */
                                         1
...
BEGIN
        ...
        IF lt_subq_cur_rec.COUNT > 0 THEN
         ...
         LOOP
          ...
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.party_id         :=  lt_subq_cur_rec(i).party_id          ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.party_name       :=  lt_subq_cur_rec(i).party_name        ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.account_number   :=  lt_subq_cur_rec(i).account_number    ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.party_site_id    :=  lt_subq_cur_rec(i).party_site_id     ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.address1         :=  lt_subq_cur_rec(i).address1          ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.address2         :=  lt_subq_cur_rec(i).address2          ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.city             :=  lt_subq_cur_rec(i).city              ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.state            :=  lt_subq_cur_rec(i).state             ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.province         :=  lt_subq_cur_rec(i).province          ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.postal_code      :=  lt_subq_cur_rec(i).postal_code       ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.country          :=  lt_subq_cur_rec(i).country           ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.country_code     :=  lt_subq_cur_rec(i).country_code      ;
          XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out.cust_account_id  :=  lt_subq_cur_rec(i).cust_account_id	 ;	
          														 
          PIPE ROW (XXCDH_AR_ABL_CUSTOMER_PRF_PKG.lrec_subq_func_out);							
...
AS
    ...
    FROM(  
    	   ...
    	   FROM  TABLE(XXCDH_AR_ABL_CUSTOMER_PRF_PKG.Get_abl_cust_Details) subq_func
    	   WHERE EXISTS
    	               (
    	                SELECT 1
    	                FROM   APPS.hz_cust_site_uses_all  hcsua,
...
BEGIN
    ...
    IF lt_abl_cust_rec.COUNT > 0 THEN
         ...
         LOOP 
          ...
          lt_phone_number('PHONE'):= Get_Ap_Phone(p_party_id => lt_abl_cust_rec(i).party_id);
