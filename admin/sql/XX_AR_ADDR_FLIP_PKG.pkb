...
PROMPT Creating PACKAGE BODY XX_AR_ADDR_FLIP_PKG

PROMPT Program exits IF the creation IS NOT SUCCESSFUL

WHENEVER SQLERROR CONTINUE

create or replace PACKAGE  BODY XX_AR_ADDR_FLIP_PKG
AS
-- +========================================================================+
...
-- |======   ==========     =============        ======================= |
-- |Draft 1  22-JUN-09     Lavanya Ramamoorthy     Initial version       |
-- |                                                                     |
-- +========================================================================+
--- +=====================================================================+
