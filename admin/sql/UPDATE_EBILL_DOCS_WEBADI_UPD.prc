...
-- |1.1        02-JAN-2019     Sridhar Pamu          Added EDI for NAIT 50792                   |
-- +============================================================================================+

UPDATE bne_interface_cols_b 
SET val_addl_w_c = 'value_set_id = 1011050 AND enabled_code = ''Y'' AND (NVL(start_date,SYSDATE- 1) < SYSDATE) AND (NVL(end_date,SYSDATE+ 1) > SYSDATE) AND internal_name IN (''OPSTECH'', ''ePDF'', ''PRINT'', ''EDI'')' 
