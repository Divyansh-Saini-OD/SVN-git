create or replace TRIGGER "APPS"."XX_AP_SUPPLIERS_ADD_AIR1" AFTER
INSERT
 ON  "AP"."AP_SUPPLIERS#"  FOR EACH ROW 
...
INSERT
  INTO XX_PO_VENDOR_ADD_AUD
    ...
    VALUES
    (
      XXFIN.XX_PO_VENDOR_ADD_AUD_SEQ.NEXTVAL ,
      'I',
