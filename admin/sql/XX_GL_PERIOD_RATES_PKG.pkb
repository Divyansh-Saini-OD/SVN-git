...
-- +=======================================================================+
  ...
  BEGIN
    ...
    FND_FILE.PUT_LINE(FND_FILE.LOG,'Request type is: ' || p_request_type);
    ...
    FOR r_request IN (SELECT   XFTV.source_value1 request_key
                         ...
                         WHERE XFTD.translation_name = 'GL_RATE_REQUESTS'
                           AND XFTV.translate_id = XFTD.translate_id
                           AND (XFTV.source_value2 = TRIM(p_request_type))        -- we may support other rate types in future, but those files would likely be generated by a separate procedure
