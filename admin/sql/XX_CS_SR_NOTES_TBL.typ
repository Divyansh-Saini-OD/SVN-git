...
create or replace TYPE  XX_CS_SR_NOTES_REC AS OBJECT (
NOTES         VARCHAR2(1000),
...
SET TERM ON
PROMPT Creating tbl type XX_CS_SR_NOTES_TBL
SET TERM OFF


CREATE OR REPLACE
TYPE XX_CS_SR_NOTES_TBL AS TABLE OF XX_CS_SR_NOTES_REC
/
