...
PROMPT
PROMPT Providing Grant on Custom Table XX_PO_MLSS_HDR to Apps......
PROMPT

WHENEVER SQLERROR EXIT 1

PROMPT
PROMPT Providing Grant on the Table XX_PO_MLSS_HDR to Apps .....
PROMPT


GRANT ALL ON  XX_PO_MLSS_HDR TO APPS;


WHENEVER SQLERROR EXIT 1

PROMPT
PROMPT Providing Grant on the Sequence XX_PO_MLSS_HDR_S to Apps .....
PROMPT


GRANT ALL ON  XX_PO_MLSS_HDR_S TO APPS;
