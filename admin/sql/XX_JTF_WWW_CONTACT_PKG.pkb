...
-- +=======================================================================+
-- | Name             :XX_JTF_WWW_CONTACT_PKG.pkb                          |
...
create or replace package body XX_JTF_WWW_CONTACT_PKG
AS 
...
IS
   ...
   lc_package_name         varchar2(32) := 'XX_JTF_WWW_CONTACT_PKG';
...
BEGIN    
  ...
  fnd_file.put_line(fnd_file.LOG,
    lpad('OD: JTF WWW load CONTACTS to CV tables',69,' '));
  ...
  fnd_file.put_line(fnd_file.LOG,
    ...
    ' XXCRM.XX_JTF_WWW_CONTACT_EXTR...');
    
  DELETE FROM XXCRM.XX_JTF_WWW_CONTACT_EXTR;
  ...
  For i in c_api
    LOOP
        ...
        INSERT INTO XXCRM.XX_JTF_WWW_CONTACT_EXTR 
          (BATCH_ID
          ,PARENT_OSR
          ,CONTACT_OSR
          ,ORIG_SYSTEM
    ...
    fnd_file.put_line(fnd_file.LOG,
      ...
      ' XX_JTF_WWW_CONTACT_EXTR: ' || ln_extr_cnt);
    ...
    FROM XXCRM.XX_JTF_WWW_CONTACT_EXTR;
