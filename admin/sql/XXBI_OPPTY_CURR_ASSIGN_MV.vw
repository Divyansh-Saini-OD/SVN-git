...
CREATE MATERIALIZED VIEW APPS.XXBI_OPPTY_CURR_ASSIGN_MV
  BUILD DEFERRED
  REFRESH COMPLETE ON DEMAND
-- +===================================================================+
-- |                  Office Depot - Project Simplify                  |
-- +===================================================================+
-- | Name        :  XXBI_OPPTY_CURR_ASSIGN_MV.vw                       |
-- | Description :  MV for Opportunity Current Assignments             |
-- |                                                                   |
-- |Change Record:                                                     |
-- |===============                                                    |
...
WHERE
       TERR_ENT.entity_type = 'OPPORTUNITY'
...
-- Grant to XXCRM
----------------------------------------------------------
GRANT ALL ON APPS.XXBI_OPPTY_CURR_ASSIGN_MV TO XXCRM;
