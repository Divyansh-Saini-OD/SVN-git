      ...
      -- -------------------------------------------
        ...
        -- -------------------------------------------
          ...
          --put_log_line('[WIP] Fetch 4 Rec - ' || TO_CHAR(SYSDATE,'DD-MON-RRRR HH24:MI:SS') );
			  ...
			  ln_cons_inv_id1          := 0;            --Added for Bill Complete Change NAIT-67168
			  ln_cons_inv_id2          := 0;            --Added for Bill Complete Change NAIT-67168
			  ln_cons_inv_id3          := 0;            --Added for Bill Complete Change NAIT-67168
          -- -------------------------------------------
...
--------------------------------------------------------------
-- Step  #1 -- Check Length of Invoice greater than equal to 11
--------------------------------------------------------------
                 IF  (ln_invoice1_length >= 11) THEN					--NAIT-72199
                     ...
                     ln_tot_inv_rcv_bnk                        := ln_tot_inv_rcv_bnk + 1;   -- Counter for total invoice received from bank
----------------------------------------
