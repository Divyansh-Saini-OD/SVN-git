...
CREATE OR REPLACE PACKAGE BODY XX_CDH_EBL_FILE_NAME_DTL_PKG
...
BEGIN
  XX_CDH_EBL_UTIL_PKG.log_error('p_ebl_file_name_id: ' || p_ebl_file_name_id);

  INSERT
  INTO xx_cdh_ebl_file_name_dtl
    (
      ebl_file_name_id,
      cust_doc_id,
      file_name_order_seq,
...
BEGIN
  ...
  UPDATE xx_cdh_ebl_file_name_dtl
  SET file_name_order_seq  = p_file_name_order_seq,
    field_id               = p_field_id,
  ...
  AND ebl_file_name_id     = p_ebl_file_name_id;
