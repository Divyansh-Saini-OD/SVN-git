...
BEGIN
  ...
  IF NVL(ld_semicolon_cnt,0) != 56 THEN
    lc_error_mesg            := 'Invalid number of columns in data record - expecting 56 columns and data file contains ' || TO_CHAR(ld_semicolon_cnt) || ' columns!';
    raise DATA_ERROR;
  END IF;
