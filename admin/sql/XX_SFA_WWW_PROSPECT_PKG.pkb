...
-- +=======================================================================+
-- | Name             :XX_SFA_WWW_PROSPECT_PKG.pkb                         |
...
create or replace package body XX_SFA_WWW_PROSPECT_PKG
AS 
PROCEDURE sfa_prospect_main 
...
IS
   ...
   lc_package_name         varchar2(32) := 'XX_SFA_WWW_PROSPECT_PKG';
...
BEGIN   
   ...
   fnd_file.put_line(fnd_file.LOG,
     lpad('OD: SFA WWW load PROSPECTS to CV tables',69,' '));
   ...
   fnd_file.put_line(fnd_file.LOG,
     ...
     ' XXCRM.XX_SFA_WWW_PROSPECT_EXTR...');
   DELETE FROM XXCRM.XX_SFA_WWW_PROSPECT_EXTR;
   fnd_file.put_line(fnd_file.LOG,
   ...
   fnd_file.put_line(fnd_file.LOG,
     ' Started deleting existing records from the table' ||  
     ' XXCRM.XX_SFA_WWW_PROSPECT_ADDR...');
   DELETE FROM XXCRM.XX_SFA_WWW_PROSPECT_ADDR;
   fnd_file.put_line(fnd_file.LOG,
     ' Successfully deleted all the records from the table' || 
     ' XXCRM.XX_SFA_WWW_PROSPECT_ADDR...');
   ...
   For i in c_api
     LOOP
        ...
        Insert into XXCRM.XX_SFA_WWW_PROSPECT_ADDR
          (BATCH_ID
          ,CREATED_BY_MODULE
          ,PARTY_ORIG_SYSTEM
       ...
       Insert into XXCRM.XX_SFA_WWW_PROSPECT_EXTR
         (BATCH_ID
         ,PARTY_ORIG_SYSTEM
         ,PARTY_ORIG_SYSTEM_REFERENCE
         ,PARTY_TYPE
    ...
    fnd_file.put_line(fnd_file.LOG,
      ...
      ' XX_SFA_WWW_PROSPECT_EXTR: ' || ln_extr_cnt);
    fnd_file.put_line(fnd_file.LOG,
      ' total number of addresses loaded into stg table' ||
      ' XX_SFA_WWW_PROSPECT_ADDR: ' || ln_addr_cnt);
    ...
    SELECT BATCH_ID
          ...
          ,ATTRIBUTE_CATEGORY
    FROM XXCRM.XX_SFA_WWW_PROSPECT_EXTR;
    ...
    SELECT BATCH_ID
          ...
          ,CREATED_BY
          ,sysdate as CREATION_DATE
    FROM XXCRM.XX_SFA_WWW_PROSPECT_ADDR;
...
END sfa_prospect_main;

END XX_SFA_WWW_PROSPECT_PKG;
/
Show errors
/
