...
-- |2.0		  20-July-21	Sreedhar Mohan	 NAIT-190252 Print debug if XXOD_EXTERNAL_USERS_SYNC_DEBUG_LEVEL > 3
-- +====================================================================================================+
*/
...
--            VALUES (g_session_id, SYSTIMESTAMP, p_message);
     ...
     THEN
        ...
        ELSE
        */ 
        IF fnd_profile.value('XXOD_EXTERNAL_USERS_SYNC_DEBUG_LEVEL') >= 3
        THEN
		--NAIT-162336 ends
        -- Call XX_COMN_DEBUG
     ...
     --END IF; -- g_debug = TRUE AND g_debug_level >= p_debug_level  --NAIT-162336
