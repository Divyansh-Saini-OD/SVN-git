...
email_subject:=instance_name||' '||'OD: Trade Match Merchant Contacts';   --added for jira NAIT-87654
           ...
           /*xx_pa_pb_mail.attach_text( conn => conn,
            ...
            --Added for NAIT-102629
			xx_pa_pb_mail.attach_text( conn => conn,
                                        data => 'Please click on the https://officedepot.sharepoint.com/sites/MCH/MRCHBI/Home/TO%20BE%20PUBLISHED/Merchant%20Contact%20List.xlsx for the merchant contact details ' 
                                       );
