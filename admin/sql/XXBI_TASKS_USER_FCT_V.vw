...
CREATE OR REPLACE VIEW APPS.XXBI_TASKS_USER_FCT_V
-- +===================================================================+
-- |                  Office Depot - Project Simplify                  |
-- +===================================================================+
-- | Name        :  XXBI_TASKS_USER_FCT_V.vw                             |
...
WHERE(((tfmv.created_by = gmi.map_user_id 
OR tfmv.owner_user_id = gmi.map_user_id 
OR (tfmv.assigned_user_id = gmi.map_user_id and
