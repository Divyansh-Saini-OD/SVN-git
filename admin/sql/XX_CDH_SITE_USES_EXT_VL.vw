...
-- +=======================================================================+
-- | Name             :XX_CDH_SITE_USES_EXT_VL.vw                          |
-- | Description      :Site Uses Extension view                            |
-- |                                                                       |
-- |                                                                       |
-- |Change History:                                                        |
-- |---------------                                                        |
...
-- +=======================================================================+
-- -----------------------------------------------------
--      DROP view XX_CDH_SITE_USES_EXT_VL    --
-- -----------------------------------------------------
	DROP VIEW XX_CDH_SITE_USES_EXT_VL;

-- ---------------------------------------------------------------------
--      Create view XX_CDH_SITE_USES_EXT_VL    --
-- ---------------------------------------------------------------------
CREATE  VIEW XX_CDH_SITE_USES_EXT_VL
