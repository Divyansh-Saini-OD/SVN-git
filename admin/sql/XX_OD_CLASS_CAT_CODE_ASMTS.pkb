...
create or replace
PACKAGE BODY XX_OD_CLASS_CAT_CODE_ASMTS AS
-- +=========================================================================================+
...
-- |1.1        31-Aug-2011     Ravi Kumar P	        Modified the code as per Def#13417 for   |
-- |                                               Customer Segmentation Class Category logic|
...
l_loyalty_code        hz_code_assignments.class_code%TYPE;
...
BEGIN
      x_return_status := 'S';
      l_loyalty_code  := nvl(p_loyalty_code,'RG');
      l_segment_code  := nvl(p_segment_code,'OT');
      
        -- Loyalty
        BEGIN
              select  code_assignment_id, object_version_number   into 
                      l_code_assignment_id ,  l_ovn
              from    hz_code_assignments
              where   class_category = 'Customer Loyalty'
             -- and     class_code = ''
              ...
              l_CODE_ASSIGNMENT_REC.class_code := l_loyalty_code;
        ...
        EXCEPTION WHEN NO_DATA_FOUND THEN
              ...
              l_CODE_ASSIGNMENT_REC.class_category := 'Customer Loyalty';
              l_CODE_ASSIGNMENT_REC.class_code := l_loyalty_code;
