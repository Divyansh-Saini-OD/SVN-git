...
-- +=======================================================================+
-- | Name             :XX_CDH_ACCT_SITE_EXT_VL.vw                          |
-- | Description      :Account Site Extension view                         |
-- |                                                                       |
-- |                                                                       |
-- |Change History:                                                        |
-- |---------------                                                        |
...
-- +=======================================================================+
-- -----------------------------------------------------
--      DROP view XX_CDH_ACCT_SITE_EXT_VL    --
-- -----------------------------------------------------
	DROP VIEW XX_CDH_ACCT_SITE_EXT_VL;

-- ---------------------------------------------------------------------
--      Create view XX_CDH_ACCT_SITE_EXT_VL    --
-- ---------------------------------------------------------------------
CREATE  VIEW XX_CDH_ACCT_SITE_EXT_VL
