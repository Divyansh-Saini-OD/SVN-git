CREATE OR REPLACE VIEW XX_PA_PROJECTS_RPT_CFCST_V 
-- +===================================================================+
-- |                  Office Depot - PLM/PA-Project                    |
-- |              Private Brand China Global Sourcing                  |
-- +===================================================================+
-- | Name  :  XX_PA_PROJECTS_RPT_CFCST_V                               |
-- | Description: This View is Created for the PBCGS Reporting         |
-- |              for the PLM/PA team. Total Current Forecast          |
-- |                                                                   |
-- |                                                                   |
-- |Change Record:                                                     |
-- |===============                                                    |
...
GRANT SELECT ON  XX_PA_PROJECTS_RPT_CFCST_V  TO EUL10_US;
/