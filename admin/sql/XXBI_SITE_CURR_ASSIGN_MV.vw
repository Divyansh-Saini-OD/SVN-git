...
CREATE MATERIALIZED VIEW APPS.XXBI_SITE_CURR_ASSIGN_MV
  BUILD DEFERRED
  REFRESH COMPLETE ON DEMAND
-- +===================================================================+
-- |                  Office Depot - Project Simplify                  |
-- +===================================================================+
-- | Name        :  XXBI_SITE_CURR_ASSIGN_MV.vw                        |
...
SELECT 
    ...
    ,TERR_ENT.entity_id party_site_id
...
WHERE
       TERR_ENT.entity_type = 'PARTY_SITE'
...
-- Grant to XXCRM
----------------------------------------------------------
GRANT ALL ON APPS.XXBI_SITE_CURR_ASSIGN_MV TO XXCRM;
