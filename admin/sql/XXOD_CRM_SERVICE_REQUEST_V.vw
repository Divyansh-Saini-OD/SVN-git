CREATE OR REPLACE VIEW XXOD_CRM_SERVICE_REQUEST_V (SR_ID
                                                    ,SR_NUMBER
                                                    ,SR_DATE
                                                    ,SR_URGENCY
                                                    ,SR_SEVERITY
...
-- |                       WIPRO Technologies                          |
-- +===================================================================+
-- | Name         : XXOD_CRM_SERVICE_REQUEST_V                         |
-- | Rice ID      : CTR Reports                                        |
-- | Description  : This view is used to fetch the details of the      |
-- |                Service Requests.                                  |
-- |Change Record :                                                    |
-- |===============                                                    |
...
-- |DRAFT 1B  24-JUN-2008 Sneha Anand        Fixed for Defect 8330     |
-- |Ver 1.C   27-JUN-2008 Michelle Gautier   Modified for Def.8482, 8483|
-- |                      Added Group ID                               |    
-- |Ver 1.D   16-JUL-2009 Bala E             Modified for Def,260      |
-- |Ver 1.E   06-OCT-2009 Bala E             Added Decode function for |
-- |                                         Ship To Seq               |  
-- |Ver 1.F   01-MAR-2011 Raj Jagarlamudi    Calendar change           |
-- |Ver 1.G   21-Feb-2017 Suresh N           GSSC Voilations (Removed Schema Reference) |
-- +===================================================================+
AS 
