CREATE OR REPLACE VIEW XX_PA_PROJECTS_RPT_MNAWHATIF_V 
-- +===================================================================+
-- |                  Office Depot - PLM/PA-Project                    |
-- |              Private Brand China Global Sourcing                  |
-- +===================================================================+
-- | Name  :  XX_PA_PROJECTS_RPT_MNAWHATIF_V                           |
 ...
 SELECT
  ...
  ( SELECT
       ...
       WHERE PPA1.PROJECT_ID > 0 
         ...
         AND PPA1.PROJECT_ID IN (SELECT X.PROJECT_ID FROM XX_PA_PROJECTS_RPT_MNAPROJ_V X)
       ORDER BY PPA1.PROJECT_ID ) A
          LEFT OUTER JOIN 
                XX_PA_PROJECTS_RPT_NEWSALES_V V9 ON 
                A.PROJECT_ID = V9.PROJECT_ID ;
GRANT SELECT ON  XX_PA_PROJECTS_RPT_MNAWHATIF_V  TO EUL10_US;
/