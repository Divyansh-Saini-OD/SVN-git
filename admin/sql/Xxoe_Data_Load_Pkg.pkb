...
BEGIN
  ...
  LOOP
    ...
    WHEN OTHERS THEN
      ...
      AND Process_Flag   = 'P'
      AND status         = 'New';
      DELETE FROM Xxom_Order_Headers_Int WHERE header_id = L_Header_Id;
      DELETE FROM Xxom_Order_Lines_Int WHERE header_id = L_Header_Id;
      DELETE FROM Xxom_Order_Adjustments_Int WHERE header_id = L_Header_Id;
      DELETE FROM Xxom_Order_Tenders_Int WHERE header_id = L_Header_Id;
    END;
  END LOOP;
  UPDATE Xxom_Import_Int
  SET Process_Flag   = 'P',
    ...
    BEGIN
      ...
      INTO Xx_Oe_Order_Headers_All
        ...
        (
          ...
          ,
          DECODE(NVL(I.Dropshipflag,'N'),'Y','Y','N') ,
          I.DELIVERYMETHOD,
      ...
      INTO Xx_Oe_Header_Attributes_All
        ...
        (
          ...
          I.Giftflag ,
          I.Alternateshipper ,
          DECODE(NVL(I.COMMISIONFLAG,'N'),'Y','Y','N'),
          --I.Salelocid ,
          --I.Salelocid ,
          I.Spcacctnumber ,
          I.LOYALTYID,
          ...
          to_date(i.ORDERDATE
          || ' '
          ||SUBSTR(LPAD(i.ORDERCREATETIME,8,0),1,6) ,'RRRR-MM-DD hh24miss') --i.ORDERCREATETIME
          ,
          to_date(i.ORDERDATE
          || ' '
          ||SUBSTR(LPAD(i.ORDERENDTIME,8,0),1,6) ,'RRRR-MM-DD hh24miss') --i.ORDERENDTIME
          ,
          I.Taxableflag ,
          I.ACTIONCODE,
      ...
      SELECT Xx_Oe_Ord_adjustment_Seq.Nextval ,
        ...
        --couponOwner
        --adjustName
      FROM Xxom_Order_Adjustments_Int xoa ,
        Xx_Oe_Order_Lines_All xoline
