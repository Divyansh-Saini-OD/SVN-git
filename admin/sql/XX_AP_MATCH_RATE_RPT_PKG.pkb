...
create or replace 
PACKAGE BODY      xx_ap_match_rate_rpt_pkg
AS
  -- +============================================================================================+
  ...
  ---|  1.6         04-DEC-18     Priyam PArmar     Code Fix for Reclass Invoices NAIT-29696 
  -- +============================================================================================+
...
IS
  ...
  IS
    ...
    AND ou_name        =NVL(p_ou_name,ou_name)
  ----  AND process_date  >=to_date(p_date_from)-120 commented for correct true match count NAIT-29696 
	AND process_date  >=to_date(p_date_from)
...
IS
  ...
  and xev.event_number=1-----NAIT-29696 
  AND A.invoice_type_lookup_code='STANDARD'
  AND A.invoice_num NOT LIKE '%ODDBUIA%'
  AND a.cancelled_date  IS NULL
  AND b.vendor_site_id   =A.vendor_site_id
