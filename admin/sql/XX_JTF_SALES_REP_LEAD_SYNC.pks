...
PROMPT
PROMPT Creating XX_JTF_SALES_REP_LEAD_SYNC package specification
PROMPT

CREATE OR REPLACE PACKAGE XX_JTF_SALES_REP_LEAD_SYNC
-- +===================================================================================+
...
-- |                    Synchronize Lead Named Account' to update the  |
-- |                    the lead in the custom assignments entity table|
-- |                                                                   |
-- +===================================================================+
