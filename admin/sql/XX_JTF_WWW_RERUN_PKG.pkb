...
create or replace package body XX_JTF_WWW_RERUN_PKG
AS 
PROCEDURE jtf_rerun_main 
...
IS
    ln_batch_id             NUMBER;
    ln_batch_cnt            NUMBER;
    lc_package_name         varchar2(32) := 'XX_JTF_WWW_RERUN_PKG';
...
BEGIN    
    ...
    fnd_file.put_line(fnd_file.LOG,
      lpad('OD: JTF WWW rerun batch',69,' '));
