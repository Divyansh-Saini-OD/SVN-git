...
-- |                  Office Depot                                              |
-- +============================================================================+
-- | Name        : XX_ALT_RENEW_CONT_RPT_BURST_F.sql                            |
-- | Rice ID     : XXX                                                          |
...
-- |=======  ===========   =============    ====================================|
-- |1.0      06-Jan-2021   Kayed Ahmed      Initial Version                     |
-- +============================================================================+
SET SHOW         OFF
SET VERIFY       OFF
SET ECHO         OFF
...
PROMPT
PROMPT Creating Function XX_ALT_RENEW_CONT_RPT_BURST_F in APPS.....
PROMPT

CREATE OR REPLACE FUNCTION XX_ALT_RENEW_CONT_RPT_BURST_F
  RETURN BOOLEAN
IS
...
EXCEPTION
WHEN OTHERS THEN
  fnd_file.put_line(fnd_file.log, 'Exception in XX_ALT_RENEW_CONT_RPT_BURST_F function '||SQLERRM );
END XX_ALT_RENEW_CONT_RPT_BURST_F;
/
show error;
exit;