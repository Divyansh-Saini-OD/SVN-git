...
BEGIN
  ...
  u_filehandle := UTL_FILE.FOPEN(p_from_dir,p_from_file,'r');
LOOP
 BEGIN
...
BEGIN
  IF g_debug THEN
    fnd_file.put_line (fnd_file.log,SUBSTR(p_text, 1, 255));
  END IF;
END;
