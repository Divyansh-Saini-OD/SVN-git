...
AS
   ...
   |              custom table XX_OD_XNET_REPORT_DATA_TMP                          |
   |Change Record:                                                             |
   |==============                                                             |
...
FROM XXFIN.XX_AR_OPEN_TRANS_ITM    APS,hz_cust_accounts_all hca,HZ_HIERARCHY_NODES hhn
...
SELECT      HP.party_id                      PARTY_ID,
         ...
         from  APPS.HZ_CUST_ACCOUNTS HCA,
           ...
           APPS.HZ_PARTY_SITES HPS,
            ...
            APPS.AR_COLLECTORS  ARC, 
            APPS.XX_HR_PER_ALL_PEOPLE_F_V HRE,
            APPS.AR_LOOKUPS ALP
where   
...
TYPE T_MAIN IS TABLE OF XX_OD_XNET_REPORT_DATA_TMP%ROWTYPE INDEX BY BINARY_INTEGER;
R_MAIN T_MAIN;
...
DELETE FROM XX_OD_XNET_REPORT_DATA_TMP ;
COMMIT;
...
END LOOP;
 ...
 -- Loading the data into XX_OD_XNET_REPORT_DATA_TMP  table
FORALL i in 1..R_MAIN.count 
insert into XX_OD_XNET_REPORT_DATA_TMP values R_MAIN(i);
commit;
