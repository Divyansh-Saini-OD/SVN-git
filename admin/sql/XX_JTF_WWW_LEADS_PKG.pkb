...
create or replace package body XX_JTF_WWW_LEADS_PKG
AS 
PROCEDURE jtf_leads_main 
...
IS
   ...
   lc_package_name         varchar2(32) := 'XX_JTF_WWW_LEADS_PKG';
...
BEGIN    
   ...
   fnd_file.put_line(fnd_file.LOG,
     lpad('OD: JTF WWW load LEADS to CV tables',69,' '));
   ...
   fnd_file.put_line(fnd_file.LOG,
     ...
     ' XXCRM.XX_JTF_WWW_LEAD_EXTR...');

   DELETE FROM XXCRM.XX_JTF_WWW_LEAD_EXTR;
   ...
   For i in c_api
     LOOP
       ...
       INSERT INTO XXCRM.XX_JTF_WWW_LEAD_EXTR
         (BATCH_ID
         ,PARTIES_OSR
         ,PARTY_SITES_OSR
         ,CONTACT_OSR
    ...
    fnd_file.put_line(fnd_file.LOG,
      ...
      ' XX_JTF_WWW_LEAD_EXTR: ' || ln_extr_cnt);
    ...
    FROM XXCRM.XX_JTF_WWW_LEAD_EXTR;
