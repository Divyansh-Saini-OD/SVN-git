...
SELECT fctmv.*,
       ...
       fctmv.aops_number aops_number_dsc,
       repsmv.user_id,
       repsmv.user_name,
...
FROM xxbi_customer_fct_mv fctmv, XXBI_SITE_CURR_ASSIGN_MV repsmv, XXBI_ACTIVITIES act
WHERE repsmv.party_site_id = fctmv.party_site_id
AND act.source_type(+) = 'PARTY SITE'
AND act.source_id(+) = fctmv.party_site_id
