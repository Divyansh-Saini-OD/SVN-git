/*=============================================================================+
|                                                                              |
| Program Name   : XXPO_ITEM_SUPP_RMS_ATTRIBUTE_REGISTER.sql                   |
|                                                                              |
| Purpose        : To register the custom table XXPO_ITEM_SUPP_RMS_ATTRIBUTE   |
|                  in apps                                                     |
| Change History  :                                                            |
...
DECLARE
 ...
 SELECT *
  ...
  WHERE table_name = 'XXPO_ITEM_SUPP_RMS_ATTRIBUTE';

BEGIN
  AD_DD.register_table(p_appl_short_name => 'FND',
                       p_tab_name => 'XXPO_ITEM_SUPP_RMS_ATTRIBUTE',
                       p_tab_type => 'T'
                      );
