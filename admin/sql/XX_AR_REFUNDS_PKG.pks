CREATE OR REPLACE PACKAGE XX_AR_REFUNDS_PKG
AS
  -- ==============================================================================================================
  ...
  --   1.1        11/15/2007  Deepak Gowda     1. Added P_ORG_ID parameter to Identify proc.
  --   1.2        12/23/2007  Ganga Devi R     Added aops_customer_number for R1.2 CR#714(Defect#2532)
  --   1.3        12/25/2009  Ramya Priya M    Added p_refund_header_id for defect 3340
  --   1.4        03/23/2010  Usha R           Modified the code for defect 4901
  --   1.5        05/04/2010  Usha R           Modified the code for defect 4901
  --   1.6        13/05/2010  Rama Krishna K     Modified the code for defect 5755 to take UNAPP and UNIDENTIFIED trxn's
  --   1.7        11/09/2010  Venkatesh B      Added one parameter p_user_id in the code for defect 8304
  --   1.8        5/04/2011  Gaurav Agarwal    SDR Changes
  --   1.9        8/07/2019  Jitendra A        AR Refund & POS mailcheck interface changes to accommodate using Cloud
  --                                           numbering when Supplier Master in in Cloud
  -- ==============================================================================================================
...
IS
  ...
  PROCEDURE create_refund(
      ...
      p_user_id     IN NUMBER --Added for Defect #8304
    );
  ...
  -- |Version   Date          Author              Remarks                      |
  -- |=======   ==========   =============   ==================================|
  -- |   1      7-AUG-19     Jitendra A     Initial version--Added for #1.9    |
