...
-- |1.10      17-DEC-2018   Aniket Jadhav        Added change NAIT-75659 | 
-- |                                             OPSTECH delivery method |
-- +=====================================================================+
...
-- Consolidated Bill Flag Mismatch
   ...
   -- MBS Doc Sequence Id vs Invoice Type Mismatch Error
      ...
      --Added Aniket CG for defect# NAIT 75659 
	  --Start 
	   FND_FILE.PUT_LINE(FND_FILE.LOG,' Document id :'|| lr_ar_main.Billdocs_doc_id || ' Delivery_Method: '|| lr_ar_main.Delivery_Method);
	  -- Commenting old if adding not in (2,3)
	  -- IF lr_ar_main.Billdocs_doc_type = 'Consolidated Bill' and lr_ar_main.Billdocs_doc_id <> 2 THEN 
      IF lr_ar_main.Billdocs_doc_type = 'Consolidated Bill' and lr_ar_main.Billdocs_doc_id not in (2,3) THEN
      --END       
	  lc_code := '30';
            XX_AR_BILL_INSERT_PROC(lr_ar_main.Customer_id
                                   ,lr_ar_main.Customer_Number
