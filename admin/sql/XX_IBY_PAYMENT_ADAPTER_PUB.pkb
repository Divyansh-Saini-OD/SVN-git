...
PROMPT Creating Package Body XX_IBY_PAYMENT_ADAPTER_PUB
...
-- |1.1      10-JUL-2008  Subbarao B            New Version Applied    |
-- |                                            for the patch 7042544  |
-- |                                                                   |
-- +===================================================================+
...
/* $Header: ibyppadb.pls 115.124 2007/12/26 07:02:16 lmallick ship $ */
    ...
    -- G_PKG_NAME CONSTANT VARCHAR2(30) := 'IBY_PAYMENT_ADAPTER_PUB';
     G_PKG_NAME CONSTANT VARCHAR2(30) := 'XX_IBY_PAYMENT_ADAPTER_PUB';
...
--    iby_utility_pvt.get_property(iby_payment_adapter_pub.C_ECAPP_URL_PROP_NAME,x_baseurl);
    ...
    --Start of Customization for I0349

	SELECT substr(x_baseurl,1,instr(x_baseurl,'/',-1)) ||'oramipp_ods'
    INTO   x_baseurl
    FROM dual;

    --End of Customization for I0349
