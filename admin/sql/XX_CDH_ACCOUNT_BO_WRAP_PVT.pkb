...
CREATE OR REPLACE PACKAGE BODY XX_CDH_ACCOUNT_BO_WRAP_PVT
-- +=========================================================================================+
-- |                  Office Depot                                                           |
-- +=========================================================================================+
-- | Name        : XX_CDH_ACCOUNT_BO_WRAP_PVT                                            |
-- | Description :                                                                           |
-- |                                                                                         |
-- |                                                                                         |
-- |Change Record:                                                                           |
...
AS
  ...
  BEGIN
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_copy_cust_profiles(+)');
       ...
       HZ_CUSTOMER_PROFILE_V2PUB.get_customer_profile_rec (
        ...
        if( l_return_status = 'S') then
            ...
            if (c_is_site_use_exist%ROWCOUNT <1) then
              ...
              --
              XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'do_copy_cust_profiles after create_customer_profile, l_return_status: ' || l_return_status);
              --
              if l_return_status != 'S' THEN
                  if l_msg_count > 0 THEN
                    begin
                      ...
                      XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'do_copy_cust_profiles after create_customer_profile, l_msg_data: ' || l_msg_data);
                  end if;
                  x_return_status := l_return_status;
                  x_msg_count     := l_msg_count;
                  x_msg_data      := l_msg_data;
        ...
        where  cust_account_profile_id = l_cust_account_profile_id;
              ...
              --
              XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'do_copy_cust_profiles after update_customer_profile, l_return_status: ' || l_return_status);
              --
              if l_return_status != 'S' THEN
                  if l_msg_count > 0 THEN
                    begin
                      ...
                      XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'do_copy_cust_profiles after update_customer_profile, l_msg_data: ' || l_msg_data);
                  end if;
                  x_return_status := l_return_status;
                  x_msg_count     := l_msg_count;
                  x_msg_data      := l_msg_data;
...
EXCEPTION
  WHEN OTHERS THEN
      ...
      XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
          ...
          , p_package_name           =>  'XX_CDH_ACCOUNT_BO_WRAP_PVT'            
      ...
      X_RETURN_STATUS := 'E';   
      --X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.do_copy_cust_profiles'   || SQLERRM;
END do_copy_cust_profiles;
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.create_cust_acct_relates(+)');
  ...
  EXCEPTION
      ...
      X_RETURN_STATUS := 'E';   
      X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.create_cust_acct_relates'  || SQLERRM;
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.save_cust_acct_relates(+)');
  ...
  EXCEPTION
      ...
      X_RETURN_STATUS := 'E';   
      X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.save_cust_acct_relates'    || SQLERRM;
END save_cust_acct_relates;
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.create_payment_method(+)');
  ...
  EXCEPTION
    WHEN OTHERS THEN
      ...
      X_RETURN_STATUS := 'E';   
      X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.save_cust_accounts'    || SQLERRM;  
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.save_payment_method(+)');
...
BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.create_cust_profile(+)');
    ...
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_customer_osr      :' || p_acct_osr);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_reactivated_flag  :' || p_reactivated_flag);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_ab_flag           :' || p_ab_flag);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_status            :' || l_cp_rec.status);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_customer_type     :' || lc_customer_type   );
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_cust_template     :' || lc_prof_class_name );
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'x_prof_class_modify :' || l_prof_class_modify);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'x_prof_class_name   :' || l_prof_class_name  );
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'x_prof_class_id     :' || l_prof_class_id    );
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'x_retain_collect_cd :' || l_retain_collect_cd);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'x_collector_code    :' || l_collector_code   );
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'x_collector_name    :' || l_collector_name   );
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'x_errbuf            :' || X_ERRBUF           );
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'x_return_status     :' || l_return_status    );
    ...
    EXCEPTION
      ...
      X_RETURN_STATUS := 'E';   
      X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.create_cust_profile'   || SQLERRM;    
END create_cust_profile;
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.update_cust_profile(+)');
    ...
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_reactivated_flag  :' || p_reactivated_flag);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_ab_flag           :' || p_ab_flag);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_status            :' || 'A');
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_customer_type     :' || lc_customer_type   );
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_cust_template     :' || lc_prof_class_name );
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'x_prof_class_modify :' || l_prof_class_modify);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'x_prof_class_name   :' || l_prof_class_name  );
...
EXCEPTION
  WHEN OTHERS THEN
      ...
      X_RETURN_STATUS := 'E';   
      --X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.update_cust_profile'   || SQLERRM;                                          
...
begin
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_cust_account(+), party_id: ' || l_party_id);
    ...
    --xx debug info
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_cust_account, after create_cust_account, l_return_status:' || l_return_status || ', l_cust_account_id: ' || l_cust_account_id);
    ...
    x_party_id := l_party_id;
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(-)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_cust_account(-)');
...
begin
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_update_cust_account(+)');
...
exception
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo(+)');
    ...
    IF(px_parent_obj_type = 'ORG') THEN
      ...
      do_create_cust_account (
        ...
        x_cust_acct_os        => px_parent_os,
        x_cust_acct_osr       => px_parent_osr,
    ...
    */
    ...
    --xx debug info
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after create_cust_account, l_return_status:' || l_return_status);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after create_cust_account, x_cust_acct_id:' || x_cust_acct_id);
      ...
      IF l_return_status <> FND_API.G_RET_STS_SUCCESS THEN
        ...
        XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
            ...
            , p_logged_by              =>  FND_GLOBAL.user_id                    
            , p_package_name           =>  'HZ_CUST_ACCOUNT_V2PUB'            
            , p_procedure_name         =>  'create_cust_account'              
            , p_bo_table_name          =>  'HZ_CUST_ACCOUNTS'        
            , p_bo_column_name         =>  'CUST_ACCOUNT_ID'       
            , p_bo_column_value        =>  x_cust_acct_id       
            , p_orig_system            =>  x_cust_acct_os 
            , p_orig_system_reference  =>  x_cust_acct_osr
            , p_exception_log          =>  'Exception in calling HZ_CUST_ACCOUNT_V2PUB.create_cust_account from XX_CDH_ACCOUNT_BO_WRAP_PVT.create_cust_acct_relates, x_cust_acct_id: '||x_cust_acct_id 
            , p_oracle_error_code      =>  null    
            , p_oracle_error_msg       =>  null 
        );
      END IF;
    ...
    IF((p_cust_acct_obj.acct_relate_objs IS NOT NULL) AND
      ...
      IF l_return_status <> FND_API.G_RET_STS_SUCCESS THEN
        ...
        XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
              p_bo_process_id          =>  p_bo_process_id        
            , p_bpel_process_id        =>  p_bpel_process_id       
            , p_bo_object_name         =>  'HZ_CUST_ACCT_RELATE_OBJ_TBL'            
            , p_log_date               =>  SYSDATE             
            , p_logged_by              =>  FND_GLOBAL.user_id                    
            , p_package_name           =>  'HZ_CUST_ACCT_BO_PVT'            
            , p_procedure_name         =>  'create_cust_acct_relates'              
            , p_bo_table_name          =>  'HZ_CUST_ACCOUNTS'        
            , p_bo_column_name         =>  'CUST_ACCOUNT_ID'       
            , p_bo_column_value        =>  x_cust_acct_id       
            , p_orig_system            =>  x_cust_acct_os 
            , p_orig_system_reference  =>  x_cust_acct_osr
            , p_exception_log          =>  'Exception in calling HZ_CUST_ACCT_BO_PVT.create_cust_acct_relates from XX_CDH_ACCOUNT_BO_WRAP_PVT.create_cust_acct_relates, x_cust_acct_id: '||x_cust_acct_id 
            , p_oracle_error_code      =>  null    
            , p_oracle_error_msg       =>  null 
        );
      END IF;
      IF l_return_status = 'S' THEN     
        ...
        XX_CDH_CUST_UTIL_BO_PVT.save_gt(
           p_bo_process_id          =>  p_bo_process_id,
           p_bo_entity_name         =>  'HZ_CUST_ACCT_RELATE_OBJ_TBL',
           p_bo_table_id            =>  x_cust_acct_id, 
           p_orig_system            =>  x_cust_acct_os,           
           p_orig_system_reference  =>  x_cust_acct_osr
        );
    ...
    --xx debug info
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after save_cust_acct_contacts, l_return_status:' || l_return_status);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after save_cust_acct_contacts, l_msg_count:' || l_msg_count);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after save_cust_acct_contacts, l_msg_data:' || l_msg_data);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after save_cust_acct_contacts, x_cust_acct_id:' || x_cust_acct_id);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after save_cust_acct_contacts, x_cust_acct_os:' || x_cust_acct_os);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after save_cust_acct_contacts, x_cust_acct_osr:' || x_cust_acct_osr);
      ...
      IF l_return_status <> FND_API.G_RET_STS_SUCCESS THEN
        ...
        XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
              p_bo_process_id          =>  p_bo_process_id        
            , p_bpel_process_id        =>  p_bpel_process_id       
            , p_bo_object_name         =>  'HZ_CUST_ACCT_CONTACT_BO_TBL'            
            , p_log_date               =>  SYSDATE             
            , p_logged_by              =>  FND_GLOBAL.user_id                    
            , p_package_name           =>  'HZ_CUST_ACCT_CONTACT_BO_PVT'            
            , p_procedure_name         =>  'save_cust_acct_contacts'              
            , p_bo_table_name          =>  'HZ_CUST_ACCOUNTS'        
            , p_bo_column_name         =>  'CUST_ACCOUNT_ID'      
            , p_bo_column_value        =>  x_cust_acct_id       
            , p_orig_system            =>  x_cust_acct_os 
            , p_orig_system_reference  =>  x_cust_acct_osr
            , p_exception_log          =>  'Exception in calling HZ_CUST_ACCT_CONTACT_BO_PVT.save_cust_acct_contacts from XX_CDH_ACCOUNT_BO_WRAP_PVT.create_cust_acct_relates, x_cust_acct_id: '||x_cust_acct_id 
            , p_oracle_error_code      =>  null    
            , p_oracle_error_msg       =>  null 
        );
      END IF;
      IF l_return_status = 'S' THEN     
        ...
        XX_CDH_CUST_UTIL_BO_PVT.save_gt(
           p_bo_process_id          =>  p_bo_process_id,
           p_bo_entity_name         =>  'HZ_CUST_ACCT_CONTACT_BO_TBL',
           p_bo_table_id            =>  x_cust_acct_id, 
           p_orig_system            =>  x_cust_acct_os,           
           p_orig_system_reference  =>  x_cust_acct_osr
        );
    ...
    IF((p_cust_acct_obj.cust_acct_site_objs IS NOT NULL) AND
      ...
      --xx debug info
      XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after save_cust_acct_sites, l_return_status:' || l_return_status);
      ...
      IF l_return_status <> FND_API.G_RET_STS_SUCCESS THEN
        ...
        XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
            ...
            , p_log_date               =>  SYSDATE             
            , p_logged_by              =>  FND_GLOBAL.user_id                    
            , p_package_name           =>  'HZ_CUST_ACCT_SITE_BO_PVT'            
            , p_procedure_name         =>  'save_cust_acct_sites'              
            , p_bo_table_name          =>  'HZ_CUST_ACCOUNTS'        
            , p_bo_column_name         =>  'CUST_ACCOUNT_ID'      
            , p_bo_column_value        =>  x_cust_acct_id       
            , p_orig_system            =>  x_cust_acct_os 
            , p_orig_system_reference  =>  x_cust_acct_osr
            , p_exception_log          =>  'Exception in calling HZ_CUST_ACCT_SITE_BO_PVT.save_cust_acct_sites from XX_CDH_ACCOUNT_BO_WRAP_PVT.create_cust_acct_relates, x_cust_acct_id: '||x_cust_acct_id 
            , p_oracle_error_code      =>  null    
            , p_oracle_error_msg       =>  null 
        );
      END IF;
      IF l_return_status = 'S' THEN     
        ...
        XX_CDH_CUST_UTIL_BO_PVT.save_gt(
           p_bo_process_id          =>  p_bo_process_id,
           p_bo_entity_name         =>  'HZ_CUST_ACCT_SITE_BO_TBL',
           p_bo_table_id            =>  x_cust_acct_id, 
           p_orig_system            =>  x_cust_acct_os,           
           p_orig_system_reference  =>  x_cust_acct_osr
        );
    ...
    */
    ...
    create_cust_profile(
      ...
      p_ab_flag                 => p_ab_flag,
      p_reactivated_flag        => p_reactivated_flag,
      p_cust_type               => p_cust_acct_obj.attribute18,	  
      p_bo_process_id           => p_bo_process_id,
      p_bpel_process_id         => p_bpel_process_id,
      p_created_by_module       => p_created_by_module,
      x_return_status           => l_return_status, 
    ...
    */
    ...
    --xx debug info
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after create_cust_profile, l_return_status:' || l_return_status);
      ...
      IF l_return_status <> FND_API.G_RET_STS_SUCCESS THEN
        ...
        XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
            ...
            , p_orig_system            =>  x_cust_acct_os 
            , p_orig_system_reference  =>  x_cust_acct_osr
            , p_exception_log          =>  'Exception in calling create_cust_profile from XX_CDH_ACCOUNT_BO_WRAP_PVT.create_cust_acct_relates, x_cust_acct_id: '||x_cust_acct_id 
            , p_oracle_error_code      =>  null    
            , p_oracle_error_msg       =>  null 
        );
      END IF;
    ...
    IF((p_cust_acct_obj.cust_profile_obj.cust_profile_amt_objs IS NOT NULL) AND
      ...
      --xx debug info
      XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after create_cust_profile_amts, l_return_status:' || l_return_status);
    ...
    IF((p_cust_acct_obj.bank_acct_use_objs IS NOT NULL) AND
      ...
      --xx debug info
      XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after save_bank_acct_uses, l_return_status:' || l_return_status);
    ...
    IF(p_cust_acct_obj.payment_method_obj IS NOT NULL) THEN
      ...
      --xx debug info
      XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo, after create_payment_method, l_return_status:' || l_return_status);
  ...
  EXCEPTION
    WHEN fnd_api.g_exc_error THEN
      ...
      L_RETURN_STATUS := 'E';        
      X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_contr_cust_acct_bo'         || SQLERRM;                                                                                  
    WHEN OTHERS THEN
      ROLLBACK TO do_create_contr_cust_acct_bo;        
      --call exception process
      XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_dir_cust_acct_bo(+)');
  ...
  EXCEPTION
    WHEN fnd_api.g_exc_error THEN
      ...
      L_RETURN_STATUS := 'E';        
      X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.do_create_dir_cust_acct_bo'         || SQLERRM;                                                                                  
    WHEN OTHERS THEN
      ROLLBACK TO do_create_dir_cust_acct_bo;        
      --call exception process
      XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_update_contr_cust_acct_bo(+)');
    ...
    -------------------------------------
    ---*****IMPORTANT******
    --Prepup cust_site_use object for CA site uses using XX_CDH_BPEL_RETAIL_ORG_PKG
    ---*****IMPORTANT******
    -- create cust account site uses will include cust acct site use plus site use profile
    -- need to put customer account id and customer account site id
    IF((p_cust_acct_obj.cust_acct_site_objs IS NOT NULL) AND
  ...
  EXCEPTION
    WHEN fnd_api.g_exc_error THEN
      ...
      L_RETURN_STATUS := 'E';        
      X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.do_update_contr_cust_acct_bo'         || SQLERRM;                                                                                  
    WHEN OTHERS THEN
      ROLLBACK TO do_update_contr_cust_acct_bo;        
      --call exception process
      XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_update_dir_cust_acct_bo(+)');
  ...
  EXCEPTION
    WHEN fnd_api.g_exc_error THEN
      ...
      L_RETURN_STATUS := 'E';        
      X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.do_update_dir_cust_acct_bo'         || SQLERRM;                                                                                  
    WHEN OTHERS THEN
      ROLLBACK TO do_update_dir_cust_acct_bo;        
      --call exception process
      XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_save_contr_cust_acct_bo(+)');
  ...
  EXCEPTION
    WHEN fnd_api.g_exc_error THEN
      ...
      L_RETURN_STATUS := 'E';        
      X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.do_save_contr_cust_acct_bo'         || SQLERRM;                                                                                  
    WHEN OTHERS THEN
      --call exception process
      XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
           p_bo_process_id          =>  p_BO_PROCESS_ID        
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)XX_CDH_ACCOUNT_BO_WRAP_PVT.do_save_dir_cust_acct_bo(+)');
  ...
  EXCEPTION
    WHEN fnd_api.g_exc_error THEN
      ...
      L_RETURN_STATUS := 'E';        
      X_ERRBUF        := 'Error in XX_CDH_ACCOUNT_BO_WRAP_PVT.do_save_dir_cust_acct_bo'         || SQLERRM;                                                                                  
    WHEN OTHERS THEN
      --call exception process
      XX_CDH_CUST_UTIL_BO_PVT.LOG_EXCEPTION (
           p_bo_process_id          =>  p_BO_PROCESS_ID        
  ...
  BEGIN
    ...
    --debug msg
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(+)In XX_CDH_ACCOUNT_BO_WRAP_PVT.save_cust_accounts(+)');
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_parent_id: ' || p_parent_id);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_parent_os: ' || p_parent_os);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_parent_osr: ' || p_parent_osr);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_parent_obj_type: ' || p_parent_obj_type);
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, 'p_cust_prof_cls_name: ' || p_cust_prof_cls_name);
    ...
    */
    ...
    IF(p_create_update_flag = 'C') THEN
      ...
      FOR i IN 1..p_account_objs.COUNT LOOP
        IF (p_account_objs(i).attribute18 = 'CONTRACT') THEN
          do_create_contr_cust_acct_bo(     
    ...
    x_cust_acct_id := l_ca_id;
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(=)In XX_CDH_ACCOUNT_BO_WRAP_PVT.save_cust_accounts, x_cust_acct_id' || x_cust_acct_id);
    -- Debug info.
    XX_CDH_CUST_UTIL_BO_PVT.log_msg(p_bo_process_id, '(-)In XX_CDH_ACCOUNT_BO_WRAP_PVT.save_cust_accounts(-)');
...
END XX_CDH_ACCOUNT_BO_WRAP_PVT;
/
SHOW ERRORS;
