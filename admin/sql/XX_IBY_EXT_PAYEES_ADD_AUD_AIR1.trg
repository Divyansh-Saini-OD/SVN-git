CREATE OR REPLACE TRIGGER "APPS"."XX_IBY_EXT_PAYEES_ADD_AUD_AIR1" AFTER
  INSERT ON "APPS"."IBY_EXTERNAL_PAYEES_ALL" FOR EACH ROW
  
  -- +===============================================================================+
    -- |                  Office Depot - Project Simplify                              |
    -- +===============================================================================+
    -- | Name        : XX_IBY_EXT_PAYEES_ADD_AUD_AIR1.trg                              |
...
OPEN c1;
   ...
   EXIT WHEN c1%notfound;
      insert into XX_IBY_EXT_PAYEES_ALL_AUD(EXT_PAYEE_AUDIT_ID
,VERSIONS_OPERATION
,VERSION_TIMESTAMP
,SUPPLIER_SITE_ID
,LAST_UPDATE_DATE
...
,REMIT_ADVICE_EMAIL
,REMIT_ADVICE_FAX)
values (XX_IBY_EXT_PAYEES_ALL_AUD_SEQ.nextval,
'I',
systimestamp
