...
CREATE OR REPLACE PACKAGE BODY XX_CDH_EBL_CONTACTS_PKG 
...
BEGIN
  ...
  SET org_contact_id	   = p_org_contact_id,
  ...
  AND ebl_doc_contact_id   = p_ebl_doc_contact_id ;
