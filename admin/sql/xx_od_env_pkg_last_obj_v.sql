-- This query will display the most current version for all objects of a specific   
-- package that has been applied to a specified environment(aka DB instance)
--
-- The query requires 2 parameters
--      Package Number
...
--
CREATE OR REPLACE FORCE VIEW xx_od_env_pkg_last_obj_v (
     package_number
    ,description
    ,project_code
    ,status_code
...
WHERE
        oe.package_id = pl.package_id 
    AND p.package_id = pl.package_id
