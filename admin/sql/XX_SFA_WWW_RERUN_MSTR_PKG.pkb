...
-- +=======================================================================+
-- | Name             :XX_SFA_WWW_RERUN_MSTR_PKG.pkb                       |
...
create or replace package body XX_SFA_WWW_RERUN_MSTR_PKG
AS 
PROCEDURE sfa_rerun_mstr_main 
...
IS
    ...
    lc_package_name         varchar2(32) := 'XX_SFA_WWW_RERUN_MSTR_PKG';
...
BEGIN    
    ...
    fnd_file.put_line (fnd_file.log,' ');
    lc_request_set := 'XX_SFA_WWW_RERUN_SET';
...
--
    fnd_file.put_line (fnd_file.log,' ');
    Lc_program_name := 'XX_SFA_WWW_RERUN';
...
END sfa_rerun_mstr_main;

END XX_SFA_WWW_RERUN_MSTR_PKG;
/
Show errors
/
