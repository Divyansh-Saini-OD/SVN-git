...
CREATE MATERIALIZED VIEW XXBI_SALES_LEAD_REPS_FCT_MV
  REFRESH COMPLETE ON DEMAND
-- +===================================================================+
-- |                  Office Depot - Project Simplify                  |
-- +===================================================================+
-- | Name        :  XXBI_SALES_LEAD_REPS_FCT_MV.vw                     |
-- | Description :  Sales Leads Reps MV                                |
-- |                                                                   |
-- |Change Record:                                                     |
-- |===============                                                    |
...
SELECT 
	...
	,apps.jtf_rs_groups_vl grp
     where 
	TERR_ENT.ENTITY_ID=asl.sales_lead_id
