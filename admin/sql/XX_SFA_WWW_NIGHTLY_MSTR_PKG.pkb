...
-- +=======================================================================+
-- | Name             :XX_SFA_WWW_NIGHTLY_MSTR_PKG.pkb                     |
...
create or replace package body XX_SFA_WWW_NIGHTLY_MSTR_PKG
AS 
PROCEDURE sfa_nightly_mstr_main 
...
IS
    ...
    lc_package_name         varchar2(32) := 'XX_SFA_WWW_NIGHTLY_MSTR_PKG';
...
BEGIN    
    ...
    fnd_file.put_line (fnd_file.log,' ');
    lc_request_set := 'XX_SFA_WWW_NIGHTLY_SET';
...
--
    fnd_file.put_line (fnd_file.log,' ');
    Lc_program_name := 'XX_SFA_WWW_VALIDATE';
...
--
    fnd_file.put_line (fnd_file.log,' ');
    Lc_program_name := 'XX_SFA_WWW_PROSPECT_MSTR';
...
--
    fnd_file.put_line (fnd_file.log,' ');
    Lc_program_name := 'XX_SFA_WWW_CONTACT_MSTR';
...
--
    ...
    fnd_file.put_line (fnd_file.log,' ');
    Lc_program_name := 'XX_SFA_WWW_LEAD_MSTR'; 
...
EXCEPTION
    ...
    WHEN OTHERS THEN
      ...
      x_retcode := 2;
END sfa_nightly_mstr_main;

END XX_SFA_WWW_NIGHTLY_MSTR_PKG;
/
Show errors
/
