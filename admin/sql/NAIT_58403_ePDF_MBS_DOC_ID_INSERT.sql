...
-- | Description : This Script is used to insert two new MBS Doc    ID's(10240,25674)          |
-- |               for ePDF Dely Method for SKU Level Tax and SKU Level Total                  |
-- |Change Record:                                                                             |
-- |===============                                                                            |
...
INTO XX_CDH_MBS_DOCUMENT_MASTER
  ...
  (
    /*(SELECT MAX(document_id)+1
      FROM  XXCRM.XX_CDH_MBS_DOCUMENT_MASTER
