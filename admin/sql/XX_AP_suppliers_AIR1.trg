...
CREATE OR REPLACE TRIGGER apps.XX_AP_suppliers_AIR1 AFTER
--INSERT ON apps.po_vendors FOR EACH ROW
INSERT ON apps.ap_suppliers FOR EACH ROW   --Commented/Added for R12 Upgrade retrofit

  -- +===============================================================================+
  -- |                  Office Depot - Project Simplify                              |
  -- |                Oracle NAIO Consulting Organization                            |
  -- +===============================================================================+
  -- | Name        : XX_AP_suppliers_AIR1.trg                                          |
