...
-- +=======================================================================+
-- | Name             :XX_SFA_WWW_CONTACT_MSTR_PKG.pkb                     |
...
create or replace package body XX_SFA_WWW_CONTACT_MSTR_PKG
AS 
PROCEDURE sfa_contact_mstr_main 
...
IS
    ...
    lc_process_name         varchar2(32) := 'SFA WWW CONTACT';
    lc_program_name         VARCHAR2(32);
    lc_stage_name           varchar2(32);
    lc_package_name         varchar2(32) := 'XX_SFA_WWW_CONTACT_MSTR_PKG';
...
--  
    fnd_file.put_line (fnd_file.log,' ');
    lc_request_set := 'XX_SFA_WWW_CONTACT_SET';
...
--
    fnd_file.put_line (fnd_file.log,' ');
    Lc_program_name := 'XX_SFA_WWW_CONTACT';
...
END sfa_contact_mstr_main;

END XX_SFA_WWW_CONTACT_MSTR_PKG;
/
Show errors
/
