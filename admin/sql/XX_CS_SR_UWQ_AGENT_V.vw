...
-- |                                                                   | 
-- +===================================================================+
CREATE OR REPLACE FORCE VIEW XX_CS_SR_UWQ_AGENT_V (INCIDENT_ID, INCIDENT_NUMBER, STATUS, SUMMARY, OWNER_ID, OWNER_GROUP_ID, OWNER, SR_TYPE, ESCALATED, INCIDENT_SEVERITY_ID, INCIDENT_STATUS_ID, INCIDENT_TYPE_ID, RESOURCE_TYPE, RESOURCE_ID, SEVERITY, IEU_OBJECT_FUNCTION, IEU_OBJECT_PARAMETERS, IEU_MEDIA_TYPE_UUID, IEU_PARAM_PK_COL, IEU_PARAM_PK_VALUE, EXPECTED_RESOLUTION_DATE, OBLIGATION_DATE, CREATION_DATE, MODIFIED_DATE, PROBLEM_CODE, RESOLUTION_CODE, URGENCY, LINKED_ORDERS, ELAPSED_TIME, TMZ_PRIORITY, TM_TO_RESP, TM_TO_RESOL, TIME_ZONE_ID, TIMEZONE_CODE, OBJECT_VERSION_NUMBER)
AS
  SELECT inc_b.incident_id,
    ...
    urg.name urgency,
    DECODE(inc_b.incident_attribute_12,NULL,inc_b.incident_attribute_1,inc_b.incident_attribute_1
    ||','
    ||inc_b.incident_attribute_12) linked_orders,
