-- $Id: XXBI_USER_SITE_DTL_MGR_FCT_V.vw 69444 2010-03-20 10:44:38 -0400Z Kishor Jena $
-- $Rev:  $
-- $HeadURL: https://svn.na.odcorp.net/od/crm/trunk/xxcrm/admin/sql/XXBI_USER_SITE_DTL_MGR_FCT_V.vw $
-- $Author: Kishore Jena $
...
-- +===================================================================+
-- | Name        :  XXBI_USER_SITE_DTL_MGR_FCT_V.vw                    |
-- | Description :  MGR. Customer/Prospect Dashboard View              |
-- |                                                                   |
-- |Change Record:                                                     |
-- |===============                                                    |
...
CREATE OR REPLACE VIEW APPS.XXBI_USER_SITE_DTL_VP_FCT_V AS
...
where   sdtl.rsd_user_id in (select distinct a.rsd_user_id
                            from   apps.xxbi_group_mbr_info_mv  a
                            where  (a.user_id    = FND_GLOBAL.USER_ID or 
                                    a.m1_user_id = FND_GLOBAL.USER_ID or 
                                    a.m2_user_id = FND_GLOBAL.USER_ID or 
                                    a.m3_user_id = FND_GLOBAL.USER_ID or
                                    a.m4_user_id = FND_GLOBAL.USER_ID or
                                    a.m5_user_id = FND_GLOBAL.USER_ID 
                                   )
                           )
  and (sdtl.user_id = FND_GLOBAL.USER_ID or sdtl.m1_user_id = FND_GLOBAL.USER_ID or
       sdtl.m2_user_id = FND_GLOBAL.USER_ID or sdtl.m3_user_id = FND_GLOBAL.USER_ID or
       sdtl.m4_user_id = FND_GLOBAL.USER_ID or sdtl.m5_user_id = FND_GLOBAL.USER_ID
      )
  and NVL(sdtl.duplicate_view, 'N') = 'N' 
