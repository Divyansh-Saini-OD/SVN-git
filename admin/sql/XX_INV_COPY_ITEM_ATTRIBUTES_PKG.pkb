create or replace 
package body xx_inv_copy_item_attributes_pkg
as
-- +========================================================================================================================+
-- |                  Office Depot - Project Simplify                                                                       |
-- |                  Office Depot                                                                                          |
-- +========================================================================================================================+
-- | Name  : XX_INV_COPY_ITEM_ATTRIBUTES_PKG                                                                                  |
-- | Rice ID:                                                                                                          |
...
begin
     ...
     begin
          select application_id
           ...
           where responsibility_key = 'xx_us_inventory';  --od inv inventory
...
end xx_inv_copy_item_attributes_pkg;