...
BEGIN
  ...
  DELETE FROM XXFIN.XXOD_EBAY_MPL_TRANS_RES;
  ...
  INSERT
  INTO XXFIN.XXOD_EBAY_MPL_TRANS_RES VALUES
    (
      LCLOB_BUFFER
    );
  ...
  IF L_LOOP_COUNT > 1 THEN
    ...
    LOOP
      ...
      WHEN UTL_HTTP.END_OF_BODY THEN
        UTL_HTTP.END_RESPONSE(L_RES);
      END;
      INSERT INTO XXFIN.XXOD_EBAY_MPL_TRANS_RES VALUES
        (LCLOB_BUFFER
        );
      SELECT TOTAL_TRANS,
        NEXT_PAGE
...
-- Delete existing records for Order JSON 
  DELETE FROM XXFIN.XXOD_EBAY_MPL_ORDER_RES;
 ...
 BEGIN
  ...
  INSERT INTO XXFIN.XXOD_EBAY_MPL_ORDER_RES VALUES
    (LCLOB_BUFFER);
...
IS
  ...
  IS
    SELECT TRANSACTIONID,
      ...
      TRANSACTIONDATE,
      TRANSACTIONSTATUS
    FROM XXFIN.XXOD_EBAY_MPL_TRANS_RES,
  ...
  IS
    ...
    FROM XXFIN.XXOD_EBAY_MPL_ORDER_RES,
  ...
  LOOP
    ...
    LOOP
      ...
      INTO XX_CE_MARKETPLACE_PRE_STG
        ...
        VALUES
        (
          XXFIN.XXOD_EBAY_MPL_SEQ.NEXTVAL,
          'EBAY_MPL_NEW',
          T.PAYOUTID,
          'EBAY_FINANCE_API',
          'N',
