...
// ---------------------------------------------------------------------
public class VendMootDropshipDtVORowImpl extends ViewRowImpl {
    /**
     ...
     */
    public VendMootDropshipDtVORowImpl() {
    }
...
//        return (BigDecimal) getAttributeInternal(SUMINVAMOUNT);
        return ((VendMootDropshipDtVOImpl)getViewObject()).getSumInvoiceAmt();
    }
...
//        return (BigDecimal) getAttributeInternal(SUMQTYHOLDAMT);
        return ((VendMootDropshipDtVOImpl)getViewObject()).getSumQtyHoldAmt();
    }
...
//        return (BigDecimal) getAttributeInternal(SUMPRICEHOLDAMT);
        return ((VendMootDropshipDtVOImpl)getViewObject()).getSumPriceHoldAmt();
    }
