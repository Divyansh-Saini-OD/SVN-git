...
// ---------------------------------------------------------------------
public class VendMootDtVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public VendMootDtVOImpl() {
    }
    ...
    while(rsi.hasNext()){
     VendMootDtVORowImpl  row = (VendMootDtVORowImpl)rsi.next();
    ...
    /**
     * Returns the bind variable value for p_disc.
     * @return bind variable value for p_disc
     */
    public String getp_disc() {
        return (String) getNamedWhereClauseParam("p_disc");
    }

    /**
     * Sets <code>value</code> for bind variable p_disc.
     * @param value value to bind as p_disc
     */
    public void setp_disc(String value) {
        setNamedWhereClauseParam("p_disc", value);
    }

    /**
     * Returns the bind variable value for p_fr_gldate.
     * @return bind variable value for p_fr_gldate
     */
    public Date getp_fr_gldate() {
        return (Date) getNamedWhereClauseParam("p_fr_gldate");
    }

    /**
     * Sets <code>value</code> for bind variable p_fr_gldate.
     * @param value value to bind as p_fr_gldate
     */
    public void setp_fr_gldate(Date value) {
        setNamedWhereClauseParam("p_fr_gldate", value);
    }

    /**
     * Returns the bind variable value for p_to_gldate.
     * @return bind variable value for p_to_gldate
     */
    public Date getp_to_gldate() {
        return (Date) getNamedWhereClauseParam("p_to_gldate");
    }

    /**
     * Sets <code>value</code> for bind variable p_to_gldate.
     * @param value value to bind as p_to_gldate
     */
    public void setp_to_gldate(Date value) {
        setNamedWhereClauseParam("p_to_gldate", value);
    }
}
