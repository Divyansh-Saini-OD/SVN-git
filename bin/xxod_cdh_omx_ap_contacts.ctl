...
-- |                            Office Depot                                     |
-- +=============================================================================+
-- | Name            : xx_cdh_omx_ap_contacts.ctl                                |
-- | Rice ID         : 701                                                       |
-- | Description     : ContRol File to load the xx_cdh_omx_ap_contacts_stg       |
...
LOAD DATA
APPEND
INTO TABLE xx_cdh_omx_ap_contacts_stg
WHEN (1) = 'D' 
