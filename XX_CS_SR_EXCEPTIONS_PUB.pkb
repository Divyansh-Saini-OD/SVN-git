create or replace PACKAGE BODY XX_CS_SR_EXCEPTIONS_PUB
IS
-- +===================================================================+
-- |                  Office Depot - Project Simplify                  |
-- |                  Oracle Consulting Organization                   |
-- +===================================================================+
-- | Name  :        XX_CS_SR_EXCEPTIONS_PUB                               |
...
PROCEDURE log_error( p_application_name        IN VARCHAR2  DEFAULT 'EBS'
  ...
  BEGIN
    ...
    -- -------------------------------------------------------------
    SELECT XXCRM.XX_CS_SR_EXCEPTIONS_S.NEXTVAL
    ...
    INSERT INTO XX_CS_SR_EXCEPTIONS
                  ( EXCEPTION_ID
                  ,PROCESS_ID
		    ,PROCESS_NAME
		    ,MODULE_NAME
  ...
  BEGIN
       XX_CS_SR_EXCEPTIONS_PUB.log_error
