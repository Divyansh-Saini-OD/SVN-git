...
FROM APPS.hz_customer_profiles hzcp,
     apps.xx_cdh_a_ext_billdocs_v xxcdh,
     apps.ra_terms ratl
WHERE hzcp.standard_terms  <> ratl.term_id
      AND ratl.attribute1 IS NOT NULL
	AND ratl.name = xxcdh.billdocs_payment_term
	AND  hzcp.cons_inv_flag = 'Y'
        AND hzcp.status = 'A'
	AND hzcp.site_use_id IS NULL
	AND xxcdh.BILLDOCS_PAYDOC_IND = 'Y'
	AND to_char(xxcdh.cust_account_id) = to_char(hzcp.cust_account_id)
	AND xxcdh.billdocs_doc_type = 'Consolidated Bill';
        


CURSOR CONSO_CUST_SITE(p_cust_account_id NUMBER) IS
SELECT distinct hzcp.cust_account_profile_id
,hzcp.cust_account_id
,hzcp.status
,hzcp.collector_id
...
FOR cust_rec IN CONSO_CUSTOMER
LOOP

SELECT account_number 
INTO l_customer_number
FROM hz_cust_accounts
WHERE cust_account_id = cust_rec.cust_account_id;


l_customer_profile_rec.cust_account_profile_id    		:=   cust_rec.cust_account_profile_id;
l_customer_profile_rec.cust_account_id    				:=   cust_rec.cust_account_id;
l_customer_profile_rec.status    						:=   cust_rec.status;
l_customer_profile_rec.collector_id    					:=   cust_rec.collector_id;
l_customer_profile_rec.credit_analyst_id    			:=   cust_rec.credit_analyst_id;
l_customer_profile_rec.credit_checking    				:=   cust_rec.credit_checking;
l_customer_profile_rec.next_credit_review_date    		:=   cust_rec.next_credit_review_date;
l_customer_profile_rec.tolerance    					:=   cust_rec.tolerance;
l_customer_profile_rec.discount_terms    				:=   cust_rec.discount_terms;
l_customer_profile_rec.dunning_letters    				:=   cust_rec.dunning_letters;
l_customer_profile_rec.interest_charges    				:=   cust_rec.interest_charges;
l_customer_profile_rec.send_statements    				:=   cust_rec.send_statements;
l_customer_profile_rec.credit_balance_statements    	:=   cust_rec.credit_balance_statements;
l_customer_profile_rec.credit_hold    					:=   cust_rec.credit_hold;
l_customer_profile_rec.profile_class_id    				:=   cust_rec.profile_class_id;
l_customer_profile_rec.site_use_id    					:=   cust_rec.site_use_id;
l_customer_profile_rec.credit_rating    				:=   cust_rec.credit_rating;
l_customer_profile_rec.risk_code    					:=   cust_rec.risk_code;
l_customer_profile_rec.standard_terms    				:=   cust_rec.term_id;
l_customer_profile_rec.override_terms    				:=   cust_rec.override_terms;
l_customer_profile_rec.dunning_letter_set_id    		:=   cust_rec.dunning_letter_set_id;
l_customer_profile_rec.interest_period_days    			:=   cust_rec.interest_period_days;
l_customer_profile_rec.payment_grace_days    			:=   cust_rec.payment_grace_days;
l_customer_profile_rec.discount_grace_days    			:=   cust_rec.discount_grace_days;
l_customer_profile_rec.statement_cycle_id    			:=   cust_rec.statement_cycle_id;
l_customer_profile_rec.account_status    				:=   cust_rec.account_status;
l_customer_profile_rec.percent_collectable    			:=   cust_rec.percent_collectable;
l_customer_profile_rec.autocash_hierarchy_id    		:=   cust_rec.autocash_hierarchy_id;
l_customer_profile_rec.attribute_category    			:=   cust_rec.attribute_category;
l_customer_profile_rec.attribute1    					:=   cust_rec.attribute1;
l_customer_profile_rec.attribute2    :=   cust_rec.attribute2;
l_customer_profile_rec.attribute3    :=   cust_rec.attribute3;
l_customer_profile_rec.attribute4    :=   cust_rec.attribute4;
l_customer_profile_rec.attribute5    :=   cust_rec.attribute5;
l_customer_profile_rec.attribute6    :=   cust_rec.attribute6;
l_customer_profile_rec.attribute7    :=   cust_rec.attribute7;
l_customer_profile_rec.attribute8    :=   cust_rec.attribute8;
l_customer_profile_rec.attribute9    :=   cust_rec.attribute9;
l_customer_profile_rec.attribute10    :=   cust_rec.attribute10;
l_customer_profile_rec.attribute11    :=   cust_rec.attribute11;
l_customer_profile_rec.attribute12    :=   cust_rec.attribute12;
l_customer_profile_rec.attribute13    :=   cust_rec.attribute13;
l_customer_profile_rec.attribute14    :=   cust_rec.attribute14;
l_customer_profile_rec.attribute15    :=   cust_rec.attribute15;
l_customer_profile_rec.auto_rec_incl_disputed_flag    	:=   cust_rec.auto_rec_incl_disputed_flag;
l_customer_profile_rec.tax_printing_option    			:=   cust_rec.tax_printing_option;
l_customer_profile_rec.charge_on_finance_charge_flag    :=   cust_rec.charge_on_finance_charge_flag;
l_customer_profile_rec.grouping_rule_id    				:=   cust_rec.grouping_rule_id;
l_customer_profile_rec.clearing_days    				:=   cust_rec.clearing_days;
l_customer_profile_rec.jgzz_attribute_category    :=   cust_rec.jgzz_attribute_category;
l_customer_profile_rec.jgzz_attribute1    :=   cust_rec.jgzz_attribute1;
l_customer_profile_rec.jgzz_attribute2    :=   cust_rec.jgzz_attribute2;
l_customer_profile_rec.jgzz_attribute3    :=   cust_rec.jgzz_attribute3;
l_customer_profile_rec.jgzz_attribute4    :=   cust_rec.jgzz_attribute4;
l_customer_profile_rec.jgzz_attribute5    :=   cust_rec.jgzz_attribute5;
l_customer_profile_rec.jgzz_attribute6    :=   cust_rec.jgzz_attribute6;
l_customer_profile_rec.jgzz_attribute7    :=   cust_rec.jgzz_attribute7;
l_customer_profile_rec.jgzz_attribute8    :=   cust_rec.jgzz_attribute8;
l_customer_profile_rec.jgzz_attribute9    :=   cust_rec.jgzz_attribute9;
l_customer_profile_rec.jgzz_attribute10    :=   cust_rec.jgzz_attribute10;
l_customer_profile_rec.jgzz_attribute11    :=   cust_rec.jgzz_attribute11;
l_customer_profile_rec.jgzz_attribute12    :=   cust_rec.jgzz_attribute12;
l_customer_profile_rec.jgzz_attribute13    :=   cust_rec.jgzz_attribute13;
l_customer_profile_rec.jgzz_attribute14    :=   cust_rec.jgzz_attribute14;
l_customer_profile_rec.jgzz_attribute15    :=   cust_rec.jgzz_attribute15;
l_customer_profile_rec.global_attribute1    :=   cust_rec.global_attribute1;
l_customer_profile_rec.global_attribute2    :=   cust_rec.global_attribute2;
l_customer_profile_rec.global_attribute3    :=   cust_rec.global_attribute3;
l_customer_profile_rec.global_attribute4    :=   cust_rec.global_attribute4;
l_customer_profile_rec.global_attribute5    :=   cust_rec.global_attribute5;
l_customer_profile_rec.global_attribute6    :=   cust_rec.global_attribute6;
l_customer_profile_rec.global_attribute7    :=   cust_rec.global_attribute7;
l_customer_profile_rec.global_attribute8    :=   cust_rec.global_attribute8;
l_customer_profile_rec.global_attribute9    :=   cust_rec.global_attribute9;
l_customer_profile_rec.global_attribute10    :=   cust_rec.global_attribute10;
l_customer_profile_rec.global_attribute11    :=   cust_rec.global_attribute11;
l_customer_profile_rec.global_attribute12    :=   cust_rec.global_attribute12;
l_customer_profile_rec.global_attribute13    :=   cust_rec.global_attribute13;
l_customer_profile_rec.global_attribute14    :=   cust_rec.global_attribute14;
l_customer_profile_rec.global_attribute15    :=   cust_rec.global_attribute15;
l_customer_profile_rec.global_attribute16    :=   cust_rec.global_attribute16;
l_customer_profile_rec.global_attribute17    :=   cust_rec.global_attribute17;
l_customer_profile_rec.global_attribute18    :=   cust_rec.global_attribute18;
l_customer_profile_rec.global_attribute19    :=   cust_rec.global_attribute19;
l_customer_profile_rec.global_attribute20    :=   cust_rec.global_attribute20;
l_customer_profile_rec.global_attribute_category    :=   cust_rec.global_attribute_category;
l_customer_profile_rec.cons_inv_flag    			:=   cust_rec.cons_inv_flag;
l_customer_profile_rec.cons_inv_type    			:=   cust_rec.cons_inv_type;
l_customer_profile_rec.autocash_hierarchy_id_for_adr    :=   cust_rec.autocash_hierarchy_id_for_adr;
l_customer_profile_rec.lockbox_matching_option    	:=   cust_rec.lockbox_matching_option;
l_customer_profile_rec.created_by_module    		:=   cust_rec.created_by_module;
l_customer_profile_rec.application_id    			:=   cust_rec.application_id;
l_customer_profile_rec.review_cycle    				:=   cust_rec.review_cycle;
l_customer_profile_rec.last_credit_review_date    	:=   cust_rec.last_credit_review_date;
l_customer_profile_rec.party_id    					:=   cust_rec.party_id;
l_customer_profile_rec.credit_classification    	:=   cust_rec.credit_classification;
l_object_version_number    							:=   cust_rec.object_version_number;
l_standard_terms    								:=   cust_rec.term_id;
l_cust_account_id    								:=   cust_rec.cust_account_id;
...
FOR cust_site_rec IN CONSO_CUST_SITE(l_cust_account_id)
LOOP
...
l_customer_site_rec.standard_terms    :=   l_standard_terms;
