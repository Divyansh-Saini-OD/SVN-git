...
AS
   ...
   -- +===================================================================================+
   gb_corp_book_name        VARCHAR2 (15);
   gb_fed_book_name         VARCHAR2 (15);
   gb_state_book_name       VARCHAR2 (15);
   gb_fed_ace_book_name     VARCHAR2 (15);
   gb_fed_amt_book_name     VARCHAR2 (15);
   gb_state_amt_book_name   VARCHAR2 (15);
   ...
   -- +===================================================================================+
   PROCEDURE MASTER (p_validate_flag    IN VARCHAR2,
   ...
   -- | Returns   :  None                                                                 |
   -- +===================================================================================+
   PROCEDURE LOAD_TAX (p_book_type_code   IN VARCHAR2,
                       p_depr_flag_only   IN VARCHAR2);
