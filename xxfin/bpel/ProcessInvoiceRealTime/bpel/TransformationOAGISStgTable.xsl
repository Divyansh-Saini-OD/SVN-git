...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="XSD">
      ...
      <rootElement name="XxApInvInterfaceStgCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/ServiceStgTableInsert"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [THU JUN 05 15:23:45 IST 2008]. -->
?>
            ...
            <xsl:for-each select="ns1:InvoiceLine">
              <ns0:XxApInvLinesInterfaceStg>
                    ...
                    <ns0:globalAttribute11>
                      <xsl:value-of select="normalize-space(ns1:PurchaseOrderReference/ns1:DocumentDateTime)"/>
                    </ns0:globalAttribute11>
