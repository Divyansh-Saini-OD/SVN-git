...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [TUE DEC 18 11:31:18 EST 2007]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsl ns6 ns2 ns9 ns5 ns3 xs ns4 ns8 ns1 ns7 ns10 ns0 bpws ehdr hwf xp20 xref ora ids orcl">
  <xsl:template match="/">
