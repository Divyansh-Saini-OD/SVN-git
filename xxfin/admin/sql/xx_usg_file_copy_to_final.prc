...
BEGIN
    ...
    v_request_id := FND_REQUEST.SUBMIT_REQUEST (p_application
                                                    ...
                                                    ,FALSE
                                                    ,p_source_dir
                                                    ,p_dest_dir||'/Usage_Ext_File_'||v_date||'.psv'
                                                    ,NULL
                                                    ,NULL
	...
	COMMIT;
     ...
     UTL_FILE.FGETATTR(p_alias_dir,'Usage_Ext_File_'||v_date||'.psv',v_exists,v_file_length,v_block_size);
     ...
     END IF;
       ...
       FND_FILE.PUT_LINE(FND_FILE.LOG,'File EXists Information for Usage Ext File in the Source Directory');
