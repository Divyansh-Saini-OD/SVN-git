...
CREATE OR REPLACE FORCE EDITIONABLE VIEW XX_CE_RAKUTEN_PRE_STG_V (REC_ID, REPORT_DATE, PROCESS_NAME, FILENAME, FILE_TYPE, REQUEST_ID, PROCESS_FLAG, ERR_MSG, SETTLEMENT_ID, INVOICEID, TRANDATE, TRANTYPE, ORDERID, ORDERITEMID, LISTINGID, REFERENCEID, ITEMNAME, BUYEREMAIL, QTYSHIPPED, BUYERPAID, COMMISSION, SHIPPINGFEE, PERITEMFEE, FEETOTAL, SALESTAX, RECYCLEFEE, SELLERRECEIVED) AS 
  SELECT REC_ID,
    REPORT_DATE,
    PROCESS_NAME,
    FILENAME,
