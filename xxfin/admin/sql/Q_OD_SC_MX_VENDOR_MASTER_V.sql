...
AS
  SELECT
    ...
    to_date(qr.CHARACTER6, 'YYY
Y/MM/DD') "OD_SC_INACTIVE_DATE",
    to_date(qr.CHARACTE R7, 'YYYY/MM/DD') "OD_SC_REACTIVATE_DATE",
    to_date(qr.CHARACTER8, 'YYYY/MM/DD') "OD_SC_DOC_VAL_DATE",
    TO _date(qr.CHARACTER9, 'YYYY/MM/DD') "OD_SC_FQA_APRVL_D",
    qr.CHARACTER10 "OD_SC_AUDIT_AGENT",
    qr.CHARACTER 11 "OD_SC_VEND_CONT_NAME",
    qr.CHARACTER12 "OD_SC_VEND_PHONE",
    qr.CHARACTER13 "OD_SC_VEND_FAX",
    qr.CHARAC TER14 "OD_SC_VEND_EMAIL",
    ...
    qr.C HARACTER21 "OD_SC_FACTORY_PHONE",
    ...
    qr.CHARAC TER49 "OD_SC_CNT_OF_ORGN",
    qr.CHARACTER50 "OD_SC_CNT_OF_DESTN",
    qr.CHARACTER51 "OD_SC_CIP",
    to_date(qr.C HARACTER52, 'YYYY/MM/DD') "OD_SC_POTRM_APR_D",
    qltda te.any_to_number(qr.CHARACTER53) "OD_SC_FOB_VALUE",
    qr.CHARACTER54 "OD_SC_LEAD_AUDITOR",
    qr.CHARACTER55 "OD_SC_AUDITOR",
    to_date(qr.CHARACTER56, 'YYYY/MM/DD
') "OD_SC_PREAUDT_SCHED_D",
    qr.CHARACTER57 "OD_SC_PREAUDT_RESULT",
    qr.CHARACTER58 "OD_SC_ZT_STATUS",
    to_ DATE(qr.CHARACTER59, 'YYYY/MM/DD') "OD_SC_ZT_APRVL_D",
    qr.CHARACTER60 "OD_SC_ZT_APPROVER",
    qr.CHARACTER6 1 "OD_SC_FZT_APPROVER",
    to_date(qr.CHARACTER62, 'YYY
Y/MM/DD') "OD_SC_FZT_APRVL_D",
    qr.COMMENT2 "OD_SC_PREAUDIT_COMMENTS",
    to_date(qr.CHARACTER63, 'YYYY/MM/D
D') "OD_SC_STRAUDT_REQ_D",
    ...
    to_date(qr.CHARACTER67, 'YYYY/
MM/DD') "OD_SC_VENDPAY_RCVD_D",
    to_date(qr.CHARACTER 68, 'YYYY/MM/DD') "OD_SC_STRAUDT_SCHD_D",
    to_date(qr .CHARACTER69, 'YYYY/MM/DD') "OD_SC_REQ_AUDIT_DATE",
    qr.CHARACTER70 "OD_SC_STR_AUDIT_RESULT",
    qr.CHARACTE R71 "OD_SC_CAP_ASSIGNMENT",
    to_date(qr.CHARACTER72, 'YYYY/MM/DD') "OD_SC_CAP_SENT_D",
    to_date(qr.CHARACT ER73, 'YYYY/MM/DD') "OD_SC_CAP_RECD_D",
    qr.CHARACTER 74 "OD_SC_STRAUDT_CAP_STATUS",
    to_date(qr.CHARACTER7 5, 'YYYY/MM/DD') "OD_SC_CAP_RESP_D",
    ...
    qr.CHARACTER8 3 "OD_SC_REGRUSH_NOTIFY",
    ...
    to_date(qr.CHARACTER95, 'YYYY/MM
/DD') "OD_SC_VEND_DESK_REQ_DATE",
