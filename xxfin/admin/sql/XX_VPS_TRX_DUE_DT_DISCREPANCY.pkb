...
CREATE OR REPLACE PACKAGE BODY XX_VPS_TRX_DUE_DT_DISCREPANCY
AS
  -- +============================================================================================+
...
BEGIN
  ...
  fnd_file.put_line(fnd_file.log, 'OD: US VPS Transactions Due Date Discrepancy Report Request ID: '||P_CONC_REQUEST_ID);
