...
--+=============================================================================================+--
--|                                                                                             |--
--| Program Name   : CREATE XXOD_OMX_CNV_AR_TRX_STG.tbl                                              |--
--|                                                                                             |--
--| Purpose        : Create Custom Tables .                                                     |--
--|                  The Objects created are:                                                   |--
--|                                                                                             |--
--|                1. XXOD_OMX_CNV_AR_TRX_STG   (OD Conversion OMX/"OD North" AR Transactions   |--
--| RICE ID : C0704                                                                             |--
--| Change History  :                                                                           |--
--| Version           Date             Changed By           Description                         |--
--+=============================================================================================+--
--| 1.0              06-JUN-2017       Madhu Bolli          Original                            |--
--+=============================================================================================+--
...
PROMPT
PROMPT Creating the Table XXOD_OMX_CNV_AR_TRX_STG......
PROMPT

CREATE TABLE XXFIN.XXOD_OMX_CNV_AR_TRX_STG
 ( 
   RECORD_ID    NUMBER
  ,ACCT_NO		VARCHAR2(30)
  ,PAY_DUE_DATE		DATE
