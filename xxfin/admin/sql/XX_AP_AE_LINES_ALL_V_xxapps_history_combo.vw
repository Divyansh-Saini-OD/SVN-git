...
-- +==========================================================================+
-- | NAME        : XX_AP_AE_LINES_ALL_V_xxapps_history_combo.vw               |
...
CREATE OR REPLACE FORCE VIEW XXAPPS_HISTORY_COMBO.XX_AP_AE_LINES_ALL_V 
  (ROW_ID
  ,AE_LINE_ID
  ,AE_HEADER_ID
  ,AE_LINE_NUMBER
...
AS
  SELECT row_id,
    ...
    taxable_accounted_cr,
    tax_link_id
  FROM xxapps_history_combo.ap_ae_lines_all;