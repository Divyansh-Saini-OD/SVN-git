REM dbdrv: sql ~PROD ~PATH ~FILE none none none package &phase=plb checkfile(120.3.12010100.3=120.5)(115.7=120.0):~PROD:~PATH:~FILE
/*===========================================================================+
 |               Copyright (c) 1995, 2015 Oracle Corporation                       |
...
DEFINE PACKAGE_NAME="PO_REQ_LINES_SV1"
WHENEVER SQLERROR EXIT FAILURE ROLLBACK;
CREATE or REPLACE PACKAGE BODY PO_REQ_LINES_SV1 as
/* $Header: POXRQL2B.pls 120.7.12020000.4 2015/08/05 06:21:45 rkandima ship $ */
/*==========================  po_req_lines_sv1  ============================*/
...
-- bug 18188230 End
  ...
  SELECT transaction_id, item_id, quantity, unit_of_measure, source_organization_id, destination_organization_id, source_type_code, unit_price,
