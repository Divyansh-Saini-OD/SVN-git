...
CREATE OR REPLACE TRIGGER apps.XX_AP_supplier_site_AIR1 AFTER
--INSERT ON apps.po_vendor_sites_all FOR EACH ROW
INSERT ON apps.ap_supplier_sites_all FOR EACH ROW     --Commented/Added for R12 Upgrade retrofit

  -- +===============================================================================+
  -- |                  Office Depot - Project Simplify                              |
  -- |                Oracle NAIO Consulting Organization                            |
  -- +===============================================================================+
  -- | Name        : XX_AP_supplier_site_AIR1.trg                                      |
...
BEGIN
   ...
   --Defect 30042 Get default payment method for payables
