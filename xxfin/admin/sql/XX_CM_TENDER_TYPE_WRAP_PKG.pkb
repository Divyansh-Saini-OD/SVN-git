...
PROMPT Creating PACKAGE BODY XX_CM_TENDER_TYPE_WRAP_PKG

PROMPT Program exits IF the creation IS NOT SUCCESSFUL

WHENEVER SQLERROR CONTINUE

create or replace PACKAGE  BODY XX_CM_TENDER_TYPE_WRAP_PKG
AS
...
-- |                 that used for submitting the OD: CM Tender Type Report   |
...
BEGIN
  ...
  ln_request_id := FND_REQUEST.SUBMIT_REQUEST(
					      ...
					      ,p_tender_type_from       
				              ,p_tender_type_to         
                   			      ,p_accounting_period_from 
		               		      ,p_accounting_period_to   
				              ,p_dummy                  
                                             );
...
END XX_CM_TENDER_TYPE_WRAP_PROC;
