create or replace
PACKAGE BODY XX_GL_HEADCNT_INTERFACE_PKG
   AS
-- +===================================================================+
...
-- |                      interface for GL head count journals to L    |
-- |                          Oracle GL                                |
-- |                                                                   |
-- |Change Record:                                                     |
-- |===============                                                    |
...
-- |                                                                   |
-- |1.1      17-DEC-2007  P.Marco          Defect 3053  p_bypass_flg   |
-- |                                        => 'Y' was missing from the|
-- |                                       calling statement for       |
-- |                                       XX_GL_INTERFACE_PKG.        |
-- |                                       PROCESS_JRNL_LINES procedure|
-- |                                                                   |
-- |                                                                   |
-- |1.2      19-FEB-2008 Raji              Fixed Defect 4652           |
-- |1.3      24-FEB-2008 Raji              Fixed Defect 4889           |
-- |1.4      02-JUL-2008 Raji              Fixed defect 8645           |
-- |1.5      28-JUL-2009 Harini G.         Fixed Defect 1584           |
-- |1.6      18-NOV-2015 Madhu Bolli       Remove schema for 12.2 retrofit |
-- |                                                                   |
-- |                                                                   |
-- +===================================================================+
    ...
    gc_debug_pkg_nm    VARCHAR2(30) := 'XX_GL_HEADCNT_INTERFACE_PKG.';
...
-- |                    Interface for Head count concurrent program    |
-- |                                                                   |
-- |                                                                   |
