...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="XSD">
      <schema location="http://esbdev01.na.odcorp.net/orabpel/default/ODTransactionLogger/TransactionData.xsd"/>
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [FRI JUL 04 10:19:24 IST 2008]. -->
?>
