...
-- |                                            for defect no.#25372                             |
-- | 1.4     11-Feb-2014   Veronica M           E2079 - Changes for Defect 28065.                |  
-- |                                                                                             |
-- +=============================================================================================+
...
AS
     SELECT   csl.ROWID row_id,
      ...
      WHERE       csh.statement_header_id = csl.statement_header_id
              ...
              AND csh.org_id = xcgh.org_id -- Included for defect 28065. Veronica 11-Feb-14.
              AND xcgh.org_id = FND_PROFILE.VALUE('ORG_ID') -- Included for defect 28065. Veronica 11-Feb-14.
