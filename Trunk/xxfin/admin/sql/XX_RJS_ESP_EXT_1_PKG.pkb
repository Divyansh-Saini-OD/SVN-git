...
CREATE OR REPLACE
PACKAGE BODY XX_RJS_ESP_EXT_1_PKG AS

-- +===================================================================+
-- | PROCEDURE: EXTRACT_ESP_DETAILS                                    |
-- |                                                                   |
-- | Concurrent Program : Extract ESP Details                          |
-- | Short_name         : XX_RJS_ESP_EXT_1_PKG                         |
-- | Executable         : XX_RJS_ESP_EXT_1_PKG.EXTRACT_ESP_DETAILS     |
-- |                                                                   |
...
BEGIN
    ...
    FND_FILE.PUT_LINE(FND_FILE.LOG, 'XX_RJS_ESP_EXT_1_PKG Begin:');
               ...
               IF lc_program_name <> 'ESP-PROXY' THEN
                  ...
                  BEGIN
                      ...
                      INTO   lc_exec_name,
                             ...
                             lc_method,
                             lc_parms
                      FROM   apps.FND_EXECUTABLES_VL           E,
                             apps.FND_CONCURRENT_PROGRAMS_vl   P,
                             apps.FND_APPLICATION_VL           A,
                             apps.FND_DESCR_FLEX_COLUMN_USAGES CU
                               ...
                               BEGIN
                                   SELECT rpad(E.EXECUTION_FILE_NAME, 60,' '),
                                         ...
                                         (SELECT LISTAGG(cu.END_USER_COLUMN_NAME,', ') WITHIN GROUP
                                          ...
                                          FROM   apps.FND_DESCR_FLEX_COLUMN_USAGES CU
...
EXCEPTION
    WHEN OTHERS THEN
         FND_FILE.PUT_LINE(FND_FILE.LOG, 'XX_RJS_ESP_EXT_1_PKG OTHERS ERROR'||SQLERRM);
         RETCODE := 2;
...
BEGIN
    ...
    BEGIN
        ...
        FROM   APPS.xx_fin_translatevalues V
        ...
        UPDATE APPS.xx_fin_translatevalues V
...
-- | Executable         : XX_RJS_ESP_EXT_1_PKG.UPDATE_ESP_DETAILS      |
-- |                                                                   |
...
-- | Executable         : XX_RJS_ESP_EXT_1_PKG.LOAD_ESP_DETAILS        |
-- |                                                                   |
...
-- | Executable         : XX_RJS_ESP_EXT_1_PKG.LOAD_ESP_LINKS          |
-- |                                                                   |
-- | Description      : This Procedure will read the ESP extracted     |
-- |                    LINK detail file and load the data into table  |
-- |                    XX_FIN_ESP_LINK                                |
...
-- | Executable         : XX_RJS_ESP_EXT_1_PKG.LOAD_ESP_SCHED          |
-- |                                                                   |
-- | Description      : This Procedure will read the ESP extracted     |
...
-- | Executable         : XX_RJS_ESP_EXT_1_PKG.LOAD_ESP_RUNS           |
-- |                                                                   |
-- | Description      : This Procedure will read the ESP extracted     |
-- |                    SCHEDULE file and load the data into           |
...
-- | Executable         : XX_RJS_ESP_EXT_1_PKG.LOAD_ESP_PARMS          |
-- |                                                                   |
...
-- | Executable         : XX_RJS_ESP_EXT_1_PKG.PRINT_ESP_RPT           |
-- |                                                                   |
