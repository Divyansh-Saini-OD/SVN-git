...
-- |1.3       17-Feb-2014  Darshini           Changes for defect 28261.             |
-- +===============================================================================+|
...
CREATE OR REPLACE FORCE VIEW xx_ar_lockbox_err_bank_info_v (bank_num,
                                                                 bank_account_num,
                                                                 start_date,
                                                                 end_date,
...
AS
   SELECT brpr.bank_or_branch_number , 
    ...
    WHERE ieba.branch_id = brpr.party_id(+)
      ...
      AND ipi.instrument_type='BANKACCOUNT' -- Included this condition for defect 28261
      AND iepa.cust_account_id = hca.cust_account_id
      AND iepa.acct_site_use_id = hcsu.site_use_id(+)
      AND hcsu.cust_acct_site_id = hcasa.cust_acct_site_id(+);
	  
--GRANT ALL ON xx_ar_lockbox_err_bank_info_v TO APPS;	  
