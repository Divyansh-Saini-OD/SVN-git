        ...
        ******************************/
        ...
        THEN
          ...
          ***************************************/
          ...
          lr_ra_intf_lines_info.orig_system_bill_customer_id  := lr_order_header_info.sold_to_org_id;
          lr_ra_intf_lines_info.orig_system_ship_customer_id  := lr_order_header_info.sold_to_org_id;  --??
          lr_ra_intf_lines_info.orig_system_sold_customer_id  := lr_order_header_info.sold_to_org_id;
    ...
    LOOP
      ...
      BEGIN
        ...
        ************************************/
        ...
        ELSIF px_subscription_array(indx).billing_sequence_number  = 1  -- check with Sreedhar of we replace 1 with >= initial_billing_sequence
        ...
        THEN
          ...
          THEN
            ...
            *******************************************************/
			...
			THEN
			  ...
			  lc_reason_code     := 'TERMINATING CONTRACT';
          ...
          ELSE
              ...
              --updating auth_completed_flag to T if contractStatus is TERMINATE
              IF (lr_translation_info.target_value1 = gc_contract_status) OR (px_subscription_array(indx).contract_status = gc_contract_status)
              THEN
        ...
        THEN
          ...
          THEN
            ...
            *********************/
            ...
            lr_ordt_info.customer_id                := lr_order_header_info.sold_to_org_id;
        ...
        LOOP
          ...
          THEN
            ...
            SET    contract_id                 = eligible_contract_line_rec.contract_id,
                   ...
                   program_id                  = NVL(FND_GLOBAL.CONC_REQUEST_ID, -1)
            ...
            THEN
              ...
              lr_contract_info.program_id                  := NVL(FND_GLOBAL.CONC_REQUEST_ID, -1);
          ...
          THEN
            ...
            lr_contract_line_info.program_id                 := NVL(FND_GLOBAL.CONC_REQUEST_ID, -1);
      ...
      BEGIN
        ...
        ************************************/
        ...
        THEN
          ...
          lr_subscription_info.program_id                := NVL(FND_GLOBAL.CONC_REQUEST_ID, -1);
