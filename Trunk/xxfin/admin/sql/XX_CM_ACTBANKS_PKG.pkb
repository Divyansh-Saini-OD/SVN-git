...
PROMPT Creating PACKAGE BODY XX_CM_ACTBANKS_PKG

PROMPT Program exits IF the creation IS NOT SUCCESSFUL

WHENEVER SQLERROR CONTINUE

create or replace PACKAGE  BODY XX_CM_ACTBANKS_PKG
AS
...
-- |              that used for submitting the OD: CM Active Banks Listing  |
-- |              program with the desirable format of the user, and the    |
...
-- |======   ==========     =============        =======================    |
-- |Draft 1A  19-FEB-09      Trisha Saxena         Initial version          |
-- |                                                                        |
-- +========================================================================+

--- +=======================================================================+
-- | Name :  XX_CM_ACTBANKS_WRAP_PROC                                       |
-- | Description : The procedure will submit the OD: CM Active Banks Listing|
-- |               program in the specified format                          |
