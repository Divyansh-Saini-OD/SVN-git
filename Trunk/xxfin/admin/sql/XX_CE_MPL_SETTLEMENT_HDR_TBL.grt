...
-- +==========================================================================+
-- |  Name  	:   XX_CE_MPL_SETTLEMENT_HDR.grt                         |
...
GRANT UPDATE ON xx_ce_mpl_Settlement_hdr TO ERP_SYSTEM_TABLE_SELECT_ROLE;
GRANT UPDATE ON xx_ce_mpl_Settlement_dtl TO ERP_SYSTEM_TABLE_SELECT_ROLE;
