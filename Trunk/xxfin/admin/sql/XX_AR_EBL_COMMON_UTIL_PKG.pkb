					...
					IF LENGTH(p_billing_number) = 9 THEN						
							...
							END;
								...
								IF lc_child_order_number IS NOT NULL THEN
								   lc_cons_msg_bcc:='Note: Child orders '|| lc_child_order_number ||' are pending shipment and will be billed separately.'; 
								ELSE
								   lc_cons_msg_bcc:='X';
								END IF;
					...
					ELSIF LENGTH(p_billing_number) = 12 THEN
							...
							END;
								...
								IF lc_parent_order_number IS NOT NULL THEN
								   lc_cons_msg_bcc:='The child order is part of parent order '|| lc_parent_order_number||'.' ;
								ELSE
								   lc_cons_msg_bcc:='X';
								END IF;			
