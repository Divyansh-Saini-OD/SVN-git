	...
	PROMPT Creating PACKAGE XX_C2T_CNV_CC_TOKEN_ORDT_PKG

	PROMPT Program exits IF the creation IS NOT SUCCESSFUL

	WHENEVER SQLERROR CONTINUE

	CREATE OR REPLACE PACKAGE xx_c2t_cnv_cc_token_ordt_pkg IS
	---+============================================================================================+
	---|                              Office Depot                                                  |
	---+============================================================================================+
	---|    Application     : AR                                                                    |
	---|                                                                                            |
	---|    Name            : XX_C2T_CNV_CC_TOKEN_ORDT_PKG.pks                                       |
	---|                                                                                            |
	---|    Description     :                                                                       |
	---|                                                                                            |
	---|                                                                                            |
	...
	---|    ------------    ----------------- ---------------    ---------------------              |
	---|    1.0             12-AUG-2015       Harvinder Rakhra   Initial Version                    |
	---|                                                                                            |
	---+============================================================================================+
