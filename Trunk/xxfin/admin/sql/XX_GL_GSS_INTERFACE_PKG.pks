...
CREATE OR REPLACE PACKAGE XX_GL_GSS_INTERFACE_PKG
AS
-- +===================================================================+
...
-- | Description      :  This PKG will be used to interface GSS        |
...
-- | Description      : The main controlling procedure for GSS intface |
-- |                                                                   | 
