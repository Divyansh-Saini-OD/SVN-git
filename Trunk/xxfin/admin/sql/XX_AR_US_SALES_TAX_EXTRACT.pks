...
CREATE OR REPLACE PACKAGE XX_AR_US_SALES_TAX_EXTRACT AS
-- +======================================================================+
...
-- |1.0       09-SEP-09     RamyaPriya M       Modified for Defect #1594  |
--                                                                        |
-- +======================================================================+
-- +======================================================================+
-- | Name : TAX_EXTRACT                                                   |
...
-- | Description : Procedure to extract the tax summary information    |
-- |               and insert into XX_AR_SALES_TAX_TAB table           |
-- |                                                                   |
-- |                                                                   |
-- | Parameters :  p_company                                           |
-- |               p_gl_date_from                                      |
...
PROCEDURE TAX_EXTRACT_SUMMARY(p_company                 VARCHAR2
                             ...
                             ,p_gl_date_to               DATE
                             ,p_posted_status            VARCHAR2
                             ,p_trx_id_from              NUMBER       --added for #1594
                             ,p_trx_id_to                NUMBER       --added for #1594
                             ,p_file_name                VARCHAR2
                             ,p_trx_date_from          date
                             ,p_trx_date_to             date 
                             ,p_adj_date_low             DATE 
...
FUNCTION GET_SHIP_FROM_LOCATION  (p_ship_from_org_id      NUMBER
                                  ,p_exclude_loc          VARCHAR2
                                   ...
                                   RETURN VARCHAR2;
-- +===================================================================+
-- | Name : TAX_SUMMARY_WRITE_FILE                                     |
-- | Description : Procedure to write the tax summary information      |
-- |               from XX_AR_SALES_TAX_TAB to a flat file.            |
-- |               The Tax information is grouped based on the various |
-- |               display fields.                                     |
-- |                                                                   |
-- |                                                                   |
...
-- |              NONE                                                 |
-- +===================================================================+
PROCEDURE TAX_SUMMARY_WRITE_FILE (p_file_name VARCHAR2);
