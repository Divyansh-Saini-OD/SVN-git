...
PROMPT Creating PACKAGE BODY XX_FA_IRS4562_PKG

PROMPT Program exits IF the creation IS NOT SUCCESSFUL

WHENEVER SQLERROR CONTINUE
CREATE OR REPLACE PACKAGE BODY XX_FA_IRS4562_PKG AS
 -- +===================================================================+
 ...
 -- +===================================================================+
    ...
    AND   TO_DATE(p_report_period_close_date,'DD-MON-YY') BETWEEN FBK.date_effective AND NVL(FBK.date_ineffective,SYSDATE)
    AND   FBK.date_placed_in_service   BETWEEN FFY.start_date and FFY.end_date
    AND   FBK.date_placed_in_service   BETWEEN NVL(p_spfrom_date,FBK.date_placed_in_service) AND NVL(p_spto_date,FBK.date_placed_in_service)-- Added for the defect 1178 CR 431 R1.2
    ...
    AND   TO_DATE(p_report_period_close_date,'DD-MON-YY') BETWEEN FAH.date_effective AND NVL(FAH.date_ineffective,SYSDATE)
    ...
    -- Added for the Defect 3224 --Ends Here
      ...
      --IF lcu_fa_irs4652.fiscal_year_added= 'PREV' THEN -- Commented for the Defect 3224
          IF lcu_fa_irs4652.fiscal_year_added < p_fiscal_year THEN  --Added for the Defect 3224
             INSERT INTO apps.xx_fa_irs4562_temp
