...
--  Office Depot - Project Simplify Release 1                                       
--                                                                                  
--  This procedure is used to validate GL segments passed to this procedure against 
--  the GL cross validation rules. It is required to pass at least the following    
...
--  Future
--
--  Ouput parameters are as follows.
--
--  Message
--  Valid Combinaton Flag
--  Company Segment
--
--  COMPANY will be derived from LOCATION if not passed.                            
--  INTERCOMPANY will be defaulted to '00000' if not passed.                        
--  FUTURE will be defaulted to '000000' if not passed.                             
--                                                                                  
--  Usage: XX_GL_CROSS_VALIDATION(coa name, company, cost_center,                   
--                                account, location, intercompany, lob,             
--                                future, message, valid flag);                     
------------------------------------------------------------------------------------
--  MODIFICATION HISTORY:                                                           
--  Date          Developer            Description                                         
------------------------------------------------------------------------------------
-- 7/20/2007    Prakash.S           New Procedure for GL Cross Validation   
-- 09-APR-2008  Aravind A.          Fixed defect 6051, added an out parameter for
--                                  sending out company value if the combination is
--                                  valid
-- 19-May-2008  Srinidhi            Defect 7183, Convert COAName to upper case 
-- 11-Jul-2009  P.Suresh            Defect 683. Corrected the operation parameter
--                                  to CHECK_COMBINATION.
-- 07-28-2016  Radhika .P           GLLFV_CHARTS_OF_ACCOUNTS dropped in R12.25 ,
--                                         replaced with fnd_id_flex_structures_tl
------------------------------------------------------------------------------------

CREATE OR REPLACE PROCEDURE XX_GL_CROSS_VALIDATION
