...
-- | 1.1     13-Feb-2015 Paddy Sanjeevi     Added declaration of local variable|
-- +===========================================================================+
...
DECLARE
  ...
  BEGIN
    ...
    EXCEPTION
      WHEN others THEN
        dbms_output.put_line('Error while creating XXFA_CLASS_CATEGORY definition :'||SQLERRM);
    END;
    ...
    EXCEPTION
      WHEN others THEN
        dbms_output.put_line('Error while creating XXFA_PWC_DEPRN definition :'||SQLERRM);
    END;
    ...
    EXCEPTION
      WHEN others THEN
        dbms_output.put_line('Error while creating XXFA_SAP_EXP_LOCATIONS definition :'||SQLERRM);
    END;
    ...
    EXCEPTION
      WHEN others THEN
        dbms_output.put_line('Error while creating conversion code :'||SQLERRM);
    END;
    ...
    EXCEPTION
      WHEN others THEN
        dbms_output.put_line('Error while creating system code :'||SQLERRM);
    END;
    COMMIT;
END;
/
