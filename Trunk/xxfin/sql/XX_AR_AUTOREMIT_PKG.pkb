...
-- |3.2       05-JUN-2017  Rohit Nanda          Defect 41994 - Master program needs to       |
-- |                                            complete in Error in case child program fails|
-- +=========================================================================================+
    ...
    BEGIN
        ...
        THEN
            ...
            fnd_file.put_line(fnd_file.LOG, 'Started SECOND'); --ADDED BY ROHIT NANDA ON 05-JUN-2017 V3.2
            ...
            fnd_file.put_line(fnd_file.LOG, 'Ended SECOND'); --ADDED BY ROHIT NANDA ON 05-JUN-2017 V3.2
        ...
        THEN
            ...
            fnd_file.put_line(fnd_file.LOG, 'Started THIRD'); --ADDED BY ROHIT NANDA ON 05-JUN-2017 V3.2
            ...
            x_ret_code := ln_ret_err_code;                  --ADDED BY ROHIT NANDA ON 05-JUN-2017 V3.2
            fnd_file.put_line(fnd_file.LOG, 'Ended THIRD'); --ADDED BY ROHIT NANDA ON 05-JUN-2017 V3.2
