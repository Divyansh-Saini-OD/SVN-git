...
public class ADFUtils {
    ...
    public static String getExceptionDetails(Iterator execpIterator){
        StringBuilder errorSb = new StringBuilder();
        Throwable t = null;
        while (execpIterator.hasNext())
        {
            t = (Throwable)execpIterator.next();
            errorSb=errorSb.append(t.getMessage()).append("\n");
        } 
        return errorSb.toString();
    }
    
    public static oracle.jbo.domain.Number StringToNumber(String StringParameter) 
     {
      
       try
       {
         //Covert String to Number
         oracle.jbo.domain.Number NumberReturned = new oracle.jbo.domain.Number(StringParameter, 0);

         return NumberReturned;
       }    
       catch(Exception e)
       {
           throw new RuntimeException("Cannot convert '" + StringParameter + "' to Number");
     ...
     * @return
     */
    public static Float totalAmount(DCIteratorBinding iteratValue,String attributeName){
