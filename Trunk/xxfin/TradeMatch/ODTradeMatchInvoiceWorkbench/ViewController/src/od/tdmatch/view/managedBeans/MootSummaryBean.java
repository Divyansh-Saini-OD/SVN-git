...
public class MootSummaryBean implements Serializable {
    ...
    public String setDropshipDeductions(){
        taskFlowId = "/WEB-INF/trade-match-drop-deduc-non-ded-inquiry-btf.xml#trade-match-drop-deduc-non-ded-inquiry-btf";

     return null;    
    }
    
       
    public String setDropshipNonDeductions(){
        taskFlowId = "/WEB-INF/trade-match-non-ded-inquiry-btf.xml#trade-match-non-ded-inquiry-btf";

     return null;    
    }
    
    public String setConsignmentRTV(){
            taskFlowId = "/WEB-INF/consignment-rtf-btf.xml#consignment-rtf-btf";

         return null;    
        }
     
     public String setRTVRecon(){
            taskFlowId = "/WEB-INF/trade-match-rtv-recon-btf.xml#trade-payable-rtv-recon-btf";
