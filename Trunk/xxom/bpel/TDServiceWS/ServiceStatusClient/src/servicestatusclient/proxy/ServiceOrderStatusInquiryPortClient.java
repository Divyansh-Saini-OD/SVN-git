...
public class ServiceOrderStatusInquiryPortClient {
    private servicestatusclient.proxy.ServiceOrderStatusInquiry _port;
    
    public ServiceOrderStatusInquiryPortClient() throws Exception {
        ServiceFactory factory = ServiceFactory.newInstance();
        _port = ((servicestatusclient.proxy.ServiceOrderStatusInquiryService)factory.loadService(servicestatusclient.proxy.ServiceOrderStatusInquiryService.class)).getServiceOrderStatusInquiryPort();
    }
    ...
    public static void main(String[] args) {
        try {
            servicestatusclient.proxy.ServiceOrderStatusInquiryPortClient myPort = new servicestatusclient.proxy.ServiceOrderStatusInquiryPortClient();
    ...
    public servicestatusclient.proxy.types.gsidev01.servicestatusinquiryws_wsdl.types.SearchServicerequestElement process(servicestatusclient.proxy.types.gsidev01.servicestatusinquiryws_wsdl.types.SearchServicerequestElement payload) throws java.rmi.RemoteException {
        return _port.process(payload);
    }
     ...
     */
    public servicestatusclient.proxy.ServiceOrderStatusInquiry getPort() {
        return _port;
    }
