...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [TUE MAY 04 17:16:31 EDT 2010]. -->
?>
    ...
    <tns:Root-Element>
      <xsl:for-each select="/db:OutputParameters/db:P_SR_REQ_REC">
        <tns:RESPONSE_MQ>
          ...
          <tns:request_number>
            <xsl:value-of select="../db:X_REQUEST_NUM"/>
          </tns:request_number>
          <tns:order_number>
            <xsl:value-of select="../db:X_ORDER_NUM"/>
          </tns:order_number>
        </tns:RESPONSE_MQ>
      </xsl:for-each>
    </tns:Root-Element>
