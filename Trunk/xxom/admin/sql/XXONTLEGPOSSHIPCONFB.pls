...
CREATE OR REPLACE PACKAGE BODY XX_ONT_LEG_POS_SHIP_CONF_PKG
-- +===================================================================+
...
PROCEDURE Insert_update_Payment_Proc(
                                     ...
                                     x_status                OUT    VARCHAR2,
                                     x_message               OUT    VARCHAR2,
                                     x_ack_int_pmts_tbl      IN OUT XX_ONT_ACK_ORD_LINES_TBL
                                    )
AS
...
AS
    ...
    lt_ack_ord_pmts_tbl     XX_ONT_ACK_ORD_LINES_TBL;
    lt_ack_int_pmts_tbl     XX_ONT_ACK_ORD_LINES_TBL;
