...
-- |              Wipro Technologies                                                            |
-- +============================================================================================+
-- | Name         : XX_OM_LINE_ATTRIBUTES_T.grt                                                 |
...
-- |                1. XX_OM_LINE_ATTRIBUTES_T (Additional Information attributes               |
...
PROMPT
PROMPT Providing Grant on the Table XX_OM_LINE_ATTRIBUTES_T to Apps .....
PROMPT


GRANT ALL ON  XX_OM_LINE_ATTRIBUTES_T TO APPS;
