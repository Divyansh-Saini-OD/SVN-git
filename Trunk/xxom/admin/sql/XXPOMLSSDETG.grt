...
-- +===================================================================+
-- | Name         :XXPOMLSSDETG.grt                                    |
-- | Rice ID      :E1252_MultiLocationSupplierSourcing                 |
-- | Description  :OD MultiLocationSupplier Sourcing grant Creation    |
-- |               Script                                              |
-- |                                                                   |
-- |                                                                   |
-- |Change Record:                                                     |
...
PROMPT
PROMPT Providing Grant on Custom Table XX_PO_MLSS_DET to Apps......
PROMPT

WHENEVER SQLERROR EXIT 1

PROMPT
PROMPT Providing Grant on the Table XX_PO_MLSS_DET to Apps .....
PROMPT


GRANT ALL ON  XX_PO_MLSS_DET TO APPS;
...
PROMPT
PROMPT Providing Grant on the Sequence XX_PO_MLSS_DET_S to Apps .....
PROMPT


GRANT ALL ON  XX_PO_MLSS_DET_S TO APPS;
