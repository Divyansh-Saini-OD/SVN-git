 ...
 WHENEVER OSERROR EXIT FAILURE ROLLBACK;
  ...
  (SELECT inc_b.incident_id,
         ...
         -- to_char(xx_cs_uwq_dtls_pkg.get_first(rownum,inc_b.incident_id,jtfg.group_name)) ieu_param_pk_value,
          ...
          xx_cs_uwq_dtls_pkg.get_elapsed_time(nvl(inc_b.time_zone_id,1), inc_b.creation_date, inc_b.incident_attribute_10)  Elapsed_time,
          xx_cs_uwq_dtls_pkg.get_tmz_priority(nvl(inc_b.time_zone_id,1), inc_b.incident_attribute_10) tmz_priority,
          xx_cs_uwq_dtls_pkg.get_time_to_disp(nvl(inc_b.time_zone_id,1),inc_b.obligation_date, inc_b.incident_attribute_10) tm_to_resp,
          xx_cs_uwq_dtls_pkg.get_time_to_disp(nvl(inc_b.time_zone_id,1),inc_b.expected_resolution_date, inc_b.incident_attribute_10) tm_to_resol,
          inc_b.time_zone_id,
          ftb.timezone_code,
          inc_b.object_version_number,
          decode(inc_b.incident_attribute_13,null,inc_b.incident_attribute_2,inc_b.incident_attribute_13) Delivery_date
    ...
    ORDER BY inc_b.owner_group_id, tmz_priority, ftb.upgrade_tz_id, lkp1.lookup_code, tm_to_resp, tm_to_resol) c;
