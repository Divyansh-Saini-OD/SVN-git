...
-- |                                                                                            |
-- +============================================================================================+
-- | Name         : XXOMGLOBALEXCEPTIONS.grt                                                    |
-- | Rice Id      :                                                                             | 
-- | Description  : OD Exceptions Handling Grants Creation                                      |  
-- | Purpose      : Create Grant for Table XX_OM_GLOBAL_EXCEPTIONS.                             |
-- |                                                                                            |
-- |                                                                                            |
-- |Change Record:                                                                              |
-- |===============                                                                             |
...
PROMPT
PROMPT Providing Grant on object xx_om_global_exceptions to Apps .....
PROMPT

GRANT ALL ON  xx_om_global_exceptions TO APPS
/
