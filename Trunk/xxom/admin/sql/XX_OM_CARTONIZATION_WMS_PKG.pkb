...
CREATE OR REPLACE PACKAGE BODY XX_OM_CARTONIZATION_WMS_PKG
-- +=========================================================================================+
-- |                        Office Depot - Project Simplify                                  |
-- |            Oracle NAIO/WIPRO/Office Depot/Consulting Organization                       |
-- +=========================================================================================+
-- | Name         : XX_OM_CARTONIZATION_WMS_PKG                                             |
...
AS 
  ...
  END Log_Carton_Wms_Proc_status; 
  ...
  END Process_Cartonization_Wms;

END XX_OM_CARTONIZATION_WMS_PKG ;
/
SHOW ERRORS;
--EXIT;
