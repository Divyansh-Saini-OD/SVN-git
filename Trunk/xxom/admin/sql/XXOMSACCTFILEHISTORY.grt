...
-- |                                                                                            |
-- +============================================================================================+
-- | Name         : XXOMSACCTFILEHISTORY.grt                                                    |
-- | Rice Id      : I1272                                                                       | 
-- | Description  : INT-I1272_SalesOrderFrom LegacySystems(HVOP) Grants Creation                |  
-- | Purpose      : Create Grant on table XX_OM_SACCT_FILE_HISTORY.                             |
-- |                                                                                            |
-- |                                                                                            |
-- |Change Record:                                                                              |
-- |===============                                                                             |
...
PROMPT
PROMPT Providing Grant on object XX_OM_SACCT_FILE_HISTORY.tbl to Apps .....
PROMPT

GRANT ALL ON XX_OM_SACCT_FILE_HISTORY TO APPS
/
