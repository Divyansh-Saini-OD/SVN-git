...
CREATE OR REPLACE PACKAGE XX_ONT_LEG_POS_SHIP_CONF_PKG
-- +===================================================================+
...
AS
    ...
    g_exception xxod_report_exception:= xxod_report_exception('OTHERS','OTC','Order Management','PosPmtFeed',NULL,NULL,NULL,NULL);

    TYPE XX_ONT_ORDER_HDR_REC_TYPE IS RECORD (
         order_number           NUMBER
        ,header_id              NUMBER
    ...
    TYPE XX_ONT_ORDER_LINES_REC_TYPE IS RECORD (
         order_number            NUMBER
    ...
    TYPE XX_ONT_ORDER_LINES_TBL 
    IS TABLE OF XX_ONT_ORDER_LINES_REC_TYPE INDEX BY BINARY_INTEGER;

    TYPE XX_ONT_ORD_PAYMENTS_REC_TYPE IS RECORD (
         order_number           NUMBER 
        ,line_number            NUMBER
    ...
    TYPE XX_ONT_ORDER_PAYMENTS_TBL 
    IS TABLE OF XX_ONT_ORD_PAYMENTS_REC_TYPE INDEX BY BINARY_INTEGER;

    TYPE XX_ONT_ACK_LINES_REC_TYPE IS RECORD (
         line_number            NUMBER
        ,error_message          VARCHAR2(2000)
        );
        
    TYPE XX_ONT_ACK_ORD_LINES_TBL 
    IS TABLE OF XX_ONT_ACK_LINES_REC_TYPE INDEX BY BINARY_INTEGER;
    ...
    PROCEDURE OD_POS_Ship_Confirm_Proc (
        ...
        x_order_lines_tbl_out   OUT XX_ONT_ACK_ORD_LINES_TBL,
        x_status                OUT VARCHAR2,
        x_transaction_date      OUT VARCHAR2,
        x_message               OUT VARCHAR2);
        
END XX_ONT_LEG_POS_SHIP_CONF_PKG;
/
SHOW ERRORS;
EXIT;