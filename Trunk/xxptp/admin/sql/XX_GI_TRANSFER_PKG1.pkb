CREATE OR REPLACE PACKAGE BODY APPS.XX_GI_TRANSFER_PKG1
--Version Draft 1.3
-- +=============================================================================+
    ...
    DBMS_OUTPUT.PUT_LINE('------------------------');
      ...
      IF lb_header_has_error THEN
          ...
          -- If header has errors then set the input values
           ...
           x_out_hdr_rec(x_out_hdr_rec.LAST).no_of_detail_lines :=p_in_hdr_rec.no_of_detail_lines;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute_category :=p_in_hdr_rec.attribute_category;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute1 :=p_in_hdr_rec.attribute1;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute2 :=p_in_hdr_rec.attribute2;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute3 :=p_in_hdr_rec.attribute3;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute4 :=p_in_hdr_rec.attribute4;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute5 :=p_in_hdr_rec.attribute5;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute6 :=p_in_hdr_rec.attribute6;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute7 :=p_in_hdr_rec.attribute7;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute8 :=p_in_hdr_rec.attribute8;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute9 :=p_in_hdr_rec.attribute9;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute10 :=p_in_hdr_rec.attribute10;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute11 :=p_in_hdr_rec.attribute11;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute12 :=p_in_hdr_rec.attribute12;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute13 :=p_in_hdr_rec.attribute13;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute14 :=p_in_hdr_rec.attribute14;
           x_out_hdr_rec(x_out_hdr_rec.LAST).attribute15 :=p_in_hdr_rec.attribute15;
   ...
   BEGIN
      ...
      x_return_status := G_SUCCESS;
        ...
        IF lc_hdr_status <> G_PENDING_STATUS THEN
            ...
            x_out_line_tbl(x_out_line_tbl.LAST).attribute_category := lt_line_in_dtl(i).attribute_category;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute1 := lt_line_in_dtl(i).attribute1;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute2 := lt_line_in_dtl(i).attribute2;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute3 := lt_line_in_dtl(i).attribute3;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute4 := lt_line_in_dtl(i).attribute4;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute5 := lt_line_in_dtl(i).attribute5;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute6 := lt_line_in_dtl(i).attribute6;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute7 := lt_line_in_dtl(i).attribute7;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute8 := lt_line_in_dtl(i).attribute8;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute9 := lt_line_in_dtl(i).attribute9;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute10 := lt_line_in_dtl(i).attribute10;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute11 := lt_line_in_dtl(i).attribute11;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute12 := lt_line_in_dtl(i).attribute12;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute13 := lt_line_in_dtl(i).attribute13;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute14 := lt_line_in_dtl(i).attribute14;
            x_out_line_tbl(x_out_line_tbl.LAST).attribute15 := lt_line_in_dtl(i).attribute15;
   ...
   BEGIN
    ...
    -- Assigning header input values to variables
        ...
        BEGIN            
            ...
            l_hdr_rec.no_of_detail_lines := p_in_hdr_rec.no_of_detail_lines;           
            l_hdr_rec.attribute_category := p_in_hdr_rec.attribute_category;
            l_hdr_rec.attribute1 := p_in_hdr_rec.attribute1;
            l_hdr_rec.attribute2 := p_in_hdr_rec.attribute2;
            l_hdr_rec.attribute3 := p_in_hdr_rec.attribute3;
            l_hdr_rec.attribute4 := p_in_hdr_rec.attribute4;
            l_hdr_rec.attribute5 := p_in_hdr_rec.attribute5;
            l_hdr_rec.attribute6 := p_in_hdr_rec.attribute6;
            l_hdr_rec.attribute7 := p_in_hdr_rec.attribute7;
            l_hdr_rec.attribute8 := p_in_hdr_rec.attribute8;
            l_hdr_rec.attribute9 := p_in_hdr_rec.attribute9;
            l_hdr_rec.attribute10 := p_in_hdr_rec.attribute10;
            l_hdr_rec.attribute11 := p_in_hdr_rec.attribute11;
            l_hdr_rec.attribute12 := p_in_hdr_rec.attribute12;
            l_hdr_rec.attribute13 := p_in_hdr_rec.attribute13;
            l_hdr_rec.attribute14 := p_in_hdr_rec.attribute14;
            l_hdr_rec.attribute15 := p_in_hdr_rec.attribute15;
        ...
        BEGIN  
            ...
            FOR i in p_in_line_tbl.FIRST..p_in_line_tbl.LAST
             LOOP
                ...
                line_in_dtl(line_in_dtl.LAST).attribute_category := p_in_line_tbl(i).attribute_category;
                line_in_dtl(line_in_dtl.LAST).attribute1 := p_in_line_tbl(i).attribute1;
                line_in_dtl(line_in_dtl.LAST).attribute2 := p_in_line_tbl(i).attribute2;
                line_in_dtl(line_in_dtl.LAST).attribute3 := p_in_line_tbl(i).attribute3;
                line_in_dtl(line_in_dtl.LAST).attribute4 := p_in_line_tbl(i).attribute4;
                line_in_dtl(line_in_dtl.LAST).attribute5 := p_in_line_tbl(i).attribute5;
                line_in_dtl(line_in_dtl.LAST).attribute6 := p_in_line_tbl(i).attribute6;
                line_in_dtl(line_in_dtl.LAST).attribute7 := p_in_line_tbl(i).attribute7;
                line_in_dtl(line_in_dtl.LAST).attribute8 := p_in_line_tbl(i).attribute8;
                line_in_dtl(line_in_dtl.LAST).attribute9 := p_in_line_tbl(i).attribute9;
                line_in_dtl(line_in_dtl.LAST).attribute10 := p_in_line_tbl(i).attribute10;
                line_in_dtl(line_in_dtl.LAST).attribute11 := p_in_line_tbl(i).attribute11;
                line_in_dtl(line_in_dtl.LAST).attribute12 := p_in_line_tbl(i).attribute12;
                line_in_dtl(line_in_dtl.LAST).attribute13 := p_in_line_tbl(i).attribute13;
                line_in_dtl(line_in_dtl.LAST).attribute14 := p_in_line_tbl(i).attribute14;
                line_in_dtl(line_in_dtl.LAST).attribute15 := p_in_line_tbl(i).attribute15;
