...
*/
  ...
  g_request_id                   fnd_concurrent_requests.request_id%TYPE := fnd_global.conc_request_id();
   ...
   AS
	...
	lc_account_osr			APPS.HZ_CUST_ACCOUNTS.ORIG_SYSTEM_REFERENCE%TYPE;
	lc_org_contact_osr              APPS.HZ_ORIG_SYS_REFERENCES.OWNER_TABLE_NAME%TYPE;
	lc_os                           APPS.HZ_ORIG_SYS_REFERENCES.ORIG_SYSTEM%TYPE;
...
AS
   ...
   x_phone_obj             APPS.HZ_PHONE_CP_BO;
   tot_count              NUMBER;
