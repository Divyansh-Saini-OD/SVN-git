...
public class XxCsSrExceptionsImpl extends OAEntityImpl 
{
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxom.TDSrexceptions.server.XxCsSrExceptions");
    }
  ...
  {
    return (String)getAttributeInternal(EXCEPTIONPAYLOAD);
  }
   ...
   */
  public void setExceptionPayload(String value)
  {
  ...
  protected void setAttrInvokeAccessor(int index, Object value, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case NOTIFYFLAG:
        ...
        return;
      case EXCEPTIONPAYLOAD:
        setExceptionPayload((String)value);
        return;
      case REPROCESSFLAG:
