package od.oracle.apps.xxfin.ap.idms.traitmatrix.schema.server;
...
// ---------------------------------------------------------------------
public abstract class XXSupplierMatrixEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxfin.ap.idms.traitmatrix.schema.server.XXSupplierMatrixEO");
        }
     ...
     */
    public static Key createPrimaryKey(String attribute1) {
        return new Key(new Object[]{attribute1});
    }
}
