 ...
 * Controller for ...
 */
public class ODDesktopLOVCO extends IROAControllerImpl // OAControllerImpl
{
  ...
  public void initQuery(OAPageContext oapagecontext, OAWebBean oawebbean)
  {
      ...
      OAViewObject vo = (OAViewObject)oapagecontext.getApplicationModule(oawebbean).findViewObject("ODDesktopVO1");
