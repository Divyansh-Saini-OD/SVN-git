/*==========================================================================================+
 ...
 |                                                                                          |
 |1.2       08-SEP-2016    Sreedhar Mohan            Defect#39188 - R12.2.5 retrofit changes|
 +==========================================================================================*/

package od.oracle.apps.xxfin.ar.statements;
...
public class XXARCSEBURST implements JavaConcurrentProgram
{
    ...
    public void runProgram(CpContext ctx)
    {
        ...
        //Getting Unix Tops 
        String l_cust_top = ctx.getEnvStore().getEnv("XXCOMN_TOP");
    ...
    if (arg1.equals("Y"))
        ...
        ctl_file = l_cust_top + "/java/od/oracle/apps/xxfin/ar/statements/XXARCSCUSTBURST.xml";
       // dir_file = l_cust_top + "/xxcomn/java/oracle/apps/xxod/arstatements";
        ...
        {
        path= l_applcsf+"/"+ l_applout +"/" + "o" + arg +".out";
        ctl_file = l_cust_top + "/java/od/oracle/apps/xxfin/ar/statements/XXARCSSITEBURST.xml";
       // dir_file = l_cust_top + "/xxcomn/java/oracle/apps/xxod/arstatements";
