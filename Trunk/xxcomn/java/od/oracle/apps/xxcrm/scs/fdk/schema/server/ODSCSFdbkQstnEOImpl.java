...
public class ODSCSFdbkQstnEOImpl extends OAEntityImpl 
{
  ...
  protected static final int PRECEDENCE = 63;
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxcrm.scs.fdk.schema.server.ODSCSFdbkQstnEO");
    }
    ...
    public void create(AttributeList attributeList)
  {
    ...
    Number vFdkId = transaction.getSequenceValue("XXSCS_FDBK_QSTN_ID_S");
    setFdbkQstnId(vFdkId);
  }
  ...
  /**
   * 
   * Gets the attribute value for MultiResult, using the alias name MultiResult
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for MultiResult
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for Dependents
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for Layout
   */
