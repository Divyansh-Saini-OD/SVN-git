...
System.out.println("INSIDE OUTSIDE ");
 String psId= pageContext.getTransactionValue("ASNPartySiteId").toString();
 System.out.println("INSIDE OUTSIDE " + psId);
   if (!pageContext.isFormSubmission())
    {

System.out.println("INSIDE ");
       ODSCSDshbdAMImpl am = (ODSCSDshbdAMImpl)pageContext.getApplicationModule(webBean);
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    super.processFormRequest(pageContext, webBean);
     ...
     if (pageContext.getParameter("Details") != null) 
  {
  }
  }
