/*===========================================================================+
 ...
 |  HISTORY                                                                  |
 +===========================================================================*/
package od.oracle.apps.xxcrm.cdh.uploads.exposureseg.webui;
 ...
 * Controller for ...
 */
public class XXODCDHExposureSegUploadCO extends OAControllerImpl
{
  public static final String RCS_ID="$Header: XXODCDHExposureSegUploadCO.java 115.3 2006/06/13 12:54:12 ssmohan noship $";
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    System.out.println("--In XXODCDHExposureSegUploadCO, processRequest--");
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    System.out.println("--In XXODCDHExposureSegUploadCO, processFormRequest--");
  ...
  public static String doUpload(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    String file_name = LOG_DIR + "uploadFile_ExpSegments_" + pageContext.getUserId() + pageContext.getSessionId() + ".csv";
