package od.oracle.apps.xxcrm.cdh.uploads.bulk.schema.server;
/* Subversion Info:
 * $HeadURL: http://svn.na.odcorp.net/svn/od/common/trunk/xxcomn/java/od/oracle/apps/xxcrm/cdh/uploads/bulk/schema/server/ODImportToolsEOImpl.java $
 * $Rev: 260139 $
...
public class ODImportToolsEOImpl extends OAEntityImpl 
{
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxcrm.cdh.uploads.bulk.schema.server.ODImportToolsEO");
    }
