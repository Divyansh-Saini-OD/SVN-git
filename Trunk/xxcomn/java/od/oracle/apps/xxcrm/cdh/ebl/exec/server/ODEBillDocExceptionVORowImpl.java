...
/* Subversion Info:
 * $HeadURL: http://svn.na.odcorp.net/svn/od/common/trunk/xxcomn/java/od/oracle/apps/xxcrm/cdh/ebl/exec/server/ODEBillDocExceptionVORowImpl.java $
 * $Rev: 102483 $
 * $Date: 2010-05-14 04:21:27 -0400 (Fri, 14 May 2010) $
*/
...
public class ODEBillDocExceptionVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int CUSTACCOUNTID = 59;
  protected static final int FROMSITE = 60;
  protected static final int READONLYFLAG = 61;
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public ODEBillDocExceptionVORowImpl()
  {
  }

  /**
   * 
   * Gets ODEBillCustDocExecEO entity object.
   */
  public od.oracle.apps.xxcrm.cdh.ebl.exec.schema.server.ODEBillDocExecptionEOImpl getODEBillCustDocExecEO()
  {
    return (od.oracle.apps.xxcrm.cdh.ebl.exec.schema.server.ODEBillDocExecptionEOImpl)getEntity(0);
  }
  ...
  {
   //Commenting the below validation as per the new defect details provided by Srini on 14-May-2010
  // Added by Mangala for Bill To Site validation
 /*   String s1 = getFromSite();
   
    if (s1!=null && value !=null && value.equals(s1))
    {
      throw new OAException("XXCRM","XXOD_EBL_TOSITE_VALIDATE");
    } */
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute FromSite
   */
  public String getFromSite()
  {
    return (String)getAttributeInternal(FROMSITE);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute FromSite
   */
  ...
  /*// Added by Mangala for Bill To Site validation
    ...
    setAttributeInternal(FROMSITE, value);
  }
