package od.oracle.apps.xxcrm.cdh.uploads.remitto.server;
...
public class XXODCDHUploadRemitToAMImpl extends OAApplicationModuleImpl 
{
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public XXODCDHUploadRemitToAMImpl()
  {
  }
                               ...
                               String strFileName)
  {
    ...
    try{
        cs2 = getOADBTransaction().getJdbcConnection().prepareCall("{call XXOD_CDH_UPLOAD_REMITTO_PKG.upload(?,?,?,?)}");
  ...
  {
    launchTester("od.oracle.apps.xxcrm.cdh.uploads.remitto.server", "XXODCDHUploadRemitToAMLocal");
  }
}
