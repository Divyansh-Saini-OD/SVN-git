/*===========================================================================+
 ...
 +===========================================================================+
 |  FILENAME                                                                 |
 |             ODCDHErrRecGdwCO.java                                         |
 |                                                                           |
 |  DESCRIPTION                                                              |
 |    Controller Class to view the concurrent request for the                |
 |     program - OD: CDH Error Reconciliation for GDW/RMS Batch              |
 |                                                                           |
 |  NOTES                                                                    |
 |                                                                           |
 |                                                                           |
 ...
 * Controller for ...
 */
public class ODCDHErrRecGdwCO extends OAControllerImpl
{
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    {
        Serializable params[] = {"XX_CDH_CONV_ERROR_RECON_GDW"};
        ...
        } else
        {
            ...
            throw new OAException("The report OD: CDH Error Reconciliation for GDW/RMS Batch has not yet been run");
        }
