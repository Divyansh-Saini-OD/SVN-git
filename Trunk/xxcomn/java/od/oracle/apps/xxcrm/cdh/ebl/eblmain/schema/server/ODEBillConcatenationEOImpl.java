...
public class ODEBillConcatenationEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxcrm.cdh.ebl.eblmain.schema.server.ODEBillConcatenationEO");
        }
   ...
   //     super.lock();
    ...
    public void insertRow() {
        ...
        try {
            ...
            String s = 
                "BEGIN" + " xx_cdh_ebl_concatenate_pkg.insert_row(" + 
                "  p_conc_field_id => :1" + 
                " ,p_conc_field_label => :2 " + 
                " ,p_cust_account_id  => :3 " + 
                " ,p_cust_doc_id        => :4 " + 
                " ,p_conc_base_field_id1=> :5 " + 
                " ,p_conc_base_field_id2 => :6 " + 
                " ,p_conc_base_field_id3 => :7 " + 
                " ,p_attribute1          => :8 " + 
                " ,p_attribute2          => :9 " + 
                " ,p_attribute3          => :10 " + 
                " ,p_attribute4          => :11 " + 
            ...
            oadbtransaction.writeDiagnostics(this,"this.getConcFieldId()"+this.getConcFieldId(), 1);
            oadbtransaction.writeDiagnostics(this,"this.getCustAccountId()"+this.getCustAccountId(), 1);
            oadbtransaction.writeDiagnostics(this,"this.getCustDocId()"+this.getCustDocId(), 1);
            
            oraclecallablestatement = 
                (OracleCallableStatement)oadbtransactionimpl.createCallableStatement(s, 
                                                                                     -1);
            oraclecallablestatement.setNUMBER(1, this.getConcFieldId());
            oraclecallablestatement.setString(2, this.getConcFieldLabel());
            oraclecallablestatement.setNUMBER(3, this.getCustAccountId());
            oraclecallablestatement.setNUMBER(4, this.getCustDocId());
            oraclecallablestatement.setNUMBER(5, this.getConcBaseFieldId1());
            oraclecallablestatement.setNUMBER(6, this.getConcBaseFieldId2());
            oraclecallablestatement.setNUMBER(7, this.getConcBaseFieldId3());
     ...
     public void updateRow()
        {
		  OracleCallableStatement oraclecallablestatement = null;
            try
            {
                ...
                String s = 
                    "BEGIN" + " xx_cdh_ebl_concatenate_pkg.update_row(" + 
                    "  p_conc_field_id => :1" + 
                    " ,p_conc_field_label => :2 " + 
                    " ,p_cust_account_id  => :3 " + 
                    " ,p_cust_doc_id        => :4 " + 
       ...
       public void deleteRow()
       {
          ...
          try
          {
              ...
              String s= "BEGIN"
                          +" xx_cdh_ebl_concatenate_pkg.delete_row(p_conc_field_id    =>   :1 "
                          +" ,p_cust_doc_id                        =>:2);"
                          +" END;" ;
