/*===========================================================================+
 ...
 +===========================================================================+
 |  FILENAME                                                                 |
 |             ODCDHConvStatCO.java                                          |
 |                                                                           |
 |  DESCRIPTION                                                              |
 |    Controller Class to view the concurrent request for the                |
 |     program - OD: CDH Conversion Statistics                               |
 |                                                                           |
 |  NOTES                                                                    |
 |                                                                           |
 |                                                                           |
 ...
 * Controller for ...
 */
public class ODCDHConvStatCO extends OAControllerImpl
{
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    {
        Serializable params[] = {"XX_CDH_CONV_STATISTICS"};
        ...
        } else
        {
            ...
            throw new OAException("The report OD: CDH Conversion Statistics has not yet been run");
        }
