...
public class OD_ServiceRequestDetailsVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int DISPLAY = 39;
  protected static final int MSG_HDR = 40;
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public OD_ServiceRequestDetailsVORowImpl()
  {
  }

  /**
   * 
   * Gets OD_ServiceRequestDetailEO entity object.
   */
  public od.oracle.apps.xxcrm.cs.csz.servicerequest.schema.server.OD_ServiceRequestDetailEOImpl getOD_ServiceRequestDetailEO()
  {
    return (od.oracle.apps.xxcrm.cs.csz.servicerequest.schema.server.OD_ServiceRequestDetailEOImpl)getEntity(0);
  }
