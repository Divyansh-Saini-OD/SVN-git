 ...
 * Controller for ...
 */
public class XXCSMPSTotalAssetsUnderContractCO extends OAControllerImpl
{
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    OAApplicationModule mpsAssetsundercontractsAM = pageContext.getApplicationModule(webBean);
    if(pageContext.getParameter("SubmitBtn") != null)
    {
        ...
        mpsAssetsundercontractsAM.invokeMethod("initMPSAssetsundercontractRpt", params);
    }
  if(pageContext.getParameter("ClearBtn") != null){
        System.out.println("Before ClearBtn Click");
        clear(pageContext, webBean, mpsAssetsundercontractsAM);
        System.out.println("After ClearBtn Click");
   }
  }

  public void clear(OAPageContext pageContext, OAWebBean webBean, OAApplicationModule mpsAssetsundercontractsAM)
  {
