 ...
 * Controller for ...
 */
public class XXCSMPSTopprinterCO extends OAControllerImpl
{
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    OAApplicationModule mpsTopprinterAM = pageContext.getApplicationModule(webBean);
    if(pageContext.getParameter("SubmitBtn") != null)
    {
        ...
        Serializable params[] = {
            customerName,ProgramType,managedStatus,activeStatus
            };
        mpsTopprinterAM.invokeMethod("initMPSTopPrinterRpt", params);
    }
  if(pageContext.getParameter("ClearBtn") != null){
        System.out.println("Before ClearBtn Click");
        clear(pageContext, webBean, mpsTopprinterAM);
        System.out.println("After ClearBtn Click");
   }
  }

  public void clear(OAPageContext pageContext, OAWebBean webBean, OAApplicationModule mpsTopprinterAM)
  {
