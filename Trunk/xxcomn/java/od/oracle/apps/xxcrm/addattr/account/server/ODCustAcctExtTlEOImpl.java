...
public class ODCustAcctExtTlEOImpl extends OAEntityImpl
{
  ...
  protected static final int ODCUSTACCTEXTEO = 30;
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxcrm.addattr.account.server.ODCustAcctExtTlEO");
    }
  ...
  {
    this.setCustAccountId(this.getODCustAcctExtEO().getCustAccountId());
    this.setAttrGroupId(this.getODCustAcctExtEO().getAttrGroupId());
  ...
  protected Object getAttrInvokeAccessor(int index, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case ODCUSTACCTEXTEO:
        return getODCustAcctExtEO();
      default:
  ...
  /**
   * 
   * Gets the associated entity ODCustAcctExtEOImpl
   */
  public ODCustAcctExtEOImpl getODCustAcctExtEO()
  {
    return (ODCustAcctExtEOImpl)getAttributeInternal(ODCUSTACCTEXTEO);
  }

  /**
   * 
   * Sets <code>value</code> as the associated entity ODCustAcctExtEOImpl
   */
  public void setODCustAcctExtEO(ODCustAcctExtEOImpl value)
  {
    setAttributeInternal(ODCUSTACCTEXTEO, value);
  }
