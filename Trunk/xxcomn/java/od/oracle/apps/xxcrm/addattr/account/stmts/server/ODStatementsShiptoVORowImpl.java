...
import od.oracle.apps.xxcrm.addattr.account.stmts.schema.server.ODStatementsShiptoEOImpl;
...
// ---------------------------------------------------------------------
public class ODStatementsShiptoVORowImpl extends OAViewRowImpl {
     ...
     */
    public ODStatementsShiptoVORowImpl() {
    }

    /**Gets ODStatementsShiptoEO entity object.
     */
    public ODStatementsShiptoEOImpl getODStatementsShiptoEO() {
        return (ODStatementsShiptoEOImpl)getEntity(0);
    }
