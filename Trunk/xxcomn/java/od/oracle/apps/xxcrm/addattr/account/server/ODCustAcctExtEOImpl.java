...
public class ODCustAcctExtEOImpl extends OAEntityImpl
{
  ...
  protected static final int OA_TL_ENTITIES = 78;
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxcrm.addattr.account.server.ODCustAcctExtEO");
    }
   ...
   */
   ...
   if (operation == DML_INSERT) 
   {
    ...
    {
      this.getOADBTransaction().writeDiagnostics("SPC Base EO:doDML","INSERT",
   ...
   if(operation == DML_UPDATE)
   {
        if (this.getOADBTransaction().isLoggingEnabled(OAFwkConstants.STATEMENT))
    {
      this.getOADBTransaction().writeDiagnostics("SPC Base EO:doDML","UPDATE",
          OAFwkConstants.STATEMENT);
    }
   }
      if(operation == DML_DELETE)
   {
        if (this.getOADBTransaction().isLoggingEnabled(OAFwkConstants.STATEMENT))
    {
      this.getOADBTransaction().writeDiagnostics("SPC Base EO:doDML","DELETE",
          OAFwkConstants.STATEMENT);
    }
   }
