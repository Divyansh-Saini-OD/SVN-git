...
public class ODContractTemplatesVORowImpl extends OAViewRowImpl 
{
  ...
  /**
   * 
   * Gets XxCdhContractTemplateEO entity object.
   */
  public od.oracle.apps.xxcrm.asn.common.schema.server.ODXxCdhContractTemplateEOImpl getXxCdhContractTemplateEO()
  {
    return (od.oracle.apps.xxcrm.asn.common.schema.server.ODXxCdhContractTemplateEOImpl)getEntity(0);
  }
  ...
  /**
   * 
   * Gets the attribute value for CONTARCT_NUMBER using the alias name ContarctNumber
   */
  ...
  /**
   * 
   * Sets <code>value</code> as attribute value for CONTARCT_NUMBER using the alias name ContarctNumber
   */
