/*===========================================================================+
 ...
 +===========================================================================+
 |  FILENAME                                                                 |
 |             ODHzPartySitesExtBEOImpl.java                                 |
 |                                                                           |
 |  DESCRIPTION                                                              |
 |    Entity Object Implementation for HZ_PARTY_SITES_EXT_B Base Table       |
 |                                                                           |
 |                                                                           |
 |  NOTES                                                                    |
...
public class ODHzPartySitesExtBEOImpl extends OAEntityImpl 
{
...
final String METHOD_NAME = "od.oracle.apps.xxcrm.asn.common.customer.server.ODHzPartySitesExtBEOImpl.create";
   ...
   */
  public ODHzPartySitesExtBEOImpl()
  {
  }
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxcrm.asn.common.customer.server.ODHzPartySitesExtBEO");
    }
  ...
  public void create(AttributeList attributeList)
  {
   ...
   //  String startDate =(String) transaction.getCurrentDBDate().toString();
  ...
  {
  //  Diagnostic.println("In doDML() in ODHzPartySitesExtBEOImpl()");
  ...
  {
   // Diagnostic.println("Within setCExtAttr2");
