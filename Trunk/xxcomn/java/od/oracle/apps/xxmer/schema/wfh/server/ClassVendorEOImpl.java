...
public class ClassVendorEOImpl extends OAEntityImpl 
{
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxmer.schema.wfh.server.ClassVendorEO");
    }
   ...
   */
  public static Key createPrimaryKey(Number orgId, Number merchClassId, Number vendorSiteId)
  {
    return new Key(new Object[] {orgId, merchClassId, vendorSiteId});
  }
}