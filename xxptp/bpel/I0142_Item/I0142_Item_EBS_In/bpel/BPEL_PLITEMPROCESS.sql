...
CREATE OR REPLACE PACKAGE BPEL_PLITEMPROCESS AS
   ...
   PROCEDURE XX_INV_ITEM_IN_PKG$INTERFACE_ (P_ACTIONEXPRESSION VARCHAR2,P_REASON_CODE VARCHAR2,P_MASTER_ITEM_HDR_REC XX_INV_ITEM_IN_PKG_G_MASTER_I,P_MASTER_ITEM_CATEGORY_REC XX_INV_ITEM_IN_PKG_G_MASTER_1,P_MASTER_ITEM_ATTRI_REC XX_INV_ITEM_IN_PKG_ROWTYPE_SQ,P_LOCATION_REC XX_INV_ITEM_IN_PKG_G_LOCATION,X_MESSAGE_CODE OUT NUMBER,X_MESSAGE_DATA OUT VARCHAR2);
END BPEL_PLITEMPROCESS;
/
show errors
CREATE OR REPLACE PACKAGE BODY BPEL_PLITEMPROCESS IS
	FUNCTION PL_TO_SQL0(aPlsqlItem XX_INV_ITEM_IN_PKG.G_MASTER_ITM_HDR_REC_TYPE)
	...
	BEGIN 
		-- initialize the object
		aSqlItem := XX_INV_ITEM_IN_PKG_ROWTYPE_SQ(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	...
	BEGIN 
		-- initialize the object
		aSqlItem := XXINVITEMINPKGGLOCATION_ROWTY(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
		aSqlItem.SOURCE_SYSTEM_CODE := aPlsqlItem.SOURCE_SYSTEM_CODE;
		aSqlItem.SOURCE_SYSTEM_REF := aPlsqlItem.SOURCE_SYSTEM_REF;
		aSqlItem.INVENTORY_ITEM_ID := aPlsqlItem.INVENTORY_ITEM_ID;
		aSqlItem.ORGANIZATION_ID := aPlsqlItem.ORGANIZATION_ID;
   ...
   BEGIN
      P_MASTER_ITEM_HDR_REC_ := BPEL_PLITEMPROCESS.SQL_TO_PL0(P_MASTER_ITEM_HDR_REC);
      P_MASTER_ITEM_CATEGORY_REC_ := BPEL_PLITEMPROCESS.SQL_TO_PL1(P_MASTER_ITEM_CATEGORY_REC);
      P_MASTER_ITEM_ATTRI_REC_ := BPEL_PLITEMPROCESS.SQL_TO_PL2(P_MASTER_ITEM_ATTRI_REC);
      P_LOCATION_REC_ := BPEL_PLITEMPROCESS.SQL_TO_PL3(P_LOCATION_REC);
      APPS.XX_INV_ITEM_IN_PKG.INTERFACE_ITEM_DATA(P_ACTIONEXPRESSION,P_REASON_CODE,P_MASTER_ITEM_HDR_REC_,P_MASTER_ITEM_CATEGORY_REC_,P_MASTER_ITEM_ATTRI_REC_,P_LOCATION_REC_,X_MESSAGE_CODE,X_MESSAGE_DATA);
