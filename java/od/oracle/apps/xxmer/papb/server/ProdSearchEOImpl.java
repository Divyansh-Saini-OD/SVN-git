...
public class ProdSearchEOImpl extends OAEntityImpl 
{
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxmer.papb.server.ProdSearchEO");
    }
  ...
  /**
   * 
   * Gets the attribute value for DiMerchant, using the alias name DiMerchant
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for DiMerchant
   */
  ...
  /**
   * 
   * Gets the attribute value for DomesticMerchant, using the alias name DomesticMerchant
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for DomesticMerchant
   */
  ...
  /**
   * 
   * Gets the attribute value for TrackerType, using the alias name TrackerType
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for TrackerType
   */
  ...
  /**
   * 
   * Gets the attribute value for TrackerYear, using the alias name TrackerYear
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for TrackerYear
   */
   ...
   */
  public static Key createPrimaryKey(Number prodDtlId)
  {
    return new Key(new Object[] {prodDtlId});
  }
}