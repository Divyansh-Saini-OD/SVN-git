 ...
 * Controller for ...
 */
public class ODReleaseLOVCO extends IROAControllerImpl // OAControllerImpl
{
  ...
  public void initQuery(OAPageContext oapagecontext, OAWebBean oawebbean)
  {
      ...
      OAViewObject vo = (OAViewObject)oapagecontext.getApplicationModule(oawebbean).findViewObject("ODReleaseVO1");
