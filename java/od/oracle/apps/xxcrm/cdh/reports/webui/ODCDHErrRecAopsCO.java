/*===========================================================================+
 ...
 +===========================================================================+
 |  FILENAME                                                                 |
 |             ODCDHErrRecAopsCO.java                                        |
 |                                                                           |
 |  DESCRIPTION                                                              |
 |    Controller Class to view the concurrent request for the                |
 |     program - OD: CDH Error Reconciliation for AOPS Batch                 |
 |                                                                           |
 |  NOTES                                                                    |
 |                                                                           |
 |                                                                           |
 ...
 * Controller for ...
 */
public class ODCDHErrRecAopsCO extends OAControllerImpl
{
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    {
        Serializable params[] = {"XX_CDH_CONV_ERROR_RECON"};
        ...
        } else
        {
            ...
            throw new OAException("The report OD: CDH Error Reconciliation for AOPS Batch has not yet been run");
        }
    }
  }
}
