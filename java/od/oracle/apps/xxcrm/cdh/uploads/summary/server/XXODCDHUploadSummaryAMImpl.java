package od.oracle.apps.xxcrm.cdh.uploads.summary.server;
...
public class XXODCDHUploadSummaryAMImpl extends OAApplicationModuleImpl 
{
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public XXODCDHUploadSummaryAMImpl()
  {
  }
                               ...
                               String strFileName)
  {
    ...
    try{
        cs2 = getOADBTransaction().getJdbcConnection().prepareCall("{call XXOD_CDH_UPLOAD_SUMMARY_PKG.upload(?,?,?,?)}");
  ...
  {
    launchTester("od.oracle.apps.xxcrm.cdh.uploads.summary.server", "XXODCDHUploadSummaryAMLocal");
  }
}
