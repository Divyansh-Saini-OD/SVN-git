...
// ---------------------------------------------------------------------
public class ODEBillDynConcFieldsVOImpl extends OAViewObjectImpl {
    /**This is the default constructor (do not remove)
     */
    public ODEBillDynConcFieldsVOImpl() {
    }
    
    public void initQuery(String custDocId, String sTab)
          {
              this.clearCache();
           Number xcustDocId = new Number(Integer.parseInt(custDocId));
            ...
            this.setWhereClauseParam(0,custDocId);
              this.setWhereClauseParam(1,sTab);
