...
import od.oracle.apps.xxcrm.cdh.ebl.ebltxtmain.schema.server.ODEBillTemplHdrTxtEOImpl;
...
// ---------------------------------------------------------------------
public class ODEBillTemplHdrTxtVORowImpl extends OAViewRowImpl {

    public static final int CUSTDOCID = 0;
    public static final int INCLUDELABEL = 1;
    ...
    public static final int ROWNUMBER = 55;
    public static final int STARTTXTPOS = 56;
    public static final int ENDTXTPOS = 57;
    public static final int FILLTXTPOS = 58;
    public static final int JUSTIFYTXT = 59;
    public static final int STARTVALPOS = 60;
    public static final int ENDVALPOS = 61;
    public static final int PREPENDCHAR = 62;
    public static final int APPENDCHAR = 63;
    public static final int EBLTEMPLHDRID = 64;
    ...
    public static final int LABELMETHODHDR = 69;
    public static final int ABSOLUTEFLAG = 70;
    public static final int DCINDICATOR = 71;
    public static final int DBCRSEPERATOR = 72;

    /**This is the default constructor (do not remove)
     */
    public ODEBillTemplHdrTxtVORowImpl() {
    }

    /**Gets ODEBillTemplHeaderTxtEO entity object.
     */
    public ODEBillTemplHdrTxtEOImpl getODEBillTemplHeaderTxtEO() {
        return (ODEBillTemplHdrTxtEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for INCLUDE_LABEL using the alias name IncludeLabel
     */
    public String getIncludeLabel() {
        return (String) getAttributeInternal(INCLUDELABEL);
    }

    /**Sets <code>value</code> as attribute value for INCLUDE_LABEL using the alias name IncludeLabel
     */
    public void setIncludeLabel(String value) {
        setAttributeInternal(INCLUDELABEL, value);
    }
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case ISUSEDINCONCATORSPLIT:
            ...
            return;
        case LABELMETHODHDR:
            setLabelmethodhdr((String)value);
            return;
        case ABSOLUTEFLAG:
    ...
    /**Gets the attribute value for EBL_TEMPLHDR_ID using the alias name EblTemplhdrId
     */
    public Number getEblTemplhdrId() {
        return (Number) getAttributeInternal(EBLTEMPLHDRID);
    }

    /**Sets <code>value</code> as attribute value for EBL_TEMPLHDR_ID using the alias name EblTemplhdrId
     */
    public void setEblTemplhdrId(Number value) {
        setAttributeInternal(EBLTEMPLHDRID, value);
    }
    ...
    /**Gets the attribute value for the calculated attribute Labelmethodhdr
     */
    public String getLabelmethodhdr() {
        return (String) getAttributeInternal(LABELMETHODHDR);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute Labelmethodhdr
     */
    public void setLabelmethodhdr(String value) {
        setAttributeInternal(LABELMETHODHDR, value);
    }
