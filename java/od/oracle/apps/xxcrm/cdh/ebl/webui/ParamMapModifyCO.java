 ...
 * Controller for ...
 */
public class ParamMapModifyCO extends OAControllerImpl
{
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    EbillingParamAMImpl am = (EbillingParamAMImpl) pageContext.getApplicationModule(webBean); 
    am.invokeMethod("initParamMapQuery");
