...
public class ODEBillCustDocHeaderVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int CUSTOMERTYPE = 3;
  protected static final int ABFLAG = 4;
  protected static final int BILLINGID = 5;
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public ODEBillCustDocHeaderVORowImpl()
  {
  }
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute BillingId
   */
  public String getBillingId()
  {
    return (String)getAttributeInternal(BILLINGID);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute BillingId
   */
