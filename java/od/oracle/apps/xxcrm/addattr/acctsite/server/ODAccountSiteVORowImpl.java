...
public class ODAccountSiteVORowImpl extends EgoExtAttributeDataVORowImpl 
{
  ...
  protected static final int CUSTACCTSITEID = MAXATTRCONST + 1;
  ...
  /**
   * 
   * Gets ODAccountSiteEO entity object.
   */
  public ODAccountSiteEOImpl getODAccountSiteEO()
  {
    return (ODAccountSiteEOImpl)getEntity(0);
  }
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute DeleteAttr
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute DeleteAttr
   */
