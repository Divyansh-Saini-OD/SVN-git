...
public class ODLeadAccessDetailsVORowImpl extends OAViewRowImpl 
{


  protected static final int ACCESSID = 0;
  protected static final int SALESLEADID = 1;
  protected static final int SALESFORCEID = 2;
  protected static final int SALESGROUPID = 3;
  protected static final int TEAMLEADERFLAG = 4;
  protected static final int OWNERFLAG = 5;
  protected static final int FREEZEFLAG = 6;
  protected static final int SOURCEJOBTITLE = 7;
  protected static final int SOURCEPHONE = 8;
  protected static final int SOURCEEMAIL = 9;
  protected static final int RESOURCENAME = 10;
  protected static final int CUSTOMERID = 11;
  protected static final int OBJECTVERSIONNUMBER = 12;
  protected static final int ASNSTACCSWITCHER = 13;
  protected static final int ASNSTKEEPSWITCHER = 14;
   ...
   */
  public ODLeadAccessDetailsVORowImpl()
  {
  }
  ...
  {
    return (Number)getAttributeInternal(SALESLEADID);
  }
  ...
  {
    setAttributeInternal(SALESLEADID, value);
  }
