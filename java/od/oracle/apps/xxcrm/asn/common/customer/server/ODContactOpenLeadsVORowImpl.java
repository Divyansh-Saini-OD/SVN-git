...
import oracle.apps.asn.common.customer.server.ContactOpenLeadsVORowImpl;
...
public class ODContactOpenLeadsVORowImpl extends ContactOpenLeadsVORowImpl
{
  protected static final int MAXATTRCONST = oracle.jbo.server.ViewDefImpl.getMaxAttrConst("oracle.apps.asn.common.customer.server.ContactOpenLeadsVO");;


  protected static final int ADDRESS = MAXATTRCONST;
  protected static final int COUNTRY = MAXATTRCONST + 1;
  protected static final int ADDRESSID = MAXATTRCONST + 2;
  /**
   *
   * This is the default constructor (do not remove)
   */
  public ODContactOpenLeadsVORowImpl()
  {
  }
