/*===========================================================================+
 ...
 +===========================================================================+
 |  FILENAME                                                                 |
 |             ODSiteOpenOpprVOImpl.java                                     |
 |                                                                           |
 |  DESCRIPTION                                                              |
 |    Class to initial and execute the VO query to fetch the open            |
 |    opportunities related to the given party site.                         |
 |                                                                           |
 |  NOTES                                                                    |
 |                                                                           |
 |                                                                           |
 |  DEPENDENCIES                                                             |
 |    This class file is called from ODSiteBusActOpenOpprAMImpl.java         |
 |                                                                           |
 |  HISTORY                                                                  |
 |                                                                           |
...
public class ODSiteOpenOpprVOImpl extends OAViewObjectImpl 
{
 /**
  * Oracle Applications internal source control identifier.
  */
  public static final String RCS_ID="$Header: ODSiteOpenOpprVOImpl.java,v 1.2 2007/10/01 11:53:58 Ashokuma Exp $";
