...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="XSD">
      <schema location="oramds:/apps/ODCommon/EnterpriseObjects/Core/EBO/Project/V1/ProjectEBO.xsd"/>
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.4.0(build 110106.1932.5682) AT [THU MAR 22 14:25:32 EDT 2012]. -->
?>
