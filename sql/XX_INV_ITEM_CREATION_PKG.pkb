...
-- +=============================================================================+
   ...
   IS
      ...
      IS
         SELECT inventory_item_id, segment1
          ...
          WHERE description = p_item_description
   ...
   BEGIN
      ...
      --        INTO   ln_user_id, ln_resp_id,ln_application_id
      --        FROM   fnd_user fnd
      --        ,      fnd_responsibility_tl fresp
      --        WHERE  fnd.user_name = 'CS_ADMIN'
      --        AND    fresp.responsibility_name = NULL;
      ...
      OPEN c_item_check (p_item_description, ln_master_org_id);
      ...
      THEN
         ...
         OPEN c_item_check (p_item_description, ln_organization_id);
