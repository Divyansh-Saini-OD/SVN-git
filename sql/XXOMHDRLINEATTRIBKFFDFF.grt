...
GRANT ALL ON XXOM.XX_OM_HEADERS_ATTRIBUTES_ALL TO APPS;

PROMPT
PROMPT Providing Grant on the Table XX_OM_HEADERS_ATTRIBUTES_ALL_S to Apps .....
PROMPT

GRANT ALL ON  XXOM.XX_OM_HEADERS_ATTRIBUTES_ALL_S TO APPS;
...
GRANT ALL ON  XXOM.XX_OM_LINES_ATTRIBUTES_ALL TO APPS;

PROMPT
PROMPT Providing Grant on the Table XX_OM_LINES_ATTRIBUTES_ALL to Apps .....
PROMPT

GRANT ALL ON  XXOM.XX_OM_LINES_ATTRIBUTES_ALL_S TO APPS;
