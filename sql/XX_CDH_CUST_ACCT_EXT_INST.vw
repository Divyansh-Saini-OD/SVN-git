...
-- +===================================================================+
-- | Name        :  XX_CDH_CUST_ACCT_EXT_INST.tbl                      |
-- | Description :  Create custom DB Tables,Views and Indexes for      |
-- |                Account-Site additional attributes                 |
-- |                The Objects created are:                           |
-- |                 1. XX_CUST_ACCT_EXT_B      (Extension Table)      |
-- |                 2. XX_CUST_ACCT_EXT_B_N1   (Index )               |
-- |                 3. XX_CUST_ACCT_EXT_B_U1   (Unique Index )        |
-- |                 4. XX_CUST_ACCT_EXT_TL     (Translation)          |
-- |                 5. XX_CUST_ACCT_EXT_TL_N1  (Index )               |
-- |                 6. XX_CUST_ACCT_EXT_TL_U1  (Unique Index )        |
-- |                 7. XX_CUST_ACCT_EXT_VL     (View)                 |
-- |                                                                   |
-- |Change Record:                                                     |
-- |===============                                                    |
...
PROMPT
PROMPT Creating View XX_CUST_ACCT_EXT_VL 
PROMPT   

CREATE OR REPLACE  VIEW XX_CUST_ACCT_EXT_VL
...
FROM XX_CUST_ACCT_EXT_B B , 
XX_CUST_ACCT_EXT_TL TL 
