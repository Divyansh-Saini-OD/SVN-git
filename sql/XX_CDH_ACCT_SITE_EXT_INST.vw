...
PROMPT
PROMPT Creating View XX_ACCT_SITE_EXT_VL 
PROMPT   

CREATE OR REPLACE  VIEW XX_ACCT_SITE_EXT_VL
(EXTENSION_ID, CUST_ACCT_SITE_ID,  ATTR_GROUP_ID, CREATED_BY, 
 ...
 TL_EXT_ATTR20)
AS 
SELECT B.EXTENSION_ID , B.CUST_ACCT_SITE_ID , B.ATTR_GROUP_ID , 
...
FROM XX_ACCT_SITE_EXT_B B , 
XX_ACCT_SITE_EXT_TL TL 
