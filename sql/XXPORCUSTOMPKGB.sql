CREATE OR REPLACE PACKAGE BODY APPS.POR_CUSTOM_PKG AS

/* $Header: PORCUSTB.pls 115.19.11510.4 2004/12/17 01:22:03 aktang ship $ */
...
-- line data: update any of the following parameters as default for line
  ...
  IS
BEGIN
  -- Commended for the Customization of E0979 Assign Need By Date Dt 25 Jan 2007 by Pradeep R
  -- X_RETURN_CODE:=0;
  -- X_ERROR_MSG:='';

  -- Added for the Extesnion E0979 Assign Need By Date Dt 25 Jan 2007 by Pradeep R
   xx_ipo_needbydate_proc(x_item_id,x_need_by_date,x_return_code,x_error_msg,x_deliver_to_org_id);
END;
