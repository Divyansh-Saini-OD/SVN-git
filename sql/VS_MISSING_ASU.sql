...
--| Object Name    :                                                                            |--
--|                                                                                             |--
--| Program Name   : VS_MISSING_ASU.sql                                                      |--        
--|                                                                                             |--   
--|                                                                                             |-- 
--| Change History  :                                                                           |--
...
PROMPT
PROMPT Script VS_MISSING_ASU....
PROMPT

select a.aops_batch_id AOPS, e.batch_id EBS, s.ACCT_SITE_ORIG_SYS_REFERENCE, s.SITE_USE_CODE, s.org_id ORG_ID, s.interface_status STA, e.exception_log error
