...
---         
      ...
      INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (12,'inside for loop of vedor_audit_notify');  
      END LOOP;
...
-----
  ...
  INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (12,'inside IF lc_trans_status');  
	 ...
	 ELSE
	 INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (13,'inside IF else of lc_trans_status'); 
...
INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (12,'before calling xx_pa_pb_compliance for draft'); 
  ...
  END IF;
     ...
     INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (12,'inside lc_trans_statsu for draft'); 
       v_text := null;
       v_text := v_text||chr(13);
	   ...
	   INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (13,'inside lc_trans_statsu for draft before calling mail'); 
     ...
     IF p_match_flag = 'N'  THEN
	   ...
	   INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (14,'end of lc_send_mail'); 
           v_email_list:='saritha.mummaneni@officedepot.com:neeraj.sharma@officedepot.com';
    	   v_cc_email_list:='saileshan.subhakaran@officedepot.com';
       ELSE
       
       INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (14,'end of else of lc_send_mail'); 
      ...
      ELSE
         SELECT COUNT (*)
          ...
          WHERE od_sc_inspection_no = p_audit_rec.inspection_no
            ...
            INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values
(3,'taking count ln_audit_count');
...
commit;
         ...
         THEN
            ...
            lc_insert_type := '2' ; 
                     ...
                     INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (4,'checking ln_audit_count value');
commit;
...
-- added the following function call to include the regional collection plans 
         ...
         THEN
            ...
            INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (5,'checking lc_vend_exists_count value');
      ...
      END;                                                  -- End for Begin 2
       ...
       INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (4,'End of begin..exc');
...
--***** code added for notification
      IF TRIM (UPPER (lc_trans_status)) = 'DRAFT'
      THEN
      INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (5,'Inside DRAFT status');
...
-- #############################################################################################################
    INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (6,'before selecting violation');
    ...
    SELECT GREATEST ((SELECT ln_find_count
        ...
        INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (7,'after selecting \violatoin');
...
---         
	...
	INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (8,'inside loop');                            
      END LOOP;
...
--dbms_output.put_line('**********Finding Table*****************');
      ...
      LOOP                                                  -- Loop for Insert
         ...
         INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (9,'inside loop for insert');                            
         ...
         THEN
             INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (10,'inside p_violation_tbl condition');                            
         ...
         INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (11,'before inserting into q_od_sc_vendor_audit_iv');                            
...
--
         ...
         INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (11,'end of inserting into q_od_sc_vendor_audit_iv');  
      END LOOP;        
      --  End Loop for Insert
...
-- #############################################################################################################
               ...
               INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (12,'before calling master values with Final vendor_audit_notify');  
                    vendor_audit_notify( p_header_rec    => p_header_rec
                      ,p_audit_rec     => p_audit_rec
                      ,p_vendor_tbl    => p_vendor_tbl
                      ,p_match_flag    => lc_match_flag
...
--dbms_output.put_line('Return Code....' ||  x_return_cd);
   EXCEPTION                                          -- Exception for Begin 1
      ...
      THEN
         ...
         INSERT into XX_GSO_PO_STG(PO_LINE_NO,DESCRIPTION) values (11,'before proc end vendor_audit_result_pub');  
         commit;
