 ...
 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>
	 ...
	 <tr>
	 <td width="100%" class="OraTableColumnHeader"><b>Other Store Portal Communication:</b>
		</td>
   ...
   <% 
          String srRequestNumber1 = request.getParameter("srID");
	 	  String test11 = "Explain Details of Communication:";
		  String test22 = "When should file(s) be removed from the Store Portal?";
		  String test33 = "Desired Communication Date:";
	 ...
	 String test3 = request.getParameter("calendar1");



	 String sr_type = "Other Store Communication";
