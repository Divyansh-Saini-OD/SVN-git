...
function checkform(form) { 
    ...
    alert( "Please Enter the Expain Details of Communication" );
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>
	 ...
	 <tr>
	 <td width="100%" class="OraTableColumnHeader"><b>Other Store Communication:</b>
		</td>
...
<table>
<tr>
<td class="OraPromptText" ><a target="_blank" href="http://sp.na.odcorp.net/sites/StoreSupport/home/Shared%20Documents/SS_Request_System_Business_Rules/Other_Store_Communication_BR.pdf" title="">Click here to review the Other Store Communication Business Rules</a></td>
</tr>
</table>
<form name="form1" method="post" action="xxod_Other_Store_Portal_Process.jsp?srID=<%=srRequestNumber%>" onsubmit="return checkform(this)" >
...
<table width="100%">
<tr>
  <td class="OraPromptText" bgcolor="#CC0000" border="1"  BORDERCOLOR ="#FFFFFF"  ><font color="#FFFFFF"><B> Desired Communication Date:</td>
  <td bgcolor="#B0B0B0"> <input type="text" name="calendar1" size="40" style="background-color:yellow;" /><a href="#" onclick="return getCalendar(document.form1.calendar1);"><img src="Calendar/calendar.png" border="0" /></a>
  </td>
</tr>
</table>
  </td>
  ...
  <tr>
<td class="OraPromptText" bgcolor="#CC0000" ><font color="#FFFFFF"><B>Explain Details of Communication:</B><I><BR>if greater than 200 characters, memo is required</I></font> </td>
</tr>
<tr>
<td><TEXTAREA NAME="Business_opp1" COLS=100 ROWS=6 style="background-color:yellow;"></TEXTAREA>
</td>
</tr>

 <tr>
<td class="OraPromptText" bgcolor="#CC0000" ><font color="#FFFFFF"><B>When should file(s) be removed from the Store Portal?</B></font> </td>
</tr>
<tr>
<td><TEXTAREA NAME="Business_opp2" COLS=100 ROWS=1></TEXTAREA>
</td>
</tr>
<tr>
