    ...
    if (iRequestHandlerStatus > 0)
    {
        ...
        if (iRequestHandlerStatus == 1)
        {
            ...
            caboMgr.setMessage(sMsgs[0], CaboUtil.CONFIRMATION_MESSAGE);
             ...
             String newURL          = IBUUtil.getURL("IBU_SR_DETAILS_CUSTOM") + "&srID=" + newSRID;
...
<FORM name="SRDetails" action="<%=IBUUtil.getURL("IBU_SR_DETAILS_CUSTOM")+"&srID="+requestNumber%>" method="post">
