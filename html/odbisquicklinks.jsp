  ...
  **/
  %><%@
   ...
   import="java.sql.*"
  import="od.oracle.apps.xxcrm.bis.pmv.report.ODQuickLinksBean"
 ...
 %><%
   ...
   try
   {
     ...
     if (userSession.isSONAR()) {
       ODQuickLinksBean reportPageBean = new ODQuickLinksBean(userSession);
       ...
       ODQuickLinksBean reportPageBean = new ODQuickLinksBean();
