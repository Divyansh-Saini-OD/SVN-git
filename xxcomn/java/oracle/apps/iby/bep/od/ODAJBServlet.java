package oracle.apps.iby.bep.od;
...
import oracle.apps.iby.bep.od.struct.AJBResponseStruct;
import oracle.apps.iby.bep.od.struct.PurchCardAuthStruct;
    ...
    String getAJBAuthRequestString(PurchCardAuthStruct oCommonAuth,
        ...
        try {
            ...
            if (sOrderId.equals("ARI") || (sTokenEnabled != null && sTokenEnabled.equals("Y"))) {
			    oStringBuffer.append("*Tokenization *forcebankfamily MPSCRD,"); // Amex - Added *forcebankfamily
			} else {
			    oStringBuffer.append(",");
			}
            //  IxOption
