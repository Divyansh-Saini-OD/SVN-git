...
/*============================================================================+
 ...
 |  HISTORY                                                                   |
 |                                                                            |
 |    04-Nov-2007   Anusha R       Modified                                   |
 |    14-Mar-2008   Madankumar J   Modified for fixing the defect 5410.       |
 |                                 replicated the old file logic in the latest|
 |                                 file taken from the standard top as the    |
 |                                 patch was applied.                         |
 |    31-Jul-2008   Rama Krishna K Defect 9423, changed IN to EXISTS for      |
 |                                 performance reasons                        |
 +===========================================================================*/
...
public class ShoppingSearchVOBuilder extends ShoppingVOBuilder
{
    ...
    public static final String RCS_ID = "$Header: ShoppingSearchVOBuilder.java 115.21.11510.3 2007/06/08 19:13:14 ahariha" +
"r ship $"
;
    public static final boolean RCS_ID_RECORDED = VersionInfo.recordClassVersion("$Header: ShoppingSearchVOBuilder.java 115.21.11510.3 2007/06/08 19:13:14 ahariha" +
"r ship $"
, "oracle.apps.icx.icatalog.shopping.server");
    ...
    protected String constructHintClause(CategoryElement categoryelement, CategoryElement categoryelement1, BuilderContext buildercontext, OAApplicationModuleImpl oaapplicationmoduleimpl)
    {
        ...
        if("Relevance".equals(s2) && super.m_type.equals("Shopping Search") || "Favorite List Item".equals(s1) || "Public List Item".equals(s1))
        {
            s = "FIRST_ROWS";
        } else
...
//      Commenting below line since adding EXISTS Clause instead of IN, so table not needed - defect 9423
		//stringbuffer.append("ICX_CAT_ITEMS_TLP");
        
 // View statement is added for the E0990 Restrict Items by Anusha on 11 Apr 2007
 // Commented below line for defect 9423 and added next line
 //       stringbuffer.append(".internal_item_id IN (select inventory_item_id from XX_PO_RESP_CATSETS_V) ");
        stringbuffer.append("EXISTS (select 1 from XX_PO_RESP_CATSETS_V WHERE ICX_CAT_ITEMS_TLP.internal_item_id = XX_PO_RESP_CATSETS_V.inventory_item_id) ");
        stringbuffer.append(" AND ");
        stringbuffer.append("ICX_CAT_ITEMS_TLP");
    ...
    protected OAViewObjectImpl getAuxiliaryViewObject(BuilderContext buildercontext, OAApplicationModuleImpl oaapplicationmoduleimpl, String s, String s1)
    {
        ...
        {
            s4 = "DISTINCT ICX_CAT_ITEMS_TLP.primary_category_id  AS CategoryId, ICX_CAT_ITEMS_TLP" +
".primary_category_name AS CategoryName"
;
        ...
        if(s1.equals("Favorite List Matches"))
        {
            ...
            stringbuffer.append(" AND POR_FAVORITE_LIST_HEADERS.favorite_list_id = POR_FAVORITE_LIST_LINES.favori" +
"te_list_id "
);
        ...
        OAViewObjectImpl oaviewobjectimpl1 = (OAViewObjectImpl)oaapplicationmoduleimpl.createViewObject(s,(OAViewDef)catalogviewdefimpl);
    ...
    protected String constructWhereClauseForFavoriteItem(CategoryElement categoryelement, CategoryElement categoryelement1, BuilderContext buildercontext, OAApplicationModuleImpl oaapplicationmoduleimpl)
    {
        ...
        stringbuffer.append(" and POR_FAVORITE_LIST_LINES.rt_item_id is not null and POR_FAVORITE_LIST_LINES." +
"rt_item_id = ICX_CAT_ITEMS_TLP.rt_item_id "
);
        stringbuffer.append(" and ICX_CAT_ITEMS_TLP.rt_item_id = ICX_CAT_ITEM_PRICES.rt_item_id  and ICX_CAT_" +
"ITEM_PRICES.active_flag = 'Y' "
);
        ...
        super.m_bindIndex++;
        stringbuffer.append(") ");
        stringbuffer.append(" and ((POR_FAVORITE_LIST_LINES.price_list_id is null and ICX_CAT_ITEM_PRICES.pri" +
"ce_list_id is null "
);
        stringbuffer.append(" and ((POR_FAVORITE_LIST_LINES.SOURCE_DOC_HEADER_ID = ICX_CAT_ITEM_PRICES.contra" +
"ct_id "
);
        stringbuffer.append(" and POR_FAVORITE_LIST_LINES.SOURCE_DOC_LINE_ID = ICX_CAT_ITEM_PRICES.contract_l" +
"ine_id) "
);
        stringbuffer.append("  or (POR_FAVORITE_LIST_LINES.SOURCE_DOC_HEADER_ID is null and POR_FAVORITE_LIST" +
"_LINES.TEMPLATE_NAME = ICX_CAT_ITEM_PRICES.template_id "
);
        stringbuffer.append(" and POR_FAVORITE_LIST_LINES.TEMPLATE_LINE_NUM = ICX_CAT_ITEM_PRICES.template_li" +
"ne_id) "
);
        stringbuffer.append("  or (POR_FAVORITE_LIST_LINES.SOURCE_DOC_HEADER_ID is null and POR_FAVORITE_LIST" +
"_LINES.TEMPLATE_NAME is null "
);
        stringbuffer.append(" and POR_FAVORITE_LIST_LINES.asl_id = ICX_CAT_ITEM_PRICES.asl_id) ");
        stringbuffer.append("  or (POR_FAVORITE_LIST_LINES.SOURCE_DOC_HEADER_ID is null and POR_FAVORITE_LIST" +
"_LINES.TEMPLATE_NAME is null "
);
        stringbuffer.append(" and POR_FAVORITE_LIST_LINES.asl_id is null and POR_FAVORITE_LIST_LINES.item_id " +
"= ICX_CAT_ITEM_PRICES.inventory_item_id)) ) "
);
        stringbuffer.append("  or  (POR_FAVORITE_LIST_LINES.price_list_id = ICX_CAT_ITEM_PRICES.price_list_id" +
" and "
);
        stringbuffer.append("   POR_FAVORITE_LIST_LINES.suggested_vendor_site_id = ICX_CAT_ITEM_PRICES.suppli" +
"er_site_id) ) "
);
        ...
        super.m_bindIndex++;
        stringbuffer.append(") ");
        stringbuffer.append("  and ICX_CAT_ITEM_PRICES.unit_of_measure = MTL_UNITS_OF_MEASURE_TL.uom_code(+) " +
"and MTL_UNITS_OF_MEASURE_TL.language(+) = :"
);
        stringbuffer.append(super.m_bindIndex);
        super.m_bindIndex++;
        if(flag)
        ...
        super.m_bindIndex++;
        stringbuffer.append(" and POR_FAVORITE_LIST_HEADERS.favorite_list_id = POR_FAVORITE_LIST_LINES.favori" +
"te_list_id and POR_FAVORITE_LIST_LINES.rt_item_id is null "
);
        ...
        stringbuffer.append(" and (POR_FAVORITE_LIST_LINES.suggested_vendor_site_id IS NULL ");
        stringbuffer.append(" or (POR_FAVORITE_LIST_LINES.suggested_vendor_site_id = (select vendor_site_id f" +
"rom "
);
        stringbuffer.append(" po_vendor_sites_all where vendor_site_id = POR_FAVORITE_LIST_LINES.suggested_ve" +
"ndor_site_id"
);
        stringbuffer.append(" and (purchasing_site_flag='Y' OR rfq_only_site_flag='Y')");
        stringbuffer.append(" and trunc(sysdate) < trunc(nvl(inactive_date, sysdate+1))");
        stringbuffer.append(" and org_id IN (-2, :");
        stringbuffer.append(super.m_bindIndex);
        super.m_bindIndex++;
        stringbuffer.append("))))");
        stringbuffer.append(" and POR_FAVORITE_LIST_LINES.UNIT_MEAS_LOOKUP_CODE = MTL_UNITS_OF_MEASURE_TL.uni" +
"t_of_measure(+) and MTL_UNITS_OF_MEASURE_TL.language(+) = :"
);
        stringbuffer.append(super.m_bindIndex);
        super.m_bindIndex++;
        return stringbuffer.toString();
