package od.oracle.apps.xxcrm.addattr.achcccontrol.cccontrol.webui;
 ...
 * Controller for ...
 */
public class ODCCControlCO extends OAControllerImpl
{
   ...
   */
   ...
   public static void initialize(OAPageContext pageContext, 
                                 OAWebBean webBean) {
       pageContext.writeDiagnostics("ODCCControlCO", "XXOD: StartinitParams", 
                                    1);
       ...
       pageContext.writeDiagnostics("ODCCControlCO.initParams", 
       ...
       pageContext.writeDiagnostics("ODCCControlCO", "XXOD: End initParams", 
                                    1);
   }
   ...
   public void applyView(OAPageContext pageContext, OAWebBean webBean) {
     ...
     try {
       ...
       OAMessageCheckBoxBean cb = 
                   (OAMessageCheckBoxBean)webBean.findChildRecursive("chkODCCControlCheck");
