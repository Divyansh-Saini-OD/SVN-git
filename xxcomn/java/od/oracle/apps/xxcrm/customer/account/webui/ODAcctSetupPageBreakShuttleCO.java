 ...
 * Controller for ...
 */
public class ODAcctSetupPageBreakShuttleCO extends OAControllerImpl
{
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
   ...
   OAViewObject ODAcctSetupDocPageBreakShuttleVO = (OAViewObject)currentAm.findViewObject("ODAcctSetupDocPageBreakShuttleVO");
   if ( ODAcctSetupDocPageBreakShuttleVO == null )
   ODAcctSetupDocPageBreakShuttleVO = (OAViewObject)currentAm.createViewObject("ODAcctSetupDocPageBreakShuttleVO", 
            "od.oracle.apps.xxcrm.customer.account.poplist.server.ODAcctSetupDocPageBreakShuttleVO");
   String docId = pageContext.getParameter("documentID");
   if (docId == null) docId = "0";
   ODAcctSetupDocPageBreakShuttleVO.setWhereClauseParam(0, new Integer(docId));
   ODAcctSetupDocPageBreakShuttleVO.executeQuery();
  ...
  if("Apply".equals(pageEvent))
  {
   ...
   ODCustAcctSetupDocPropertyVO = (OAViewObject)currentAm.createViewObject("ODCustAcctSetupDocPropertyVO", 
       ...
       ODCustAcctSetupDocPropertyVO.setWhereClauseParam(0, new Integer(docId));
        ODCustAcctSetupDocPropertyVO.setWhereClauseParam(1, "PAGEBREAK");
      ...
      ODCustAcctSetupDocPropertyVORowImpl newRow;
       ...
       {      
        for (int i = 0; i < sortIds.length; i++)
        {
          ...
          newRow.setPropertyType("PAGEBREAK");
