...
public class ODOpportunityAccessDetailsVORowImpl extends OAViewRowImpl 
{


  protected static final int ACCESSID = 0;
  protected static final int LEADID = 1;
  protected static final int TEAMLEADERFLAG = 2;
  protected static final int OWNERFLAG = 3;
  protected static final int FREEZEFLAG = 4;
  protected static final int SALESFORCEID = 5;
  protected static final int SALESGROUPID = 6;
  protected static final int CUSTOMERID = 7;
  protected static final int RESOURCEID = 8;
  protected static final int RESOURCENAME = 9;
  protected static final int SOURCEJOBTITLE = 10;
  protected static final int SOURCEPHONE = 11;
  protected static final int SOURCEEMAIL = 12;
  protected static final int OBJECTVERSIONNUMBER = 13;
  protected static final int ASNSTACCSWITCHER = 14;
  protected static final int ASNSTKEEPSWITCHER = 15;
  protected static final int ATTRIBUTECATEGORY = 16;
   ...
   */
  public ODOpportunityAccessDetailsVORowImpl()
  {
  }
  ...
  protected Object getAttrInvokeAccessor(int index, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case ASNSTACCSWITCHER:
        return getASNSTAccSwitcher();
      case ASNSTKEEPSWITCHER:
        return getASNSTKeepSwitcher();
  ...
  protected void setAttrInvokeAccessor(int index, Object value, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case OBJECTVERSIONNUMBER:
        ...
        return;
      case ASNSTACCSWITCHER:
        setASNSTAccSwitcher((String)value);
        return;
      case ASNSTKEEPSWITCHER:
        setASNSTKeepSwitcher((String)value);
        return;
      case ATTRIBUTECATEGORY:
  ...
  {
    return (String)getAttributeInternal(OWNERFLAG);
  }
  ...
  {
    setAttributeInternal(OWNERFLAG, value);
  }
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute ASNSTAccSwitcher
   */
  public String getASNSTAccSwitcher()
  {
        if("N".equals(getOwnerFlag()))
        {
            return "ASNSTAccN";
        } else
        {
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute ASNSTAccSwitcher
   */
  public void setASNSTAccSwitcher(String value)
  {
    setAttributeInternal(ASNSTACCSWITCHER, value);
  }

  /**
   * 
   * Gets the attribute value for the calculated attribute ASNSTKeepSwitcher
   */
  public String getASNSTKeepSwitcher()
  {
        if("N".equals(getOwnerFlag()))
        {
            return "ASNSTKeepN";
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute ASNSTKeepSwitcher
   */
  public void setASNSTKeepSwitcher(String value)
  {
    setAttributeInternal(ASNSTKEEPSWITCHER, value);
  }

  /**
   * 
   * Gets OpportunityAccessEO entity object.
   */
  public oracle.apps.asn.common.schema.server.AccessEOImpl getOpportunityAccessEO()
  {
    return (oracle.apps.asn.common.schema.server.AccessEOImpl)getEntity(0);
  }
