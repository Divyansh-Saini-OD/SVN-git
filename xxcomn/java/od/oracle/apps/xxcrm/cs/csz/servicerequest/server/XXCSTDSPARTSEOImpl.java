...
public class XXCSTDSPARTSEOImpl extends OAEntityImpl 
{
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxcrm.cs.csz.servicerequest.server.XXCSTDSPARTSEO");
    }
  ...
  protected void setAttrInvokeAccessor(int index, Object value, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case CREATIONDATE:
        ...
        return;
      case CREATEDBY:
        setCreatedBy((oracle.jbo.domain.Number)value);
        return;
      case LASTUDATEDATE:
        setLastUdateDate((Date)value);
        return;
      case LASTUPDATEDBY:
        setLastUpdatedBy((oracle.jbo.domain.Number)value);
        return;
      case ATTRIBUTE1:
