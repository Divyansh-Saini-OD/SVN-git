/*===========================================================================+
 ...
 +===========================================================================+
 |  FILENAME                                                                 |
 |             ODCDHBatchRecCO.java                                          |
 |                                                                           |
 |  DESCRIPTION                                                              |
 |    Controller Class to view the concurrent request for the                |
 |     program - OD: CDH Submit Batch Reconciliation Report                  |
 |                                                                           |
 |  NOTES                                                                    |
 |                                                                           |
 |                                                                           |
 ...
 * Controller for ...
 */
public class ODCDHBatchRecCO extends OAControllerImpl
{
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    {
        Serializable params[] = {"XX_CDH_SUBMIT_BATCH_RECON"};
        ...
        } else
        {
            ...
            throw new OAException("The report OD: CDH Submit Batch Reconciliation Report has not yet been run");
        }
