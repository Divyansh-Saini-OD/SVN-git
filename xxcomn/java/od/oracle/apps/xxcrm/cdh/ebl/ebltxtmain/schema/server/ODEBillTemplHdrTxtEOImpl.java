...
// ---------------------------------------------------------------------
public class ODEBillTemplHdrTxtEOImpl extends OAEntityImpl {
    ...
    public static final int STARTVALPOS = 58;
    public static final int ENDVALPOS = 59;
    public static final int FILLTXTPOS = 60;
    public static final int JUSTIFYTXT = 61;
    public static final int PREPENDCHAR = 62;
    public static final int APPENDCHAR = 63;
    public static final int EBLTEMPLHDRID = 64;
    public static final int ABSOLUTEFLAG = 65;
    public static final int DCINDICATOR = 66;
    public static final int DBCRSEPERATOR = 67;
     ...
     */
    public static Key createPrimaryKey(Number eblTemplhdrId) {
        return new Key(new Object[]{eblTemplhdrId});
    }
    ...
    public enum AttributesEnum {
        CustDocId {
            public Object get(ODEBillTemplHdrTxtEOImpl obj) {
                return obj.getCustDocId();
            }

            public void put(ODEBillTemplHdrTxtEOImpl obj, Object value) {
        ...
        IncludeLabel {
            public Object get(ODEBillTemplHdrTxtEOImpl obj) {
                return obj.getIncludeLabel();
            }

            public void put(ODEBillTemplHdrTxtEOImpl obj, Object value) {
                obj.setIncludeLabel((String)value);
            }
        }
        ,
        RecordType {
        ...
        EblTemplhdrId {
            public Object get(ODEBillTemplHdrTxtEOImpl obj) {
                return obj.getEblTemplhdrId();
            }

            public void put(ODEBillTemplHdrTxtEOImpl obj, Object value) {
                obj.setEblTemplhdrId((Number)value);
            }
        }
        ,
        AbsoluteFlag {
        ...
        public abstract Object get(ODEBillTemplHdrTxtEOImpl object);

        public abstract void put(ODEBillTemplHdrTxtEOImpl object,
                                 Object value);
     ...
     */
    public ODEBillTemplHdrTxtEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxcrm.cdh.ebl.ebltxtmain.schema.server.ODEBillTemplHdrTxtEO");
        }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        if(operation == DML_INSERT) {
            //Added by Bhagwan Rao 7 Jul 2017 for Defect #40174
             String absoluteCHFlag= getAbsoluteFlag();
            String absoluteCDHFlag= getDcIndicator();
            //String debitCredit=getDbCrSeperator();
            //String debitCredit=getAttribute16();
            //System.out.println("debitCredit"+debitCredit);
             if(absoluteCHFlag == null) {
                 setAbsoluteFlag("N");
             } 
             
            if(absoluteCDHFlag == null) {
                setDcIndicator(null);
            } 
//           if(debitCredit == null) {
...
//            } 
    ...
    /**Gets the attribute value for IncludeLabel, using the alias name IncludeLabel
     */
    public String getIncludeLabel() {
        return (String)getAttributeInternal(INCLUDELABEL);
    }

    /**Sets <code>value</code> as the attribute value for IncludeLabel
     */
    ...
    /**Gets the attribute value for EblTemplhdrId, using the alias name EblTemplhdrId
     */
    public Number getEblTemplhdrId() {
        return (Number)getAttributeInternal(EBLTEMPLHDRID);
    }

    /**Sets <code>value</code> as the attribute value for EblTemplhdrId
     */
