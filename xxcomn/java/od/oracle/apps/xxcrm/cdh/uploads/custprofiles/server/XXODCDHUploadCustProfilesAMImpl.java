package od.oracle.apps.xxcrm.cdh.uploads.custprofiles.server;
...
public class XXODCDHUploadCustProfilesAMImpl extends OAApplicationModuleImpl 
{
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public XXODCDHUploadCustProfilesAMImpl()
  {
  }
                               ...
                               String strFileName)
  {
    ...
    try{
        cs2 = getOADBTransaction().getJdbcConnection().prepareCall("{call XXOD_CDH_UPLOAD_ATTRIBUTES.upload(?,?,?,?)}");
  ...
  {
    launchTester("od.oracle.apps.xxcrm.cdh.uploads.custprofiles.server", "XXODCDHUploadCustProfilesAMLocal");
  }
}
