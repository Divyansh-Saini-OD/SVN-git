...
//Below code added for the Defect 4737
      ...
      String ctl_file = l_cust_top + "/java/od/oracle/apps/xxfin/ar/statements/XXARStatementBurst.xml";
      String dir_file = l_cust_top + "/java/oracle/apps/xxod/arstatements";
