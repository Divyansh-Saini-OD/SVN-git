 ...
 * Controller for ...
 */
public class ODShipToLOVCO extends OAControllerImpl
{
...
//      companyID = "34049";
//      billToSiteID = "1537";
      OAViewObject vo = (OAViewObject)oapagecontext.getApplicationModule(oawebbean).findViewObject("ODShipToLocationsVO1");
      vo.setWhereClauseParams(null);
      vo.setWhereClause(null);
      vo.setWhereClauseParam(0, billToSiteID); // billToSiteID
      vo.setWhereClauseParam(1, customerID);   // customerID
      vo.setWhereClauseParam(2, billToSiteID); // billToSiteID
      vo.setWhereClauseParam(3, billToSiteID); // billToSiteID
  }
}
