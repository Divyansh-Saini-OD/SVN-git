...
import od.oracle.apps.xxfin.ap.idms.traitmatrix.lov.XXOperatingUnitLovVOImpl;
import od.oracle.apps.xxfin.ap.idms.traitmatrix.lov.XXSuppTraitImpl;
import od.oracle.apps.xxfin.ap.idms.traitmatrix.lov.xxsuppliernamelovImpl;
// ---------------------------------------------------------------------
...
public class XXSupplierMatrixAMImpl extends OAApplicationModuleImpl {
    ...
    /**Container's getter for XXSupplierMatrixVO1
     */
    public XXSupplierMatrixVOImpl getXXSupplierMatrixVO1() {
        return (XXSupplierMatrixVOImpl)findViewObject("XXSupplierMatrixVO1");
    }
    ...
    public void updMatrixRow(String tId,String sNo) {
        XXSuppMatrixVOImpl  vo =  getXXSuppMatrixVO1();
        vo.clearCache();
        vo.setWhereClause(null);
        String wclause  = " SUP_TRAIT = '"+tId+"'  AND  SUPPLIER = '"+sNo+"'";
        vo.setWhereClause(wclause); 
        System.out.println("SUP_TRAIT "+tId+" -- Sno "+sNo);
   ...
   public void updateFlag(String  rowRef) {
    ...
    public void updateTelex(String Supplier) {
        ...
        CallableStatement callableStatement = 
            getOADBTransaction().createCallableStatement("begin  xx_ap_supp_rms_update_telex(:1,:2); end;", 
