...
// ---------------------------------------------------------------------
public class XXSuppMatrixEOImpl extends OAEntityImpl {
    ...
    public static final int SUPTRAITID = 12;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxfin.ap.idms.traitmatrix.schema.server.XXSuppMatrixEO");
        }
