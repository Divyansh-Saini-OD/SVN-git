 ...
 * Controller for ...
 */
public class PlannerUpdateCO extends OAControllerImpl
{
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    super.processRequest(pageContext, webBean);
     ...
     // (the user selected the Update Planner button) and we should proceed
     ...
     if (!pageContext.isBackNavigationFired(false))
     {
        ...
        TransactionUnitHelper.startTransactionUnit(pageContext, "plannerUpdateTxn");
        ...
        if (!pageContext.isFormSubmission())
        {
          ...
          am.invokeMethod("prepUpdatePlannerVO", parameters);
        }
      }
      else
      {
        if (!TransactionUnitHelper.isTransactionUnitInProgress(pageContext, "plannerUpdateTxn", true))
        {
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    {
      OAViewObject vo = (OAViewObject)am.findViewObject("UpdatePlannerVO1");
