 ...
 * Controller for ...
 */
public class ClassUpdateCO extends OAControllerImpl
{
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    super.processRequest(pageContext, webBean);
     ...
     if (!pageContext.isBackNavigationFired(false))
     {
        ...
        TransactionUnitHelper.startTransactionUnit(pageContext, "merchClassUpdateTxn");
        ...
        if (!pageContext.isFormSubmission())
        {
          ...
          Serializable[] parameters = { merchClassId };

          OAApplicationModule am = pageContext.getApplicationModule(webBean);
          am.invokeMethod("prepUpdateClassVO", parameters);
        }
      }
      else
      {
        if (!TransactionUnitHelper.isTransactionUnitInProgress(pageContext, "merchClassUpdateTxn", true))
        {
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    {
      OAViewObject vo = (OAViewObject)am.findViewObject("UpdateClassVO1");
      ...
      TransactionUnitHelper.endTransactionUnit(pageContext, "merchClassUpdateTxn");
      ...
      MessageToken[] msgTokens = {new MessageToken("MERCH_CLASS", merchClass)};
      OAException confirmMessage = new OAException("XXMER", "XX_WFH_CONFIRM_UPDATE_MC", msgTokens, OAException.CONFIRMATION, null);
    ...
    else if (pageContext.getParameter("Cancel") != null)
    {
       ...
       pageContext.forwardImmediately("OA.jsp?page=/od/oracle/apps/xxmer/wfh/webui/ClassSearchPG",
                                      null,
