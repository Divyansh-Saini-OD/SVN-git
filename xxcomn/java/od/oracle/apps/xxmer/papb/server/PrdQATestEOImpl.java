...
public class PrdQATestEOImpl extends OAEntityImpl 
{
  ...
  protected static final int TASKSEQ = 27;
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("od.oracle.apps.xxmer.papb.server.PrdQATestEO");
    }
  ...
  /**
   * 
   * Gets the attribute value for PrdTestId, using the alias name PrdTestId
   */
  public Number getPrdTestId()
  {
    return (Number)getAttributeInternal(PRDTESTID);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for PrdTestId
   */
  public void setPrdTestId(Number value)
  {
    setAttributeInternal(PRDTESTID, value);
  }
