...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [THU JUN 12 15:23:29 IST 2008]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <ns0:ProcessInvoice>
      <ns0:DataArea>
   <xsl:if test = "not(/tns:Extensity/tns:Invoices/tns:Header)">
      <ns0:Invoice>
        <ns0:InvoiceHeader>
                 <ns7:Name>
