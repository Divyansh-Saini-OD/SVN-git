...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="XSD">
      <schema location="../../../../../Office%20Depot/BPEL_Projects/Test_Application/PostJournalEntryGLSI/bpel/GLStagingTableInsert_table.xsd"/>
      <rootElement name="XxGlInterfaceNaStgCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/GLStagingTableInsert"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [THU JAN 24 17:06:26 EST 2008]. -->
?>
<xsl:stylesheet version="1.0"
                xmlns:ns6="http://www.openapplications.org/oagis/9/unqualifieddatatypes/1.1"
                xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/"
                xmlns:ns0="http://xmlns.oracle.com/pcbpel/adapter/db/top/GLStagingTableInsert"
        ...
        <ns0:status>
         ...
         <xsl:choose>
          ...
          <ns0:groupId>
            ...
            <xsl:text disable-output-escaping="no">111</xsl:text>
