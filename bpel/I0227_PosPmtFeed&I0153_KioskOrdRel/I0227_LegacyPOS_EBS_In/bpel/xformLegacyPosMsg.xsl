...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="XSD">
      ...
      <rootElement name="InputParameters" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/APPS/XX_BPEL_SVCLEGACYPOSREAD/XX_OM_LEG_POS_SHIP_CONF_PKG-24O/"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.1.0(build 061009.0802) AT [MON JUN 25 15:04:41 IST 2007]. -->
?>
