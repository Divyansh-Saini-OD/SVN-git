...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.1.0(build 061009.0802) AT [SUN JUL 13 00:21:01 EDT 2008]. -->
?>
    ...
    <ns0:TransactionData>
      ...
      <ns0:EntiltyList>
		...
		<xsl:text disable-output-escaping="no">File</xsl:text>
             ...
             <xsl:value-of select="$TDMDCNFileName"/>
          </ns0:EntityID>
        </xsl:for-each>
      </ns0:EntiltyList>
      <ns0:AttributeList>
