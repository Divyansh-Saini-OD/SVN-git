...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.1.0(build 061009.0802) AT [THU JUN 21 18:10:36 EDT 2007]. -->
?>
  ...
  <xsl:template match="/">
    <ns1:OrganizationHierarchy>
      ...
      <ns1:DataArea>
        ...
        <ns1:AreaAttributes>
          <ns1:ChainNo>
            <xsl:value-of select="/db:OutputParameters/O_AREA_CHAIN"/>
          </ns1:ChainNo>
          <ns1:ManagerName>
            <xsl:value-of select="/db:OutputParameters/O_AREA_MGR"/>
          </ns1:ManagerName>
        </ns1:AreaAttributes>
        <ns1:RegionAttributes>
          <ns1:AreaNo>
            <xsl:value-of select="/db:OutputParameters/O_REGION_AREA"/>
          </ns1:AreaNo>
          <ns1:ManagerName>
            <xsl:value-of select="/db:OutputParameters/O_REGION_MGR"/>
          </ns1:ManagerName>
        </ns1:RegionAttributes>
