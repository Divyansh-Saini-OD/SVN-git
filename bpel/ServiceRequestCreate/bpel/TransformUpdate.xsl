...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [WED NOV 10 16:02:57 EST 2010]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <db:InputParameters>
      ...
      <xsl:if test="/ns1:InputParameters/ns1:P_SR_REQ_REC/ns1:ATTRIBUTE2">
        <xsl:choose>
          <xsl:when test="contains(/ns1:InputParameters/ns1:P_SR_REQ_REC/ns1:ATTRIBUTE2,'CAN')">
            <db:P_SR_STATUS_ID>
