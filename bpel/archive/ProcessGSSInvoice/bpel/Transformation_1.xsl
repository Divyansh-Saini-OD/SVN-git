...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.1.0(build 061009.0802) AT [WED AUG 29 10:05:54 EDT 2007]. -->
?>
  ...
  <xsl:template match="/">
    <ns0:ProcessInvoice>
      <ns0:DataArea>
        ...
        <ns0:TotalAmount>
          <xsl:value-of select="concat(normalize-space(tns:GrossAmountSign), normalize-space(tns:GrossAmount))"/>
        </ns0:TotalAmount>
        <ns0:SupplierParty>
          <ns0:PartyIDs>
            <ns0:ID>
        ...
        <ns6:SourceSystemCode>
          <xsl:value-of select="normalize-space(tns:DataSource)"/>
        </ns6:SourceSystemCode> 
        <ns7:Batch>
                 <ns0:FileName>
                ...
                <ns0:TotalAmount>
                  <xsl:value-of select="concat(../tns:Trailer/tns:TotalInvoiceAmountSign,../tns:Trailer/tns:TotalInvoiceAmount)"/>
                </ns0:TotalAmount>
                <ns0:Communication>
                  <ns0:URI>
        ...
        <ns0:LineNumber>
          ...
          <ns0:TotalAmount>
          <xsl:value-of select="concat(normalize-space(tns:MDSEAmountSign), normalize-space(tns:MDSEAmount))"/>
        </ns0:TotalAmount>
        <ns0:Tax>
        ...
        <ns0:Distribution>
            <ns0:GLNominalAccount>
                  <xsl:value-of 
select='concat(tns:GLCompany,".",tns:GLLocation,".",tns:GLDepartment,".",tns:GLBusinessUnit,".",tns:GLAccount)'/>
                </ns0:GLNominalAccount>
          <ns0:EnterpriseUnit>
                    <ns0:GLAccount>
                      <ns0:GLElement>
        ...
        <ns6:FreightAdjustment>
            <xsl:value-of select="normalize-space(normalize-space(tns:FreightAmount))"/>
        </ns6:FreightAdjustment>
              </ns0:InvoiceLine>
            </xsl:for-each>
          </ns0:Invoice>
