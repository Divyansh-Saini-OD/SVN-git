...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="XSD">
      <schema location="ServiceStgTableInsert_table.xsd"/>
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.1.0(build 061009.0802) AT [TUE AUG 28 13:09:58 EDT 2007]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsl ns5 ns9 ns7 ns4 ns2 xs ns3 od ns1 ns6 ns8 ns0 bpws ehdr hwf xp20 ora ids orcl">
  <xsl:template match="/">
    <ns0:XxApInvBatchInterfaceStg2Collection>
      <ns0:XxApInvBatchInterfaceStg2>
        ...
        <ns0:fileName>
          <xsl:value-of select="/ns1:ProcessInvoice/ns1:DataArea/ns1:Invoice/ns1:InvoiceHeader/od:Batch/ns1:FileName"/>
        </ns0:fileName>
        <ns0:creationDate>
          <xsl:value-of select="normalize-space(/ns1:ProcessInvoice/ns1:DataArea/ns1:Invoice/ns1:InvoiceHeader/od:Batch/ns1:CreationDateTime)"/>
        </ns0:creationDate>
        <ns0:creationTime>
          <xsl:value-of select="normalize-space(substring(/ns1:ProcessInvoice/ns1:DataArea/ns1:Invoice/ns1:InvoiceHeader/od:Batch/ns1:CreationDateTime,11.0,8.0))"/>
        </ns0:creationTime>
        <ns0:invoiceCount>
          <xsl:value-of select="normalize-space(/ns1:ProcessInvoice/ns1:DataArea/ns1:Invoice/ns1:InvoiceHeader/od:Batch/od:NumberOfRecords)"/>
        </ns0:invoiceCount>
        <ns0:totalBatchAmount>
          <xsl:value-of select="orcl:right-trim(orcl:left-trim(/ns1:ProcessInvoice/ns1:DataArea/ns1:Invoice/ns1:InvoiceHeader/od:Batch/ns1:TotalAmount))"/>
        </ns0:totalBatchAmount>
        <ns0:vendorEmailAddress>
          <xsl:value-of select="normalize-space(/ns1:ProcessInvoice/ns1:DataArea/ns1:Invoice/ns1:InvoiceHeader/od:Batch/ns1:Communication/ns1:URI)"/>
        </ns0:vendorEmailAddress>
        <ns0:xxApInvInterfaceStgCollection>
          <xsl:for-each select="/ns1:ProcessInvoice/ns1:DataArea/ns1:Invoice">
            <ns0:XxApInvInterfaceStg2>
              ...
              <xsl:choose>
                <xsl:when test='substring(ns1:InvoiceHeader/ns1:TotalAmount,1.0,1.0) = "-"'>
                  <ns0:invoiceTypeLookupCode>
                    <xsl:text disable-output-escaping="no">CREDIT MEMO</xsl:text>
                  </ns0:invoiceTypeLookupCode>
                </xsl:when>
                <xsl:when test='substring(ns1:InvoiceHeader/ns1:TotalAmount,1.0,1.0) != "-"'>
                  <ns0:invoiceTypeLookupCode>
              ...
              <ns0:termsName>
                <xsl:value-of select="ns1:InvoiceHeader/ns1:PaymentTerm/ns1:Term/ns1:Description"/>
              </ns0:termsName>
              <ns0:description>
              ...
              <ns0:attribute9>
                <xsl:value-of select="orcl:left-trim(orcl:right-trim(ns1:InvoiceHeader/od:DocumentControlNumber))"/>
              </ns0:attribute9>
              <ns0:attribute10>
                <xsl:value-of select="orcl:left-trim(orcl:right-trim(ns1:InvoiceHeader/ns1:Party/ns1:PartyIDs/ns1:ID))"/>
              </ns0:attribute10>
              <ns0:globalAttribute1>
                <xsl:value-of select="normalize-space(ns1:InvoiceHeader/od:Settlement/ns1:CreditCard/ns1:Number)"/>
              </ns0:globalAttribute1>
              <xsl:choose>
              ...
              <ns0:globalAttribute6>
                <xsl:value-of select="orcl:left-trim(orcl:right-trim(ns1:InvoiceHeader/od:SpecialProcessingPayCode))"/>
              </ns0:globalAttribute6>
              <ns0:globalAttribute7>
                <xsl:value-of select="orcl:left-trim(orcl:right-trim(ns1:InvoiceHeader/od:PaymentPriorityCode))"/>
              </ns0:globalAttribute7>
              <ns0:globalAttribute8>
                <xsl:value-of select="normalize-space(ns1:InvoiceHeader/ns1:ReasonCode)"/>
              </ns0:globalAttribute8>
              <ns0:globalAttribute20>
                <xsl:value-of select="normalize-space(ns1:InvoiceLine/ns1:Distribution/ns1:ProjectReference/ns1:ActivityID)"/>
              </ns0:globalAttribute20>
              <ns0:source>
                <xsl:value-of select="normalize-space(ns1:InvoiceHeader/od:SourceSystemCode)"/>
              </ns0:source>
              <ns0:groupId>
                <xsl:value-of select="normalize-space(ns1:InvoiceHeader/od:InvoiceGroupID)"/>
              </ns0:groupId>
              <ns0:voucherNum>
                <xsl:value-of select="normalize-space(ns1:InvoiceHeader/od:VoucherReference/ns1:DocumentID/ns1:ID)"/>
              </ns0:voucherNum>
              <ns0:termsDate>
                ...
                <xsl:for-each select="ns1:InvoiceLine">
                  <ns0:XxApInvLinesInterfaceStg2>
                    ...
                    <ns0:distCodeConcatenated>
                      <xsl:value-of select="ns1:Distribution/od:GLNominalAccount"/>
                    </ns0:distCodeConcatenated>
                    <ns0:creationDate>
                      <xsl:value-of select="xp20:current-dateTime()"/>
                    </ns0:creationDate>
                    <ns0:attribute11>
                      <xsl:value-of select="normalize-space(od:VoucherTypeCode)"/>
                    </ns0:attribute11>
                    <ns0:attribute15>
                      <xsl:value-of select="normalize-space(od:PANID)"/>
                    </ns0:attribute15>
                    <ns0:globalAttribute1>
                      <xsl:value-of select="normalize-space(od:Garnishment/od:CaseID)"/>
                    </ns0:globalAttribute1>
                    <ns0:globalAttribute2>
                      <xsl:value-of select="normalize-space(od:Garnishment/od:NonCustodialParentSSN)"/>
                    </ns0:globalAttribute2>
                    <ns0:globalAttribute3>
                      <xsl:value-of select="normalize-space(od:Garnishment/od:State)"/>
                    </ns0:globalAttribute3>
                    <ns0:globalAttribute4>
                      <xsl:value-of select="orcl:right-trim(orcl:left-trim(od:Garnishment/od:MedicalSupportIndicator))"/>
                    </ns0:globalAttribute4>
                    <ns0:globalAttribute5>
                      <xsl:value-of select="orcl:right-trim(orcl:left-trim(od:Garnishment/od:NonCustodialParentName))"/>
                    </ns0:globalAttribute5>
                    <ns0:globalAttribute6>
                      <xsl:value-of select="orcl:right-trim(orcl:left-trim(od:Garnishment/od:FIPSCode))"/>
                    </ns0:globalAttribute6>
                    <ns0:globalAttribute7>
                      <xsl:value-of select="orcl:right-trim(orcl:left-trim(od:Garnishment/od:EmploymentTerminationIndicator))"/>
                    </ns0:globalAttribute7>
                    <ns0:globalAttribute8>
                      <xsl:value-of select="orcl:right-trim(orcl:left-trim(od:Garnishment/od:TypeCode))"/>
                    </ns0:globalAttribute8>
                    <ns0:globalAttribute18>
                      <xsl:value-of select="orcl:right-trim(orcl:left-trim(ns1:Distribution/od:ExpenditureOrganizationCode))"/>
                    </ns0:globalAttribute18>
                    ...
                    <ns0:expenditureType>
                      <xsl:value-of select="orcl:right-trim(orcl:left-trim(ns1:Distribution/od:ExpenditureTypeCode))"/>
                    </ns0:expenditureType>
                    <ns0:invoiceNum>
                    ...
                    <ns0:reasonCode>
                      <xsl:value-of select="normalize-space(od:InvoiceCharge/ns1:ReasonCode)"/>
                    </ns0:reasonCode>
                    <ns0:oracleGlCompany>
