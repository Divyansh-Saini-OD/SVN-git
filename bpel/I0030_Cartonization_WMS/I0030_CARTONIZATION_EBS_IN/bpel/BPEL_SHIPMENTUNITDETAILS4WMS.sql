...
CREATE OR REPLACE TYPE XX_OM_CARTON_GETSHPMT_PKG_XX1 AS OBJECT (
      DELIVERY_ID NUMBER,
...
/
show errors
CREATE OR REPLACE TYPE XX_OM_CARTON_GETSHPMT_PKG_ AS TABLE OF XX_OM_CARTON_GETSHPMT_PKG_XX1; 
/
show errors
-- Declare package containing conversion functions between SQL and PL/SQL types
CREATE OR REPLACE PACKAGE BPEL_SHIPMENTUNITDETAILS4WMS AS
	-- Declare the conversion functions the PL/SQL type XX_OM_CARTON_GETSHPMT_PKG.XX_OM_GETSHIPMENTUNIT_T
	FUNCTION PL_TO_SQL1(aPlsqlItem XX_OM_CARTON_GETSHPMT_PKG.XX_OM_GETSHIPMENTUNIT_T)
 	RETURN XX_OM_CARTON_GETSHPMT_PKG_XX1;
	FUNCTION SQL_TO_PL1(aSqlItem XX_OM_CARTON_GETSHPMT_PKG_XX1)
	...
	FUNCTION PL_TO_SQL0(aPlsqlItem XX_OM_CARTON_GETSHPMT_PKG.XX_OM_GETSHIPMENTUNIT_TBL)
 	RETURN XX_OM_CARTON_GETSHPMT_PKG_;
	FUNCTION SQL_TO_PL0(aSqlItem XX_OM_CARTON_GETSHPMT_PKG_)
	RETURN XX_OM_CARTON_GETSHPMT_PKG.XX_OM_GETSHIPMENTUNIT_TBL;
   PROCEDURE XX_OM_CARTON_GETSHPMT_PKG$GET (P_DELIVERY_ID NUMBER,X_GETSHIPMENTUNIT_TBL OUT XX_OM_CARTON_GETSHPMT_PKG_);
END BPEL_SHIPMENTUNITDETAILS4WMS;
/
show errors
CREATE OR REPLACE PACKAGE BODY BPEL_SHIPMENTUNITDETAILS4WMS IS
	FUNCTION PL_TO_SQL1(aPlsqlItem XX_OM_CARTON_GETSHPMT_PKG.XX_OM_GETSHIPMENTUNIT_T)
 	RETURN XX_OM_CARTON_GETSHPMT_PKG_XX1 IS 
	aSqlItem XX_OM_CARTON_GETSHPMT_PKG_XX1; 
	BEGIN 
		-- initialize the object
		aSqlItem := XX_OM_CARTON_GETSHPMT_PKG_XX1(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	...
	END SQL_TO_PL1;
	FUNCTION PL_TO_SQL0(aPlsqlItem XX_OM_CARTON_GETSHPMT_PKG.XX_OM_GETSHIPMENTUNIT_TBL)
 	RETURN XX_OM_CARTON_GETSHPMT_PKG_ IS 
	aSqlItem XX_OM_CARTON_GETSHPMT_PKG_; 
	BEGIN 
   ...
   PROCEDURE XX_OM_CARTON_GETSHPMT_PKG$GET (P_DELIVERY_ID NUMBER,X_GETSHIPMENTUNIT_TBL OUT XX_OM_CARTON_GETSHPMT_PKG_) IS
      X_GETSHIPMENTUNIT_TBL_ APPS.XX_OM_CARTON_GETSHPMT_PKG.XX_OM_GETSHIPMENTUNIT_TBL;
   BEGIN
      APPS.XX_OM_CARTON_GETSHPMT_PKG.GETSHIPMENTUNIT_TO_WMS(P_DELIVERY_ID,X_GETSHIPMENTUNIT_TBL_);
      X_GETSHIPMENTUNIT_TBL := BPEL_SHIPMENTUNITDETAILS4WMS.PL_TO_SQL0(X_GETSHIPMENTUNIT_TBL_);
