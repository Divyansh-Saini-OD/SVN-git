...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="XSD">
      <schema location="../../../../Office%20Depot/BPEL_Projects/Test_Application/bpel/GLStgTableInsert_table.xsd"/>
      <rootElement name="XxGlInterfaceNaStgCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/GLStgTableInsert"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [FRI JAN 25 12:42:34 EST 2008]. -->
?>
