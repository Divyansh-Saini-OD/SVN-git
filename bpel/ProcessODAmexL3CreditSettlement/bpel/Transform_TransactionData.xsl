...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.1.0(build 061009.0802) AT [SUN JUL 13 00:10:07 EDT 2008]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:param name="AMEXCCSETFileName"/>
  <xsl:template match="/">
    <ns0:TransactionData>
      <ns0:ProcessInfo>
        <ns0:Domain>
      ...
      <ns0:EntiltyList>
		...
		<xsl:text disable-output-escaping="no">File</xsl:text>
             ...
             <xsl:value-of select="$AMEXCCSETFileName"/>
          </ns0:EntityID>
        </xsl:for-each>
      </ns0:EntiltyList>
      <ns0:AttributeList>
