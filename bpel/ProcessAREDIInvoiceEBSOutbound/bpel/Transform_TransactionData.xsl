...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.1.0(build 061009.0802) AT [SAT JUL 12 17:19:22 EDT 2008]. -->
?>
<xsl:stylesheet version="1.0"
   ...
   <xsl:param name="AREDIInvoiceFileName"/>
  <xsl:template match="/">
    <ns0:TransactionData>
      <ns0:ProcessInfo>
        <ns0:Domain>
      ...
      <ns0:EntiltyList>
		...
		<xsl:text disable-output-escaping="no">File</xsl:text>
             ...
             <xsl:value-of select="$AREDIInvoiceFileName"/>
          </ns0:EntityID>
        </xsl:for-each>
      </ns0:EntiltyList>
      <ns0:AttributeList>
